    ...
    <div class="container" id="rong1" style="    text-align: center;">
      <div class="row " id="rong2">
        ...
        <div id="input">
          ...
          <p>
            <input class="col-lg-12  col-md-12 col-sm-12 col-xs-12" id="password" name="password" type="password"
              value="" tabindex="1">
          </p>
          <p>
            <span>+</span>
          ...
          <p>
            <input class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="key" name="key" type="text" value=""
              tabindex="2">
          </p>
        </div><br>
        <p>
