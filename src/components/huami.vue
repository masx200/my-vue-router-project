        ...
        <div class="container" id="rong1" style="    text-align: center;">
            <div class="row" id="rong2">
                ...
                <div id="input">
                    ...
                    <p></p>
                    <p>
                        <input class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="password" name="password" type="password" value tabindex="1">
                    </p>
                    <p></p>
                    <span>+</span>
                    <h3>区分代号</h3>
                    <p></p>
                    <p>
                        <input class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="key" name="key" type="text" value tabindex="2">
                    </p>
                </div>
                <br>
                <p></p>
                ...
                <p>
                  <input
                    id="code16"
                    class="col-lg-12 col-md-12 col-sm-12 col-xs-12 snippet code16d"
                    readonly
                  >
                </p>
                <br>
                <p>
                  <button id="copycode16" class="btn copycode16d" data-clipboard-target="#code16">点击复制</button>
                </p>
              </span>
                    <p>
                        <span id="copyOK">
...
<script>
// import "./huami/fp.css"
//  import {myfun1} from "./huami/md5.js"
//  import {myfun2} from "./huami/huami.js"

// <script src="./huami/huami.js"/>
</script>


<style src="./huami/fp.css">
...
export default {
    ...
    methods: {
        mychangemenu() {
            ...
            if (this.myroutename == "home" || this.$route.name == "home") {
                this.isActive1 = this.isActive2 = this.isActive3 = false;
                this.isActive1 = true;
            } else if (this.myroutename == "huami" || this.$route.name == "huami") {
                this.isActive1 = this.isActive2 = this.isActive3 = false;
                this.isActive2 = true;
            } else if (this.myroutename == "about" || this.$route.name == "about") {
                this.isActive1 = this.isActive2 = this.isActive3 = false;
                this.isActive3 = true;
            }
        }
