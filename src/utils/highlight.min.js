...
!(function(e) {
  ...
  function k(e, t, i, r) {
    ...
    function o(e) {
      (b += e.cN ? c(e.cN, "", !0) : ""),
        (u = Object.create(e, { parent: { value: u } }));
    }
    function a(e, t) {
      ...
      if (r)
        return (
          r.skip ? (p += t) : (r.eB && (p += t), s(), r.rB || r.eB || (p = t)),
          o(r),
          r.rB ? 0 : t.length
        );
      ...
      if (a) {
        ...
        return (
          a.starts && (a.endSameAsBegin && (a.starts.eR = a.eR), o(a.starts)),
          n.rE ? 0 : t.length
        );
      }
      if (
        ...
        throw new Error(
          'Illegal lexeme "' + t + '" for mode "' + (u.cN || "<unnamed>") + '"'
        );
    ...
    var t,
      ...
      s = (function(e) {
        var t,
          ...
          i = e.className + " ";
        if (
          ((i += e.parentNode ? e.parentNode.className : ""), (r = l.exec(i)))
        )
          return M(r[1]) ? r[1] : "no-highlight";
        for (t = 0, a = (i = i.split(/\s+/)).length; t < a; t++)
          if (u((n = i[t])) || M(n)) return n;
      })(e);
    u(s) ||
      (v.useBR
  ...
  return (
    ...
    n.registerLanguage("diff", function() {
      return {
        aliases: ["patch"],
        c: [
          {
    ...
    n.registerLanguage("http", function() {
      var t = "HTTP/[0-9\\.]+";
      return {
        aliases: ["https"],
        i: "\\S",
    ...
    n.registerLanguage("markdown", function() {
      return {
    ...
    n.registerLanguage("shell", function() {
      return {
        aliases: ["console"],
        c: [
          {
