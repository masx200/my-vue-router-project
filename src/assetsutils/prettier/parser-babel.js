...
var r = function (t) {
    ...
    A = function (t, e) {
        ...
        if (e && "function" == typeof (s = t.toString) && !y((r = s.call(t))))
            return r;
        if ("function" == typeof (s = t.valueOf) && !y((r = s.call(t))))
            return r;
        if (!e && "function" == typeof (s = t.toString) && !y((r = s.call(t))))
            return r;
    ...
    dt = function (t) {
        return function (e, s, r) {
            ...
            if (t && s != s) {
                ...
                for (; n > o; o++)
                    if ((t || o in a) && a[o] === s) return t || o || 0;
            return !t && -1;
        };
    },
...
function Te() {
    be &&
        Fe &&
        ((be = !1),
        Fe.length ? (ge = Fe.concat(ge)) : (Pe = -1),
        ge.length && we());
}
function we() {
    if (!be) {
...
class ts {
    ...
    compare(t) {
        if (
            (qe("SemVer.compare", this.version, this.options, t),
            !(t instanceof ts))
        ) {
    ...
    getSupportInfo: function ({
        ...
        const i = ps.split("-", 1)[0],
            ...
            Object.entries(o).map(([t, e]) => Object.assign({ [u]: t }, e)))
                .filter((t) => h(t) && c(t))
                .sort((t, e) =>
                    t.name === e.name ? 0 : t.name < e.name ? -1 : 1
                )
                .map(function (t) {
                    if (r) return t;
                    return re(t, hs);
                            ...
                            (e.default =
                                1 === e.default.length
                                    ...
                                    : e.default
                                          .filter(h)
                                          .sort((t, e) =>
                                              cs.compare(e.since, t.since)
                                          )[0].value),
                        Array.isArray(e.choices) &&
                            ((e.choices = e.choices.filter(
                                (t) => h(t) && c(t)
                            )),
                            "parser" === e.name &&
                                (function (t, e, s) {
                                    const r = new Set(
                                        t.choices.map((t) => t.value)
                                    );
                                    for (const i of e)
                                        if (i.parsers)
        ...
        function c(t) {
            return (
                s ||
                !("deprecated" in t) ||
                (t.deprecated && cs.lt(i, t.deprecated))
            );
        }
    },
};
...
function Fs(t, e) {
    return (
        !1 !== e &&
        ("/" === t.charAt(e) && "/" === t.charAt(e + 1) ? Cs(t, e) : e)
    );
}
function gs(t, e, s) {
        ...
        (e.nodeDescription = (function (t) {
            ...
            let s = String(
                t.name ||
                    ...
                    (t.key &&
                        ("object" == typeof t.key ? t.key.name : t.key)) ||
                    (t.value &&
                        ("object" == typeof t.value ? "" : String(t.value))) ||
                    t.operator ||
                    ""
            );
        ...
        !(function () {
            ...
            t.exports = {
                ...
                isSourceElement: function (t) {
                    return (
                        e(t) || (null != t && "FunctionDeclaration" === t.type)
                    );
                },
        ...
        !(function () {
            ...
            t.exports = {
                ...
                isIdentifierStartES5: function (t) {
                    return t < 128
                        ? i[t]
                        : s.NonAsciiIdentifierStart.test(o(t));
                },
                ...
                isIdentifierStartES6: function (t) {
                    return t < 128
                        ? i[t]
                        : e.NonAsciiIdentifierStart.test(o(t));
                },
    ...
    qs = s(function (t) {
        !(function () {
            ...
            function n(t) {
                ...
                if (((i = t.charCodeAt(0)), !e.isIdentifierStartES5(i)))
                    return !1;
                for (s = 1, r = t.length; s < r; ++s)
                    if (((i = t.charCodeAt(s)), !e.isIdentifierPartES5(i)))
                        return !1;
                return !0;
            }
            function o(t) {
                ...
                if (0 === t.length) return !1;
                for (
                    n = e.isIdentifierStartES6, s = 0, r = t.length;
                    s < r;
                    ++s
                ) {
                    if (55296 <= (i = t.charCodeAt(s)) && i <= 56319) {
                        if (++s >= r) return !1;
                        if (!(56320 <= (a = t.charCodeAt(s)) && a <= 57343))
                            return !1;
...
function ar(t) {
    return (
        "FunctionExpression" === t.type || "ArrowFunctionExpression" === t.type
    );
}
function nr(t) {
    return (
...
function dr(t) {
    return (
        t &&
        ("CallExpression" === t.type || "OptionalCallExpression" === t.type)
    );
}
function Dr(t) {
    return (
...
var Lr = {
    ...
    isFlowAnnotationComment: function (t, e) {
        const s = Ks(e),
            r = zs(t, Xs(e));
        return (
            !1 !== r && "/*" === t.slice(s, s + 2) && "*/" === t.slice(r, r + 2)
        );
    },
    ...
    isJestEachTemplateLiteral: function (t, e) {
        ...
        return (
            ...
            (("Identifier" === e.tag.object.type &&
                s.test(e.tag.object.name)) ||
            ...
            ("Literal" === e.type ||
                ...
                ("TemplateLiteral" === e.type
                    ...
                    ? e.properties.every(
                          (t) =>
                              !t.computed &&
                              (t.shorthand || (t.value && r(t.value)))
                      )
                    : "ArrayExpression" === e.type
                    ? e.elements.every((t) => null === t || r(t))
                    : kr(e)
                    ? ("ImportExpression" === e.type || t(e.callee, s)) &&
                      Tr(e).every(r)
                    : Dr(e)
    ...
    isSimpleType: function (t) {
        return (
            !!t &&
            (!(
                ("GenericTypeAnnotation" !== t.type &&
                    "TSTypeReference" !== t.type) ||
                t.typeParameters
            ) ||
                !!pr.has(t.type))
        );
    ...
    isSimpleTemplateLiteral: function (t) {
        ...
        return (
            ...
            s.every((t) => {
                if (Ir(t)) return !1;
                if ("Identifier" === t.type || "ThisExpression" === t.type)
                    return !0;
                if (Dr(t)) {
                    let e = t;
                    for (; Dr(e); ) {
    ...
    isTheOnlyJsxElementInMarkdown: function (t, e) {
        if ("markdown" !== t.parentParser && "mdx" !== t.parentParser)
            return !1;
        const s = e.getNode();
...
function ci({
    ...
    return (
        !(
            !s ||
            ("TryStatement" !== s.type && "CatchClause" !== s.type) ||
            !r
        ) &&
...
var Ri = {
    ...
    handleEndOfLineComment: function (t) {
        return [oi, Ei, li, Ci, ui, hi, ci, Di, xi, gi, Pi, Ti, Ni, Ii].some(
            (e) => e(t)
        );
    },
    handleRemainingComment: function (t) {
        return [ki, ui, hi, di, Ai, mi, Ti, yi, fi, Li, Fi, vi].some((e) =>
            e(t)
        );
    },
        ...
        return (
            ((e &&
                (Kr(e) ||
                    Xr(e) ||
                    (ti(s) &&
                        (Jr(e.leadingComments) || Jr(e.trailingComments))))) ||
                (s &&
            ...
            (t = Hi(t, (t) => {
                ...
                (t = Hi(t, (t) => {
                    if ("ParenthesizedExpression" === t.type) {
                        ...
                        if ("TypeCastExpression" === s.type)
                            return (s.range = t.range), s;
                        const r = Ui(t);
                        if (!e.has(r))
                            return (
        ...
        return (t = Hi(t, (t) => {
            switch (t.type) {
                ...
                case "TSParenthesizedType":
                    return (
                        (t.typeAnnotation.range = [Ui(t), qi(t)]),
                        t.typeAnnotation
                    );
...
(Qa.parenR.updateContext = Qa.braceR.updateContext =
    ...
    (Qa.parenL.updateContext = function (t) {
        const e =
            t === Qa._if || t === Qa._for || t === Qa._with || t === Qa._while;
    ...
    (Qa._function.updateContext = Qa._class.updateContext =
        function (t) {
            ...
            ((t === Qa.colon || t === Qa.braceL) &&
                this.curContext() === dn.b_stat)
    ...
    (Qa.braceHashL.updateContext = function () {
        this.state.context.push(dn.recordExpression),
            (this.state.exprAllowed = !0);
    });
let Dn =
...
class Ln {
    ...
    checkRedeclarationInScope(t, e, s, r) {
        this.isRedeclaredInScope(t, e, s) &&
            this.raise(r, hn.VarRedeclaration, e);
    }
...
class Yn extends Ln {
    ...
    declareName(t, e, s) {
        ...
        if (1024 & e)
            return (
                this.maybeExportDefined(r, t), void r.exportOnlyBindings.push(t)
            );
        super.declareName(...arguments),
            2 & e &&
                (1 & e ||
...
const ho = {
        estree: (t) =>
            class extends t {
                ...
                isObjectProperty(t) {
                    return (
                        "Property" === t.type && "init" === t.kind && !t.method
                    );
                }
                isObjectMethod(t) {
            ...
            class extends t {
                            ...
                            case 123:
                                return this.state.pos === this.state.start
                                    ? 60 === s && this.state.exprAllowed
                                        ? (++this.state.pos,
                                          this.finishToken(Qa.jsxTagStart))
                ...
                jsxParseElementAt(t, e) {
                    ...
                    if (
                        ...
                        throw this.raise(
                            this.state.start,
                            Gn.UnwrappedAdjacentJSXElements
                        );
                    return Kn(i)
                ...
                getTokenFromCode(t) {
                    ...
                    if (e === dn.j_oTag || e === dn.j_cTag) {
                        ...
                        if (62 === t)
                            return (
                                ++this.state.pos, this.finishToken(Qa.jsxTagEnd)
                            );
            ...
            class extends t {
                ...
                flowParsePredicate() {
                    ...
                    return (
                        ...
                        this.state.lastTokStart > e + 1 &&
                            this.raise(
                                e,
                                jn.UnexpectedSpaceBetweenModuloChecks
                            ),
                        this.eat(Qa.parenL)
                            ...
                            !(function (t) {
                                ...
                                ? "DeclareModuleExports" === t.type &&
                                  (i &&
                                      this.raise(
                                          t.start,
                                          jn.DuplicateDeclareModuleExports
                                      ),
                                  "ES" === r &&
                                      this.raise(
                                          t.start,
                                          jn.AmbiguousDeclareModuleKind
                                      ),
                                  (r = "CommonJS"),
                                  (i = !0))
                                : ("CommonJS" === r &&
                ...
                checkNotUnderscore(t) {
                    "_" === t &&
                        this.raise(
                            this.state.start,
                            jn.UnexpectedReservedUnderscore
                        );
                }
                checkReservedType(t, e, s) {
                    Rn.has(t) &&
                        this.raise(
                            e,
                            s
                                ? jn.AssignReservedType
                                : jn.UnexpectedReservedType,
                            t
                        );
                }
                ...
                flowParseOpaqueType(t, e) {
                    return (
                        ...
                        (t.supertype = null),
                        this.match(Qa.colon) &&
                            (t.supertype = this.flowParseTypeInitialiser(
                                Qa.colon
                            )),
                        (t.impltype = null),
                        e ||
                            (t.impltype = this.flowParseTypeInitialiser(Qa.eq)),
                        this.semicolon(),
                    ...
                    for (
                        ...
                        this.flowObjectTypeSemicolon(),
                            !o ||
                                ...
                                this.raise(
                                    o,
                                    jn.UnexpectedExplicitInexactInObject
                                );
                    }
                ...
                flowParseFunctionTypeParam(t) {
                    ...
                    return (
                        a.type === Qa.colon || a.type === Qa.question
                            ? (n &&
                                  !t &&
                                  this.raise(i.start, jn.ThisParamMustBeFirst),
                ...
                flowParseFunctionTypeParams(t = []) {
                    ...
                    return (
                        this.eat(Qa.ellipsis) &&
                            (e = this.flowParseFunctionTypeParam(!1)),
                    ...
                    switch (this.state.type) {
                        ...
                        default:
                            ...
                            if (this.state.type.keyword) {
                                ...
                                return (
                                    this.next(), super.createIdentifier(s, t)
                                );
                            }
                    }
                    throw this.unexpected();
                ...
                parseConditional(t, e, s, r) {
                    ...
                    return (
                        ...
                        (n.test = t),
                        (n.consequent = o),
                        (n.alternate = this.forwardNoArrowParamsConversionAt(
                            n,
                ...
                getArrowLikeExpressions(t, e) {
                    ...
                    return e
                        ? (r.forEach((t) => this.finishArrowValidation(t)),
                          [r, []])
                        : (function (t, e) {
                              const s = [],
                                  r = [];
                              ...
                              t.params.every((t) => this.isAssignable(t, !0))
                          );
                }
                ...
                maybeParseExportNamespaceSpecifier(t) {
                    ...
                    return (
                        s && "type" === t.exportKind && this.unexpected(e), s
                    );
                }
                parseClassId(t, e, s) {
                        ...
                        e.declare &&
                            ...
                            "PropertyDefinition" !== e.type
                                ...
                                : e.value &&
                                  this.raise(
                                      e.value.start,
                                      jn.DeclareClassFieldInitializer
                                  ));
                }
                isIterator(t) {
                ...
                isNonstaticConstructor(t) {
                    return (
                        !this.match(Qa.colon) && super.isNonstaticConstructor(t)
                    );
                }
                pushClassMethod(t, e, s, r, i, a) {
                    if (
                    ...
                    return (
                        ...
                        this.match(Qa.colon)
                            ...
                            : this.isThisParam(t) &&
                              this.raise(
                                  t.start,
                                  jn.ThisParamAnnotationRequired
                              ),
                        this.match(Qa.eq) &&
                            this.isThisParam(t) &&
                ...
                parseImportSpecifier(t) {
                    ...
                    n &&
                        ...
                        this.raise(
                            e.start,
                            jn.ImportTypeShorthandOnlyInPureImport
                        ),
                        (n || o) &&
                            this.checkReservedType(
                                e.local.name,
                ...
                shouldParseAsyncArrow() {
                    return (
                        this.match(Qa.colon) || super.shouldParseAsyncArrow()
                    );
                }
                parseMaybeAssign(t, e, s) {
                    ...
                    if (
                        ...
                        const u = this.tryParse((i) => {
                            ...
                            const n = this.forwardNoArrowParamsConversionAt(
                                r,
                                () => {
                                    const i = super.parseMaybeAssign(t, e, s);
                                    return (
                                        this.resetStartLocationFromNode(i, r), i
                                    );
                                }
                            );
                        ...
                        throw this.raise(
                            r.start,
                            jn.UnexpectedTokenAfterTypeParameter
                        );
                    }
                ...
                flowEnumErrorStringMemberInconsistentlyInitailized(
                    ...
                    this.raise(
                        t,
                        jn.EnumStringMemberInconsistentlyInitailized,
                        e
                    );
                }
                flowEnumMemberInit() {
                    ...
                    switch (this.state.type) {
                        case Qa.num: {
                            const s = this.parseNumericLiteral(
                                this.state.value
                            );
                            return e()
                            ...
                            case "number":
                                this.flowEnumCheckExplicitTypeMismatch(
                                    ...
                                    r.numberMembers.push(
                                        this.finishNode(a, "EnumNumberMember")
                                    );
                                break;
                            case "string":
                                this.flowEnumCheckExplicitTypeMismatch(
                                    ...
                                    r.stringMembers.push(
                                        this.finishNode(a, "EnumStringMember")
                                    );
                                break;
                            case "invalid":
                ...
                flowEnumBody(t, { enumName: e, nameLoc: s }) {
                    ...
                    this.expect(Qa.braceL);
                    const { members: i, hasUnknownMembers: a } =
                        this.flowEnumMembers({ enumName: e, explicitType: r });
            ...
            class extends t {
                ...
                tsParseModifiers(t, e, s, r) {
                    const i = (e, s, r, i) => {
                            s === r &&
                                t[i] &&
                                this.raise(e, so.InvalidModifiersOrder, r, i);
                        },
                        a = (e, s, r, i) => {
                            ((t[r] && s === i) || (t[i] && s === r)) &&
                    ...
                    for (;;) {
                        ...
                        ro(o)
                            ? t.accessibility
                                ? this.raise(
                                      n,
                                      so.DuplicateAccessibilityModifier
                                  )
                                : (i(n, o, o, "override"),
                                  i(n, o, o, "static"),
                                  (t.accessibility = o))
                ...
                tsParseImportType() {
                    ...
                    return (
                        ...
                        this.match(Qa.string) ||
                            this.raise(
                                this.state.start,
                                so.UnsupportedImportTypeArgument
                            ),
                ...
                tsFillSignature(t, e) {
                    ...
                    (e.typeParameters = this.tsTryParseTypeParameters()),
                        ...
                        (s || this.match(t)) &&
                            (e.typeAnnotation =
                                this.tsParseTypeOrTypePredicateAnnotation(t));
                }
                ...
                tsIsUnambiguouslyIndexSignature() {
                    return (
                        this.next(), this.eat(Qa.name) && this.match(Qa.colon)
                    );
                }
                    ...
                    if (this.match(Qa.parenL) || this.isRelational("<")) {
                        ...
                        if (
                            (r.kind &&
                                ...
                                this.raise(
                                    this.state.pos,
                                    so.AccesorCannotHaveTypeParameters
                                ),
                    ...
                    return (
                        t.elementTypes.forEach((t) => {
                            ...
                            !e ||
                                ...
                                this.raise(
                                    t.start,
                                    so.OptionalTypeBeforeRequired
                                ),
                                (e =
                                    e ||
                                    ("TSNamedTupleMember" === i &&
                                        t.optional) ||
                                    "TSOptionalType" === i),
                                "TSRestType" === i &&
                                    (i = (t = t.typeAnnotation).type);
                            const a = "TSNamedTupleMember" === i;
                            (s = null != (r = s) ? r : a),
                                s !== a &&
                                    this.raise(
                                        t.start,
                                        so.MixedLabeledAndUnlabeledElements
                                    );
                        }),
                ...
                tsParseTupleElementType() {
                    ...
                    if (s) {
                        const s = this.startNodeAt(t, e);
                        (s.typeAnnotation = r),
                            (r = this.finishNode(s, "TSRestType"));
                    }
                    return r;
                }
                ...
                tsParseArrayTypeOrHigher() {
                    ...
                    for (
                        ;
                        !this.hasPrecedingLineBreak() && this.eat(Qa.bracketL);
                        ...
                        if (r && this.match(Qa._this)) {
                            ...
                            return (
                                "TSThisType" === t.type
                                    ...
                                    : (this.resetStartLocationFromNode(t, s),
                                      (t.asserts = !0)),
                                (e.typeAnnotation = t),
                ...
                tsParseType() {
                    ...
                    if (this.hasPrecedingLineBreak() || !this.eat(Qa._extends))
                        return t;
                    const e = this.startNodeAtNode(t);
                    return (
                        (e.checkType = t),
                ...
                tsParseHeritageClause(t) {
                    ...
                    return (
                        s.length ||
                            this.raise(e, so.EmptyHeritageClauseType, t),
                        s
                    );
                }
                ...
                tsParseTypeArguments() {
                    ...
                    return (
                        ...
                        0 === t.params.length &&
                            this.raise(t.start, so.EmptyTypeArguments),
                        (this.state.exprAllowed = !1),
                        this.expectRelational(">"),
                    ...
                    if (i || a) {
                        ...
                        return (
                            ...
                            "Identifier" !== o.type &&
                                ...
                                this.raise(
                                    t.start,
                                    so.UnsupportedParameterPropertyKind
                                ),
                            (t.parameter = o),
                ...
                parseFunctionBodyAndFinish(t, e, s = !1) {
                    ...
                    r && !this.match(Qa.braceL) && this.isLineTerminator()
                        ...
                        : "TSDeclareFunction" === r &&
                          ...
                          (this.raise(
                              t.start,
                              so.DeclareFunctionHasImplementation
                          ),
                          t.declare)
                            ...
                            if (n) {
                                if (!r && this.eat(Qa.parenL))
                                    return (
                                        ...
                                        this.tsCheckForInvalidTypeCasts(
                                            a.arguments
                                        ),
                                        (a.typeParameters = n),
                                        i.optionalChainMember &&
                ...
                parseNewArguments(t) {
                    if (this.isRelational("<")) {
                        const e = this.tsTryParseAndCatch(() => {
                            ...
                            return (
                                this.match(Qa.parenL) || this.unexpected(), t
                            );
                        });
                ...
                parseImport(t) {
                    ...
                    return (
                        "type" === e.importKind &&
                            ...
                            this.raise(
                                e.start,
                                so.TypeImportCannotSpecifyDefaultAndNamed
                            ),
                        e
                    );
                }
                    ...
                    const i = () => {
                        ...
                        i && this.eat(Qa.braceL)
                            ? (this.tsHasSomeModifiers(e, r) &&
                                  this.raise(
                                      this.state.pos,
                                      so.StaticBlockCannotHaveModifier
                                  ),
                ...
                parseClassMemberWithIsStatic(t, e, s, r) {
                    ...
                    if (i)
                        return (
                            ...
                            e.declare &&
                                this.raise(
                                    e.start,
                                    so.IndexSignatureHasDeclare
                                ),
                            void (
                                e.override &&
                                this.raise(
                                    e.start,
                                    so.IndexSignatureHasOverride
                                )
                            )
                        );
                    !this.state.inAbstractClass &&
                        ...
                        this.raise(
                            e.start,
                            so.NonAbstractClassHasAbstractMethod
                        ),
                        e.override &&
                            (s.hadSuperClass ||
                ...
                parseClassProperty(t) {
                    return (
                        ...
                        this.state.isAmbientContext &&
                            ...
                            this.raise(
                                this.state.start,
                                so.DeclareClassFieldHasInitializer
                            ),
                        super.parseClassProperty(t)
                    );
                }
                parseClassPrivateProperty(t) {
                    return (
                        t.abstract &&
                            this.raise(t.start, so.PrivateElementHasAbstract),
                        t.accessibility &&
                            this.raise(
                                t.start,
                ...
                pushClassMethod(t, e, s, r, i, a) {
                    ...
                    n &&
                        i &&
                        this.raise(n.start, so.ConstructorHasTypeParameters),
                        !e.declare ||
                ...
                parseClassSuper(t) {
                    super.parseClassSuper(t),
                        ...
                        this.eatContextual("implements") &&
                            (t.implements =
                                this.tsParseHeritageClause("implements"));
                }
                    ...
                    const l = this.tryParse((e) => {
                        ...
                        return (
                            ("ArrowFunctionExpression" !== i.type ||
                                ...
                                e(),
                            0 !==
                                (null == (r = p) ? void 0 : r.params.length) &&
                ...
                parseAssignableListItemTypes(t) {
                    ...
                    const e = this.tsTryParseTypeAnnotation();
                    return (
                        e && (t.typeAnnotation = e), this.resetEndLocation(t), t
                    );
                }
                toAssignable(t, e = !1) {
                    switch (t.type) {
                            ...
                            switch (s.type) {
                                ...
                                case "TSTypeAssertion":
                                    this.state.maybeInArrowParameters
                                        ? this.raise(
                                              s.start,
                                              so.UnexpectedTypeCastInParameter
                                          )
                                        : (t[e] = this.typeCastToParameter(s));
                            }
                    }
                ...
                parseCatchClauseParam() {
                    ...
                    return (
                        e && ((t.typeAnnotation = e), this.resetEndLocation(t)),
                        t
                    );
                }
...
class Io extends class extends class extends class extends class extends class extends class extends class extends class extends class {
    ...
    readToken_numberSign() {
        ...
        if (123 === e || (91 === e && this.hasPlugin("recordAndTuple"))) {
            ...
            xn(e)
                ...
                : 92 === e
                ? (++this.state.pos,
                  this.finishToken(Qa.privateName, this.readWord1()))
            ...
            if (95 !== e) {
                ...
                (-1 === n.indexOf(e) ||
                    ...
                    r ||
                        this.raise(
                            this.state.pos,
                            hn.NumericSeparatorInEscapeSequence
                        ),
                    ++this.state.pos;
            }
        }
        return this.state.pos === i ||
            (null != e && this.state.pos - i !== e) ||
            o
            ? null
            : u;
    }
        ...
        if (
            ...
            (69 !== u && 101 !== u) ||
                ...
                null === this.readInt(10) &&
                    this.raise(e, hn.InvalidOrMissingExponent),
                (s = !0),
                (a = !0),
                (u = this.input.charCodeAt(this.state.pos))),
            110 === u &&
    ...
    readTmplToken() {
        ...
        for (;;) {
            ...
            if (
                ...
                return this.state.pos === this.state.start &&
                    this.match(Qa.template)
                    ? 36 === r
                        ? ((this.state.pos += 2),
                          void this.finishToken(Qa.dollarBraceL))
                        : (++this.state.pos,
                          void this.finishToken(Qa.backQuote))
                    : ((t += this.input.slice(e, this.state.pos)),
    ...
    braceIsBlock(t) {
        ...
        return (
            ...
            (t !== Qa.colon ||
            (e !== dn.braceStatement && e !== dn.braceExpression)
    ...
    expectRelational(t) {
        this.isRelational(t)
            ? this.next()
            : this.unexpected(null, Qa.relational);
    }
    isContextual(t) {
        return (
            this.match(Qa.name) &&
    ...
    checkExpressionErrors(t, e) {
        ...
        s >= 0 && this.unexpected(s),
            r >= 0 && this.raise(r, hn.DuplicateProto);
    }
    ...
    toAssignable(t, e = !1) {
        ...
        switch (
            ...
            case "ObjectExpression":
                ...
                for (
                    let s = 0, r = t.properties.length, i = r - 1;
                    s < r;
                    s++
                ) {
                    var a;
            ...
            case "AssignmentExpression":
                "=" !== t.operator &&
                    this.raise(t.left.end, hn.MissingEqInAssignment),
    ...
    parseBindingList(t, e, s, r) {
        ...
        for (; !this.eat(t); )
            if (
                (a ? (a = !1) : this.expect(Qa.comma),
                s && this.match(Qa.comma))
            )
                i.push(null);
            else {
                if (this.eat(t)) break;
                ...
                }
                {
                    ...
                    for (
                        ...
                        this.raise(
                            this.state.start,
                            hn.UnsupportedParameterDecorator
                        );
                        this.match(Qa.at);
    ...
    checkLVal(t, e, s = 64, r, i, a = !1) {
        switch (t.type) {
            case "Identifier": {
                ...
                this.state.strict &&
                    ...
                    this.raise(
                        t.start,
                        64 === s
                            ? hn.StrictEvalArguments
                            : hn.StrictEvalArgumentsBinding,
                        e
                    ),
                    r &&
                        (r.has(e)
                            ? this.raise(t.start, hn.ParamDupe)
                            : r.add(e)),
                    i &&
                        "let" === e &&
                        this.raise(t.start, hn.LetInLexicalBinding),
                    64 & s || this.scope.declareName(e, s, t.start);
                break;
            }
            case "MemberExpression":
                64 !== s &&
                    this.raise(t.start, hn.InvalidPropertyBindingPattern);
                break;
            case "ObjectPattern":
            ...
            default:
                this.raise(
                    t.start,
                    64 === s ? hn.InvalidLhs : hn.InvalidLhsBinding,
                    e
                );
        }
    }
    ...
    parseExprOp(t, e, s, r) {
        ...
        if (
            null != i &&
            (this.prodParam.hasIn || !this.match(Qa._in)) &&
            i > r
        ) {
            ...
            if (
                ...
                throw this.raise(
                    this.state.start,
                    hn.UnexpectedAwaitAfterPipelineBody
                );
    ...
    parseMember(t, e, s, r, i) {
        ...
        return (
            !1 !== o &&
                ("Super" === a.object.type &&
                    this.raise(e, hn.SuperPrivateField),
    ...
    parseTaggedTemplateExpression(t, e, s, r) {
        ...
        return (
            ...
            r.optionalChainMember &&
                this.raise(e, hn.OptionalChainingNoTemplate),
        ...
        switch (this.state.type) {
            ...
            case Qa.bracketHashL:
                return this.parseArrayLike(
                    this.state.type === Qa.bracketBarL
                        ? Qa.bracketBarR
                        : Qa.bracketR,
                    !1,
                    !0,
                ...
                if (this.state.inPipeline)
                    return (
                        ...
                        "smart" !==
                            ...
                            this.raise(
                                s.start,
                                hn.PrimaryTopicRequiresSmartPipeline
                            ),
                        this.next(),
    ...
    parseImportMetaProperty(t) {
        ...
        return (
            ...
            this.isContextual("meta") &&
                (this.inModule ||
                    this.raise(e.start, cn.ImportMetaOutsideModule),
    ...
    parseParenAndDistinguishExpression(t) {
        ...
        return (
            (y.expression = r), this.finishNode(y, "ParenthesizedExpression"), y
        );
    }
    shouldParseArrow() {
        ...
        return (
            null === this.state.value &&
                (t ||
                    this.raise(
                        this.state.start + 1,
                        hn.InvalidEscapeSequenceTemplate
                    )),
            (e.value = {
                raw: this.input
    ...
    checkGetterSetterParams(t) {
        ...
        r.length !== s &&
            ...
            "set" === t.kind &&
                "RestElement" ===
                    (null == (e = r[r.length - 1]) ? void 0 : e.type) &&
    ...
    parseExprListItem(t, e, s, r) {
        let i;
        if (this.match(Qa.comma))
            t || this.raise(this.state.pos, hn.UnexpectedToken, ","),
                (i = null);
            ...
            this.expectPlugin("partialApplication"),
                r ||
                    this.raise(
                        this.state.start,
                        hn.UnexpectedArgumentPlaceholder
                    );
            const t = this.startNode();
        ...
        if (i === Qa.name) s = this.state.value;
            ...
            if (!i.keyword) throw this.unexpected();
            {
                ...
                (i !== Qa._class && i !== Qa._function) ||
                    (t !== dn.functionStatement &&
                        t !== dn.functionExpression) ||
                    this.state.context.pop();
            }
        }
        return (
        ...
        if ("await" === t) {
            ...
            if (this.scope.inStaticBlock && !this.scope.inNonArrowFunction)
                return void this.raise(
                    e,
                    hn.AwaitBindingIdentifierInStaticBlock
                );
            ...
            case Qa._var:
                return (
                    ...
                    t &&
                        ...
                        this.raise(
                            this.state.start,
                            hn.UnexpectedLexicalDeclaration
                        ),
    ...
    parseCatchClauseParam() {
        const t = this.parseBindingAtom(),
            e = "Identifier" === t.type;
        return (
            this.scope.enter(e ? 8 : 0), this.checkLVal(t, "catch clause", 9), t
        );
    }
    parseTryStatement(t) {
        if (
        ...
        return (
            ...
            t.handler ||
                t.finalizer ||
                this.raise(t.start, hn.NoCatchOrFinally),
    ...
    parseFunction(t, e = 0, s = !1) {
        ...
        this.initFunction(t, s),
            this.match(Qa.star) &&
                ...
                this.raise(
                    this.state.start,
                    hn.GeneratorInSingleStatementContext
                ),
    ...
    isClassProperty() {
        return (
            this.match(Qa.eq) || this.match(Qa.semi) || this.match(Qa.braceR)
        );
    }
    isClassMethod() {
    ...
    parseClassMember(t, e, s) {
        ...
        if (r) {
            if (this.parseClassMemberFromModifier(t, e)) return;
            if (this.eat(Qa.braceL))
                return void this.parseClassStaticBlock(t, e);
        }
    ...
    parseClassSuper(t) {
        t.superClass = this.eat(Qa._extends)
    ...
    isExportDefaultSpecifier() {
        ...
        if (44 === this.input.charCodeAt(t) || (this.match(Qa.name) && e))
            return !0;
    ...
    parseAssertEntries() {
        ...
        do {
            ...
            if (
                ...
                throw this.unexpected(
                    this.state.start,
                    hn.ModuleAttributeInvalidValue
                );
...
function Jo(t, ...e) {
    return (s, r, i = {}) => {
        ...
        return Ki(
            n,
            Object.assign(Object.assign({}, i), {}, { originalText: s })
        );
    };
}
...
var au = {
    parsers: Object.assign(
        Object.assign(
            { babel: ru, "babel-flow": Wa(Qo), "babel-ts": Wa(Zo) },
            Vo
        ),
        {},
        {
