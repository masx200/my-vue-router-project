/* https://cdn.jsdelivr.net/npm/prettier@2.3.1/esm/standalone.mjs */
...
var t = {
    ...
    devDependencies: {
      ...
      'eslint-plugin-prettier-internal-rules':
        'link:scripts/tools/eslint-plugin-prettier-internal-rules',
...
var u = i(function (e, t) {
    ...
    function r(e, t, n, r, i) {
      for (var u = 0, o = t.length, s = 0, a = 0; u < o; u++) {
        ...
        if (l.removed) {
          if (
            ((l.value = e.join(r.slice(a, a + l.count))),
            (a += l.count),
            u && t[u - 1].added)
          ) {
            var c = t[u - 1]
  ...
  o = i(function (e, t) {
    ...
    var r = new ((n = u) && n.__esModule ? n : { default: n }).default()
    t.characterDiff = r
  }),
  s = function (e, t) {
...
var a = Object.defineProperty({ generateOptions: s }, '__esModule', {
    value: !0,
  }),
  l = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.wordDiff = void 0)
    var n,
      r = (n = u) && n.__esModule ? n : { default: n }
    ...
    ;(t.wordDiff = s),
      (s.equals = function (e, t) {
        return (
          ...
          e === t || (this.options.ignoreWhitespace && !o.test(e) && !o.test(t))
        )
      }),
  ...
  c = i(function (e, t) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.diffTrimmedLines = function (e, t, n) {
        var i = (0, a.generateOptions)(n, { ignoreWhitespace: !0 })
        return r.diff(e, t, i)
      }),
      (t.lineDiff = void 0)
    var r = new ((n = u) && n.__esModule ? n : { default: n }).default()
  ...
  d = i(function (e, t) {
    ...
    function a(e, t, n, r, u) {
      ...
      if ('[object Array]' === o.call(e)) {
        for (
          t.push(e), l = new Array(e.length), n.push(l), s = 0;
          s < e.length;
          s += 1
        )
          l[s] = a(e[s], t, n, r, u)
      ...
      if (
        (e && e.toJSON && (e = e.toJSON()), 'object' === i(e) && null !== e)
      ) {
        t.push(e), (l = {}), n.push(l)
        var c,
          p = []
        for (c in e) e.hasOwnProperty(c) && p.push(c)
        for (p.sort(), s = 0; s < p.length; s += 1)
          l[(c = p[s])] = a(e[c], t, n, r, c)
        t.pop(), n.pop()
      } else l = e
      return l
    }
    ;(t.jsonDiff = s),
      (s.useLongestToken = !0),
      (s.tokenize = c.lineDiff.tokenize),
  ...
  g = function (e) {
    ...
    function o() {
      ...
      for (s(e), s(e), e.hunks = []; u < n.length; ) {
        ...
        if (/^@@/.test(l)) e.hunks.push(a())
          ...
          if (l && t.strict)
            throw new Error('Unknown line ' + (u + 1) + ' ' + JSON.stringify(l))
          u++
        }
      }
    }
    ...
    function a() {
      ...
      for (
        ...
        var l = 0 == n[u].length && u != n.length - 1 ? ' ' : n[u][0]
        if ('+' !== l && '-' !== l && ' ' !== l && '\\' !== l) break
        o.lines.push(n[u]),
...
var m,
  y = Object.defineProperty({ parsePatch: g }, '__esModule', { value: !0 }),
  D = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  E = v,
  b = function (e, t) {
    'string' == typeof e && (e = (0, y.parsePatch)(e))
    var n = 0
    !(function r() {
      var i = e[n++]
  ...
  C = (m = D) && m.__esModule ? m : { default: m }
function v(e, t) {
  var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
  if (('string' == typeof t && (t = (0, y.parsePatch)(t)), Array.isArray(t))) {
    if (t.length > 1)
  ...
  for (var v = 0, A = 0; A < s.length; A++) {
    var F = s[A],
      x = F.oldStart + F.offset + v - 1
    v += F.newLines - F.oldLines
    for (var S = 0; S < F.lines.length; S++) {
      var w = F.lines[S],
        T = w.length > 0 ? w[0] : ' ',
        B = w.length > 0 ? w.substr(1) : w,
        k = F.linedelimiters[S]
      if (' ' === T) x++
      else if ('-' === T) u.splice(x, 1), o.splice(x, 1)
      else if ('+' === T) u.splice(x, 0, B), o.splice(x, 0, k), x++
      else if ('\\' === T) {
        var N = F.lines[S - 1] ? F.lines[S - 1][0] : null
        '+' === N ? (r = !0) : '-' === N && (i = !0)
      }
    }
  }
  ...
  for (var P = 0; P < u.length - 1; P++) u[P] = u[P] + o[P]
  return u.join('')
}
var A = Object.defineProperty(
    { applyPatch: E, applyPatches: b },
    '__esModule',
    { value: !0 }
  ),
  F = k,
  x = N,
  S = P,
  w = function (e, t, n, r, i, u) {
    return P(e, e, t, n, r, i, u)
  }
function T(e) {
  return (
    (function (e) {
...
function k(e, t, n, r, i, u, o) {
  o || (o = {}), void 0 === o.context && (o.context = 4)
  var s = (0, c.diffLines)(n, r, o)
  function a(e) {
        ...
        if (((t.lines = i), t.added || t.removed)) {
          ...
          if (!p) {
            ...
            ;(p = h),
              (f = g),
              c &&
                ((d = o.context > 0 ? a(c.lines.slice(-o.context)) : []),
                (p -= d.length),
                (f -= d.length))
          }
          ;(u = d).push.apply(
          ...
          if (p)
            if (i.length <= 2 * o.context && e < s.length - 2) {
              var m
              ;(m = d).push.apply(m, T(a(i)))
            } else {
              var y,
                D = Math.min(i.length, o.context)
              ;(y = d).push.apply(y, T(a(i.slice(0, D))))
              var E = {
                oldStart: p,
                oldLines: h - p + D,
                newStart: f,
              ...
              if (e >= s.length - 2 && i.length <= o.context) {
                var b = /\n$/.test(n),
                  C = /\n$/.test(r),
                  v = 0 == i.length && d.length > E.oldLines
                !b &&
                  v &&
                  n.length > 0 &&
                  d.splice(E.oldLines, 0, '\\ No newline at end of file'),
                  ((b || v) && C) || d.push('\\ No newline at end of file')
              }
              l.push(E), (p = 0), (f = 0), (d = [])
            }
...
function P(e, t, n, r, i, u, o) {
  return N(k(e, t, n, r, i, u, o))
}
...
var _ = Object.defineProperty(
    { arrayEqual: I, arrayStartsWith: j },
    '__esModule',
    { value: !0 }
  ),
  M = q,
  R = function (e, t, n) {
    ...
    ;(e.newFileName || t.newFileName) &&
      (U(e)
        ? U(t)
          ? ((r.oldFileName = z(r, e.oldFileName, t.oldFileName)),
            (r.newFileName = z(r, e.newFileName, t.newFileName)),
            (r.oldHeader = z(r, e.oldHeader, t.oldHeader)),
            (r.newHeader = z(r, e.newHeader, t.newHeader)))
    ...
    for (; i < e.hunks.length || u < t.hunks.length; ) {
      var a = e.hunks[i] || { oldStart: 1 / 0 },
        l = t.hunks[u] || { oldStart: 1 / 0 }
      if (G(a, l)) r.hunks.push(H(a, o)), i++, (s += a.newLines - a.oldLines)
      else if (G(l, a))
        r.hunks.push(H(l, s)), u++, (o += l.newLines - l.oldLines)
      else {
        var c = {
          oldStart: Math.min(a.oldStart, l.oldStart),
          oldLines: 0,
          newStart: Math.min(a.newStart + o, l.oldStart + s),
          newLines: 0,
          lines: [],
        }
        J(c, a.oldStart, a.lines, l.oldStart, l.lines),
          u++,
          i++,
          r.hunks.push(c)
      }
...
function W(e, t) {
  if ('string' == typeof e) {
    if (/^@@/m.test(e) || /^Index:/m.test(e)) return (0, y.parsePatch)(e)[0]
    if (!t) throw new Error('Must provide a base reference or pass in a patch')
    return (0, O.structuredPatch)(void 0, void 0, t, e)
  }
  return e
}
function U(e) {
...
function J(e, t, n, r, i) {
  ...
  for (
    ...
    if (('-' !== s[0] && '+' !== s[0]) || ('-' !== a[0] && '+' !== a[0]))
      if ('+' === s[0] && ' ' === a[0]) {
        var l
        ;(l = e.lines).push.apply(l, $(ee(u)))
      } else if ('+' === a[0] && ' ' === s[0]) {
        var c
        ;(c = e.lines).push.apply(c, $(ee(o)))
      } else
        '-' === s[0] && ' ' === a[0]
          ? Y(e, u, o)
          : '-' === a[0] && ' ' === s[0]
...
function X(e, t, n) {
  ...
  if (te(r) && te(i)) {
    var u, o
    if ((0, _.arrayStartsWith)(r, i) && ne(n, r, r.length - i.length))
      return void (u = e.lines).push.apply(u, $(r))
    if ((0, _.arrayStartsWith)(i, r) && ne(t, i, i.length - r.length))
      return void (o = e.lines).push.apply(o, $(i))
  } else if ((0, _.arrayEqual)(r, i)) {
    var s
    return void (s = e.lines).push.apply(s, $(r))
  }
  K(e, r, i)
}
function Y(e, t, n, r) {
  ...
  o.merged
    ? (i = e.lines).push.apply(i, $(o.merged))
    : K(e, r ? o : u, r ? u : o)
}
function K(e, t, n) {
...
var ie = Object.defineProperty({ calcLineCount: M, merge: R }, '__esModule', {
    value: !0,
  }),
  ue = function (e) {
...
var oe = Object.defineProperty({ convertChangesToDMP: ue }, '__esModule', {
    value: !0,
  }),
  se = function (e) {
...
var le = Object.defineProperty({ convertChangesToXML: se }, '__esModule', {
    value: !0,
  }),
  ce = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      Object.defineProperty(t, 'diffTrimmedLines', {
        enumerable: !0,
        get: function () {
          return c.diffTrimmedLines
        },
      }),
      Object.defineProperty(t, 'diffSentences', {
        enumerable: !0,
        get: function () {
          return p.diffSentences
        },
      }),
...
const ge = { type: 'break-parent' },
  me = { type: 'line', hard: !0 },
  ye = { type: 'line', hard: !0, literal: !0 },
  De = pe([me, ge]),
  Ee = pe([ye, ge])
var be = {
    concat: pe,
    ...
    addAlignmentToDoc: function (e, t, n) {
      ...
      if (t > 0) {
        ...
        ;(r = de(t % n, r)), (r = de(Number.NEGATIVE_INFINITY, r))
      }
      return r
    },
    ...
    hardlineWithoutBreakParent: me,
    literallineWithoutBreakParent: ye,
    label: function (e, t) {
...
var Be = (e) => e[e.length - 1],
  ke = function (e) {
    return e && e.Math == Math && e
  },
  Ne =
    ke('object' == typeof globalThis && globalThis) ||
    ke('object' == typeof window && window) ||
    ke('object' == typeof self && self) ||
    ke('object' == typeof n && n) ||
    (function () {
      return this
    })() ||
  ...
  Ve = Pe(function () {
    ...
    ? function (e) {
        return 'String' == Re(e) ? $e.call(e, '') : Object(e)
      }
    : Object,
  qe = function (e) {
  ...
  ze = function (e, t) {
    if (!Ue(e)) return e
    var n, r
    if (t && 'function' == typeof (n = e.toString) && !Ue((r = n.call(e))))
      return r
  ...
  Je =
    Object.hasOwn ||
    function (e, t) {
      return He.call(Ge(e), t)
    },
  Xe = Ne.document,
  Ye = Ue(Xe) && Ue(Xe.createElement),
  Ke =
    !Oe &&
    !Pe(function () {
      return (
  ...
  Ze = {
    f: Oe
      ? Qe
      : function (e, t) {
          if (((e = We(e)), (t = ze(t, !0)), Ke))
            try {
              return Qe(e, t)
            } catch (e) {}
          if (Je(e, t)) return _e(!Le.f.call(e, t), e[t])
        },
  },
  et = function (e) {
    if (!Ue(e)) throw TypeError(String(e) + ' is not an object')
    return e
  },
  ...
  ut = Ne['__core-js_shared__'] || it('__core-js_shared__', {}),
  ot = Function.toString
'function' != typeof ut.inspectSource &&
  (ut.inspectSource = function (e) {
    return ot.call(e)
  })
var st,
  at,
  ...
  pt = ut.inspectSource,
  ft = Ne.WeakMap,
  dt = 'function' == typeof ft && /native code/.test(pt(ft)),
  ht = i(function (e) {
    ;(e.exports = function (e, t) {
      return ut[e] || (ut[e] = void 0 !== t ? t : {})
    })('versions', []).push({
      version: '3.13.1',
      mode: 'global',
  ...
  bt = Ne.WeakMap
if (dt || ut.state) {
  var Ct = ut.state || (ut.state = new bt()),
    vt = Ct.get,
    At = Ct.has,
    Ft = Ct.set
  ;(st = function (e, t) {
    if (At.call(Ct, e)) throw new TypeError('Object already initialized')
    return (t.facade = e), Ft.call(Ct, e, t), t
  }),
    (at = function (e) {
      return vt.call(Ct, e) || {}
    }),
  ...
  var xt = Dt[(ct = 'state')] || (Dt[ct] = yt(ct))
  ;(Et[xt] = !0),
    (st = function (e, t) {
      if (Je(e, xt)) throw new TypeError('Object already initialized')
...
var St,
  ...
  Tt = {
    ...
    has: lt,
    enforce: function (e) {
      return lt(e) ? at(e) : st(e, {})
    },
    getterFor: function (e) {
      return function (t) {
        var n
        if (!Ue(t) || (n = at(t)).type !== e)
  ...
  Bt = i(function (e) {
    ...
    ;(e.exports = function (e, t, i, u) {
      var o,
        ...
        l = !!u && !!u.noTargetGet
      'function' == typeof i &&
        ('string' != typeof t || Je(i, 'name') || rt(i, 'name', t),
        (o = n(i)).source ||
          (o.source = r.join('string' == typeof t ? t : ''))),
        e !== Ne
          ? (s ? !l && e[t] && (a = !0) : delete e[t],
            a ? (e[t] = i) : rt(e, t, i))
          : a
          ? (e[t] = i)
          : it(t, i)
    })(Function.prototype, 'toString', function () {
      return ('function' == typeof this && t(this).source) || pt(this)
    })
  }),
  kt = Ne,
  Nt = function (e) {
  ...
  Pt = function (e, t) {
    return arguments.length < 2
      ? Nt(kt[e]) || Nt(Ne[e])
      : (kt[e] && kt[e][t]) || (Ne[e] && Ne[e][t])
  },
  Ot = Math.ceil,
  It = Math.floor,
  jt = function (e) {
    return isNaN((e = +e)) ? 0 : (e > 0 ? It : Ot)(e)
  },
  Lt = Math.min,
  _t = function (e) {
    return e > 0 ? Lt(jt(e), 9007199254740991) : 0
  },
  Mt = Math.max,
  Rt = Math.min,
  $t = function (e) {
  ...
  Vt = { includes: $t(!0), indexOf: $t(!1) }.indexOf,
  qt = [
    'constructor',
    'hasOwnProperty',
    'isPrototypeOf',
      ...
      function (e) {
        return (function (e, t) {
          var n,
            ...
            i = 0,
            u = []
          for (n in r) !Je(Et, n) && Je(r, n) && u.push(n)
          for (; t.length > i; ) Je(r, (n = t[i++])) && (~Vt(u, n) || u.push(n))
          return u
        })(e, qt)
      },
  },
  ...
  Gt = function (e, t) {
    for (var n = zt(t), r = nt.f, i = Ze.f, u = 0; u < n.length; u++) {
      var o = n[u]
      Je(e, o) || r(e, o, i(t, o))
    }
  },
  ...
  Jt = function (e, t) {
    var n = Yt[Xt(e)]
    return n == Qt || (n != Kt && ('function' == typeof t ? Pe(t) : !!t))
  },
  Xt = (Jt.normalize = function (e) {
  ...
  tn = function (e, t) {
    var n,
      ...
      a = e.global,
      l = e.stat
    if ((n = a ? Ne : l ? Ne[s] || it(s, {}) : (Ne[s] || {}).prototype))
      for (r in t) {
        if (
          ((u = t[r]),
          (i = e.noTargetGet ? (o = en(n, r)) && o.value : n[r]),
          !Zt(a ? r : s + (l ? '.' : '#') + r, e.forced) && void 0 !== i)
        ) {
          if (typeof u == typeof i) continue
          Gt(u, i)
        }
        ;(e.sham || (i && i.sham)) && rt(u, 'sham', !0), Bt(n, r, u, e)
      }
  },
  nn =
    Array.isArray ||
  ...
  on = function (e, t, n, r, i, u, o, s) {
    for (var a, l = i, c = 0, p = !!o && un(o, s, 3); c < r; ) {
      if (c in n) {
        if (((a = p ? p(n[c], c, t) : n[c]), u > 0 && nn(a)))
          l = on(e, t, a, _t(a.length), l, u - 1) - 1
        else {
  ...
  sn = on,
  an = Pt('navigator', 'userAgent') || '',
  ln = Ne.process,
  cn = ln && ln.versions,
  pn = cn && cn.v8
pn
  ? (wt = (St = pn.split('.'))[0] < 4 ? 1 : St[0] + St[1])
  : an &&
    (!(St = an.match(/Edge\/(\d+)/)) || St[1] >= 74) &&
    (St = an.match(/Chrome\/(\d+)/)) &&
    (wt = St[1])
var fn = wt && +wt,
  dn =
    ...
    !Pe(function () {
      ...
      return (
        ...
        (!Symbol.sham && fn && fn < 41)
      )
    }),
  hn = dn && !Symbol.sham && 'symbol' == typeof Symbol.iterator,
  gn = ht('wks'),
  mn = Ne.Symbol,
  yn = hn ? mn : (mn && mn.withoutSetter) || yt,
  Dn = function (e) {
    return (
      (Je(gn, e) && (dn || 'string' == typeof gn[e])) ||
        (dn && Je(mn, e) ? (gn[e] = mn[e]) : (gn[e] = yn('Symbol.' + e))),
      gn[e]
    )
  },
  En = Dn('species'),
  bn = function (e, t) {
    ...
    return (
      nn(e) &&
        ...
        (n !== Array && !nn(n.prototype))
          ? Ue(n) && null === (n = n[En]) && (n = void 0)
          : (n = void 0)),
...
var xn = '[object z]' === String(Fn),
  ...
  Tn = xn
    ...
    : function (e) {
        ...
        return void 0 === e
          ...
          : wn
          ? Re(t)
          : 'Object' == (r = Re(t)) && 'function' == typeof t.callee
          ? 'Arguments'
          : r
      },
  Bn = Dn('iterator'),
  kn = function (e) {
    var t = e.return
    if (void 0 !== t) return et(t.call(e)).value
  },
  Nn = function (e, t) {
  ...
  Pn = function (e, t, n) {
    ...
    if (d) r = e
      ...
      if (
        'function' !=
        typeof (i = (function (e) {
          if (null != e) return e[Bn] || e['@@iterator'] || Cn[Tn(e)]
        })(e))
      )
        throw TypeError('Target is not iterable')
      if (void 0 !== (c = i) && (Cn.Array === c || An[vn] === c)) {
        for (u = 0, o = _t(e.length); o > u; u++)
          if ((s = y(e[u])) && s instanceof Nn) return s
        return new Nn(!1)
      }
      r = i.call(e)
    }
    for (a = r.next; !(l = a.call(r)).done; ) {
      try {
        s = y(l.value)
      } catch (e) {
        throw (kn(r), e)
...
var Ln = In,
  _n = jn
function Mn(e) {
  if (Ln === setTimeout) return setTimeout(e, 0)
  if ((Ln === In || !Ln) && setTimeout)
    return (Ln = setTimeout), setTimeout(e, 0)
  try {
    return Ln(e, 0)
  } catch (t) {
    try {
      return Ln.call(null, e, 0)
    } catch (t) {
      return Ln.call(this, e, 0)
    }
  }
}
'function' == typeof On.setTimeout && (Ln = setTimeout),
  'function' == typeof On.clearTimeout && (_n = clearTimeout)
var Rn,
  $n = [],
  Vn = !1,
  qn = -1
function Wn() {
  Vn &&
    Rn &&
    ((Vn = !1), Rn.length ? ($n = Rn.concat($n)) : (qn = -1), $n.length && Un())
}
function Un() {
  if (!Vn) {
    var e = Mn(Wn)
    ...
    for (var t = $n.length; t; ) {
      for (Rn = $n, $n = []; ++qn < t; ) Rn && Rn[qn].run()
      ;(qn = -1), (t = $n.length)
    }
    ;(Rn = null),
      (Vn = !1),
      (function (e) {
        if (_n === clearTimeout) return clearTimeout(e)
        if ((_n === jn || !_n) && clearTimeout)
          return (_n = clearTimeout), clearTimeout(e)
        try {
          _n(e)
        } catch (t) {
          try {
            return _n.call(null, e)
          } catch (t) {
            return _n.call(this, e)
          }
        }
      })(e)
  }
...
var rr = {
  nextTick: function (e) {
    ...
    $n.push(new zn(e, t)), 1 !== $n.length || Vn || Mn(Un)
  },
  title: 'browser',
  browser: !0,
  env: {},
...
var ir =
  ...
  rr.env &&
  rr.env.NODE_DEBUG &&
  /\bsemver\b/i.test(rr.env.NODE_DEBUG)
...
var ur = {
  ...
  or = i(function (e, t) {
    const { MAX_SAFE_COMPONENT_LENGTH: n } = ur,
      r = ((t = e.exports = {}).re = []),
      i = (t.src = []),
      u = (t.t = {})
    let o = 0
    const s = (e, t, n) => {
      const s = o++
      ir(s, t), (u[e] = s), (i[s] = t), (r[s] = new RegExp(t, n ? 'g' : void 0))
    }
    s('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
      ...
      s('FULLPLAIN', `v?${i[u.MAINVERSION]}${i[u.PRERELEASE]}?${i[u.BUILD]}?`),
      s('FULL', `^${i[u.FULLPLAIN]}$`),
      s(
        'LOOSEPLAIN',
        `[v=\\s]*${i[u.MAINVERSIONLOOSE]}${i[u.PRERELEASELOOSE]}?${i[u.BUILD]}?`
      ),
...
const sr = ['includePrerelease', 'loose', 'rtl']
var ar = (e) =>
  e
    ? 'object' != typeof e
      ? { loose: !0 }
      : sr.filter((t) => e[t]).reduce((e, t) => ((e[t] = !0), e), {})
    : {}
const lr = /^[0-9]+$/,
  cr = (e, t) => {
    const n = lr.test(e),
...
var pr = { compareIdentifiers: cr, rcompareIdentifiers: (e, t) => cr(t, e) }
const { MAX_LENGTH: fr, MAX_SAFE_INTEGER: dr } = ur,
  { re: hr, t: gr } = or,
  { compareIdentifiers: mr } = pr
class yr {
  constructor(e, t) {
    if (((t = ar(t)), e instanceof yr)) {
      if (
        e.loose === !!t.loose &&
    ...
    if (e.length > fr)
      throw new TypeError(`version is longer than ${fr} characters`)
    ir('SemVer', e, t),
      (this.options = t),
      (this.loose = !!t.loose),
      (this.includePrerelease = !!t.includePrerelease)
    const n = e.trim().match(t.loose ? hr[gr.LOOSE] : hr[gr.FULL])
  ...
  compare(e) {
    if (
      (ir('SemVer.compare', this.version, this.options, e), !(e instanceof yr))
    ) {
      if ('string' == typeof e && e === this.version) return 0
      e = new yr(e, this.options)
    }
  ...
  compareMain(e) {
    return (
      e instanceof yr || (e = new yr(e, this.options)),
      mr(this.major, e.major) ||
        mr(this.minor, e.minor) ||
        mr(this.patch, e.patch)
    )
  }
  comparePre(e) {
    if (
    ...
    do {
      const n = this.prerelease[t],
        r = e.prerelease[t]
      if ((ir('prerelease compare', t, n, r), void 0 === n && void 0 === r))
        return 0
      if (void 0 === r) return 1
      if (void 0 === n) return -1
      if (n !== r) return mr(n, r)
    } while (++t)
  }
  compareBuild(e) {
    e instanceof yr || (e = new yr(e, this.options))
...
var Dr = yr
var Er = (e, t, n) => new Dr(e, n).compare(new Dr(t, n))
var br = (e, t, n) => Er(e, t, n) < 0
var Cr = (e, t, n) => Er(e, t, n) >= 0,
  vr = i(function (e, t) {
    function n() {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.outdent = void 0)
    ...
    var g = (function e(t) {
      ...
      return o(
        function r(u) {
          ...
          if (h(u)) {
            var c = u,
              m = (s[0] === r || s[0] === g) && p.test(c[0]) && l.test(c[1]),
              y = m ? i : n,
              D = y.get(c)
            if ((D || ((D = f(c, m, t)), y.set(c, D)), 0 === s.length))
              return D[0]
...
const xr = ['cliName', 'cliCategory', 'cliDescription'],
  Sr = { compare: Er, lt: br, gte: Cr },
  wr = t.version,
  Tr = {
...
var Br = {
  getSupportInfo: function ({
    ...
    const u = wr.split('-', 1)[0],
      o = t.flatMap((e) => e.languages || []).filter(a),
      s = ((e, t) =>
        Object.entries(e).map(([e, n]) => Object.assign({ [t]: e }, n)))(
        Object.assign({}, ...t.map(({ options: e }) => e), Tr),
        'name'
      )
        .filter((e) => a(e) && l(e))
        ...
        .map((e) => {
            ...
            Array.isArray(e.default) &&
              (e.default =
                1 === e.default.length
                  ...
                  : e.default
                      .filter(a)
                      .sort((e, t) => Sr.compare(t.since, e.since))[0].value),
            Array.isArray(e.choices) &&
              ((e.choices = e.choices.filter((e) => a(e) && l(e))),
              'parser' === e.name &&
                (function (e, t, n) {
          ...
          const n = Object.fromEntries(
            t
              ...
              .map((t) => [t.name, t.defaultOptions[e.name]])
          )
          return Object.assign(Object.assign({}, e), {}, { pluginDefaults: n })
        })
    return { languages: o, options: s }
    function a(e) {
      return n || !('since' in e) || (e.since && Sr.gte(u, e.since))
    }
    function l(e) {
      return (
        r || !('deprecated' in e) || (e.deprecated && Sr.lt(u, e.deprecated))
      )
    }
  },
}
const { getSupportInfo: kr } = Br,
  Nr = /[^\x20-\x7F]/
function Pr(e) {
  return (t, n, r) => {
...
function Mr(e, t) {
  return (
    !1 !== t && ('/' === e.charAt(t) && '/' === e.charAt(t + 1) ? Lr(e, t) : t)
  )
}
function Rr(e, t, n) {
...
function $r(e, t, n = {}) {
  const r = Ir(e, n.backwards ? t - 1 : t, n)
  return r !== Rr(e, r, n)
}
function Vr(e, t) {
  let n = null,
    r = t
  for (; r !== n; ) (n = r), (r = jr(e, r)), (r = _r(e, r)), (r = Ir(e, r))
  return (r = Mr(e, r)), (r = Rr(e, r)), !1 !== r && $r(e, r)
}
function qr(e, t) {
  let n = null,
    r = t
  for (; r !== n; )
    (n = r), (r = Ir(e, r)), (r = _r(e, r)), (r = Mr(e, r)), (r = Rr(e, r))
  return r
}
function Wr(e, t, n) {
  return qr(e, n(t))
...
var Jr = {
  inferParserByLanguage: function (e, t) {
    const { languages: n } = kr({ plugins: t.plugins }),
      r =
  ...
  getStringWidth: function (e) {
    return e ? (Nr.test(e) ? Se(e) : e.length) : 0
  },
  getMaxContinuousCount: function (e, t) {
    const n = e.match(new RegExp(`(${Te(t)})+`, 'g'))
    return null === n
      ? 0
  ...
  getLast: Be,
  getNextNonSpaceNonCommentCharacterIndexWithStartIndex: qr,
  getNextNonSpaceNonCommentCharacterIndex: Wr,
  getNextNonSpaceNonCommentCharacter: function (e, t, n) {
    return e.charAt(Wr(e, t, n))
  },
  skip: Pr,
  skipWhitespace: Or,
  skipSpaces: Ir,
  skipToLineEnd: jr,
  skipEverythingButNewLine: Lr,
  skipInlineComment: _r,
  skipTrailingComment: Mr,
  skipNewline: Rr,
  isNextLineEmptyAfterIndex: Vr,
  ...
  isPreviousLineEmpty: function (e, t, n) {
    let r = n(t) - 1
    return (
      (r = Ir(e, r, { backwards: !0 })),
      (r = Rr(e, r, { backwards: !0 })),
      (r = Ir(e, r, { backwards: !0 })),
      r !== Rr(e, r, { backwards: !0 })
    )
  },
  ...
  hasSpaces: function (e, t, n = {}) {
    return Ir(e, n.backwards ? t - 1 : t, n) !== t
  },
  getAlignmentSize: Ur,
  getIndentSize: function (e, t) {
    const n = e.lastIndexOf('\n')
    return -1 === n ? 0 : Ur(e.slice(n + 1).match(/^[\t ]*/)[0], t)
  },
  getPreferredQuote: zr,
  printString: function (e, t) {
    return Gr(
      e.slice(1, -1),
      'json' === t.parser ||
        ('json5' === t.parser && 'preserve' === t.quoteProps && !t.singleQuote)
        ? '"'
  ...
  addLeadingComment: function (e, t) {
    ;(t.leading = !0), (t.trailing = !1), Hr(e, t)
  },
  addDanglingComment: function (e, t, n) {
    ;(t.leading = !1), (t.trailing = !1), n && (t.marker = n), Hr(e, t)
  },
  addTrailingComment: function (e, t) {
    ;(t.leading = !1), (t.trailing = !0), Hr(e, t)
  },
...
const { literalline: Yr, join: Kr } = be,
  Qr = (e) => Array.isArray(e) || (e && 'concat' === e.type),
  Zr = (e) => {
...
function ai(e) {
  ...
  if (Qr(e) || 'fill' === e.type) {
    const t = Zr(e)
    for (; t.length > 1 && si(...t.slice(-2)); ) t.length -= 2
    if (t.length > 0) {
      const e = ai(Be(t))
      t[t.length - 1] = e
    }
  ...
  switch (e.type) {
    ...
    case 'line-suffix':
    case 'label': {
      const t = ai(e.contents)
      return Object.assign(Object.assign({}, e), {}, { contents: t })
    }
    case 'if-break': {
      const t = ai(e.breakContents),
        n = ai(e.flatContents)
...
function li(e) {
  return ni(e, (e) =>
    (function (e) {
      switch (e.type) {
        case 'fill':
          if (0 === e.parts.length || e.parts.every((e) => '' === e)) return ''
          break
        case 'group':
      ...
      for (const n of Zr(e)) {
        if (!n) continue
        const [e, ...r] = Qr(n) ? Zr(n) : [n]
        'string' == typeof e && 'string' == typeof Be(t)
          ? (t[t.length - 1] += e)
          : t.push(e),
          t.push(...r)
      }
...
function ci(e) {
  ...
  for (; n.length > 0; ) {
    ...
    e &&
      (Qr(e)
        ? n.unshift(...Zr(e))
        : t.length > 0 && 'string' == typeof Be(t) && 'string' == typeof e
        ? (t[t.length - 1] += e)
        : t.push(e))
  }
  return t
...
var pi = {
  ...
  propagateBreaks: function (e) {
    ...
    ti(
      e,
      function (e) {
        if (('break-parent' === e.type && ui(n), 'group' === e.type)) {
  ...
  normalizeDoc: function (e) {
    return ni(e, (e) =>
      Array.isArray(e)
        ? ci(e)
        : e.parts
        ? Object.assign(Object.assign({}, e), {}, { parts: ci(e.parts) })
        : e
    )
  },
  cleanDoc: li,
...
const { getStringWidth: fi, getLast: di } = Jr,
  { convertEndOfLineToChars: hi } = Xr,
  { fill: gi, cursor: mi, indent: yi } = be,
  { isConcat: Di, getDocParts: Ei } = pi
let bi
function Ci(e, t) {
  return Ai(e, { type: 'indent' }, t)
}
function vi(e, t, n) {
  if (t === Number.NEGATIVE_INFINITY)
    return e.root || { value: '', length: 0, queue: [] }
  if (t < 0) return Ai(e, { type: 'dedent' }, n)
  if (!t) return e
  if ('root' === t.type)
...
function Ai(e, t, n) {
  ...
  for (const e of r)
    switch (e.type) {
      case 'indent':
        c(), n.useTabs ? a(1) : l(n.tabWidth)
        break
      case 'stringAlign':
        c(), (i += e.n), (u += e.n.length)
        break
      case 'numberAlign':
        ;(o += 1), (s += e.n)
        break
...
function Fi(e) {
  ...
  let t = 0
  for (; e.length > 0 && 'string' == typeof di(e) && /^[\t ]*$/.test(di(e)); )
    t += e.pop().length
  if (e.length > 0 && 'string' == typeof di(e)) {
    const n = di(e).replace(/[\t ]*$/, '')
    ;(t += di(e).length - n.length), (e[e.length - 1] = n)
  }
  return t
}
function xi(e, t, n, r, i, u) {
  ...
  for (; n >= 0; ) {
    ...
    const [e, l, c] = s.pop()
    if ('string' == typeof c) a.push(c), (n -= fi(c))
    else if (Di(c)) {
      const t = Ei(c)
      for (let n = t.length - 1; n >= 0; n--) s.push([e, l, t[n]])
    } else
      switch (c.type) {
        case 'indent':
          s.push([Ci(e, r), l, c.contents])
          break
        case 'align':
          s.push([vi(e, c.n, r), l, c.contents])
          break
        case 'trim':
          n += Fi(a)
          break
        case 'group': {
          ...
          s.push([
            e,
            t,
            c.expandedStates && 1 === t ? di(c.expandedStates) : c.contents,
          ]),
            c.id && (bi[c.id] = t)
          break
        }
        case 'fill':
          for (let t = c.parts.length - 1; t >= 0; t--)
            s.push([e, l, c.parts[t]])
          break
        case 'if-break':
        case 'indent-if-break': {
          const t = c.groupId ? bi[c.groupId] : l
          if (1 === t) {
            const t =
              'if-break' === c.type
                ? c.breakContents
  ...
  printDocToString: function (e, t) {
    ...
    for (; u.length > 0; ) {
      ...
      if ('string' == typeof c) {
        ...
        const t = Ei(c)
        for (let n = t.length - 1; n >= 0; n--) u.push([e, l, t[n]])
      } else
        switch (c.type) {
          case 'cursor':
            o.push(mi.placeholder)
            break
          case 'indent':
            u.push([Ci(e, t), l, c.contents])
            break
          case 'align':
            u.push([vi(e, c.n, t), l, c.contents])
            break
          case 'trim':
            i -= Fi(o)
            break
          case 'group':
            switch (l) {
              case 2:
                if (!s) {
                  u.push([e, c.break ? 1 : 2, c.contents])
                  break
                }
              case 1: {
                s = !1
                const r = [e, 2, c.contents],
                  o = n - i,
                  l = a.length > 0
                if (!c.break && xi(r, u, o, t, l)) u.push(r)
                else if (c.expandedStates) {
                  const n = di(c.expandedStates)
                  if (c.break) {
                    u.push([e, 1, n])
                    break
                  }
                  for (let r = 1; r < c.expandedStates.length + 1; r++) {
                    if (r >= c.expandedStates.length) {
                      u.push([e, 1, n])
                      break
                    }
                    {
                      const n = [e, 2, c.expandedStates[r]]
                      if (xi(n, u, o, t, l)) {
                        u.push(n)
                        break
                      }
          ...
          case 'fill': {
            ...
            o.splice(0, 2)
            const y = [e, l, gi(o)]
            xi([e, 2, [s, p, o[0]]], [], r, t, a.length > 0, !0)
              ? u.push(y, g, f)
              : h
              ? u.push(y, m, f)
              : u.push(y, m, d)
          ...
          case 'line-suffix':
            a.push([e, l, c.contents])
            break
          case 'line-suffix-boundary':
            a.length > 0 && u.push([e, l, { type: 'line', hard: !0 }])
            break
          case 'line':
            switch (l) {
              case 2:
              ...
              case 1:
                ...
                c.literal
                  ? e.root
                    ...
                    : (o.push(r), (i = 0))
                  : ((i -= Fi(o)), o.push(r + e.value), (i = e.length))
            }
            break
          case 'label':
            u.push([e, l, c.contents])
        }
      0 === u.length && a.length > 0 && (u.push(...a.reverse()), (a = []))
    }
    const l = o.indexOf(mi.placeholder)
    if (-1 !== l) {
      const e = o.indexOf(mi.placeholder, l + 1),
        t = o.slice(0, l).join(''),
        n = o.slice(l + 1, e).join('')
      return {
...
const { isConcat: wi, getDocParts: Ti } = pi
function Bi(e) {
  if (!e) return ''
  if (wi(e)) {
    const t = []
    for (const n of Ti(e))
      if (wi(n)) t.push(...Bi(n).parts)
      else {
        const e = Bi(n)
        '' !== e && t.push(e)
      }
  ...
  return 'if-break' === e.type
    ? Object.assign(
        ...
        {},
        {
          breakContents: Bi(e.breakContents),
          flatContents: Bi(e.flatContents),
        }
      )
    : 'group' === e.type
    ? Object.assign(
        ...
        {},
        {
          contents: Bi(e.contents),
          expandedStates: e.expandedStates && e.expandedStates.map(Bi),
        }
      )
    : 'fill' === e.type
    ? { type: 'fill', parts: e.parts.map(Bi) }
    : e.contents
    ? Object.assign(Object.assign({}, e), {}, { contents: Bi(e.contents) })
    : e
}
var ki = {
    builders: be,
    ...
    debug: {
      printDocToDebug: function (e) {
        ...
        return (function e(t, n, i) {
          ...
          if (wi(t)) {
            const n = Ti(t).map(e).filter(Boolean)
  ...
  Ni = Object.freeze({ __proto__: null, default: {} })
function Pi(e, t) {
...
function Ri(e, t) {
  ...
  ;(e = ji(e).substr(1)), (t = ji(t).substr(1))
  for (
    var r = n(e.split('/')),
      i = n(t.split('/')),
...
var zi =
  ...
  Hi = [],
  Ji = [],
  Xi = 'undefined' != typeof Uint8Array ? Uint8Array : Array,
  Yi = !1
function Ki() {
  Yi = !0
  for (
...
function eu(e, t, n, r, i) {
  var u,
    ...
    d = e[t + p]
  for (
    p += f, u = d & ((1 << -c) - 1), d >>= -c, c += s;
    c > 0;
    u = 256 * u + e[t + p], p += f, c -= 8
  );
  for (
    o = u & ((1 << -c) - 1), u >>= -c, c += r;
    c > 0;
...
var nu = {}.toString,
  ru =
    Array.isArray ||
    function (e) {
      return '[object Array]' == nu.call(e)
    }
function iu() {
  return ou.TYPED_ARRAY_SUPPORT ? 2147483647 : 1073741823
}
function uu(e, t) {
  if (iu() < t) throw new RangeError('Invalid typed array length')
  return (
    ou.TYPED_ARRAY_SUPPORT
      ? ((e = new Uint8Array(t)).__proto__ = ou.prototype)
      : (null === e && (e = new ou(t)), (e.length = t)),
    e
  )
}
function ou(e, t, n) {
  if (!(ou.TYPED_ARRAY_SUPPORT || this instanceof ou)) return new ou(e, t, n)
  if ('number' == typeof e) {
    if ('string' == typeof t)
      throw new Error(
...
function su(e, t, n, r) {
  ...
  return 'undefined' != typeof ArrayBuffer && t instanceof ArrayBuffer
    ...
    : (function (e, t) {
        if (fu(t)) {
          var n = 0 | pu(t.length)
          return 0 === (e = uu(e, n)).length || t.copy(e, 0, 0, n), e
        }
        if (t) {
          if (
            ...
            return 'number' != typeof t.length || (r = t.length) != r
              ? uu(e, 0)
              : cu(e, t)
          if ('Buffer' === t.type && ru(t.data)) return cu(e, t.data)
        }
        var r
        throw new TypeError(
...
function lu(e, t) {
  if ((au(t), (e = uu(e, t < 0 ? 0 : 0 | pu(t))), !ou.TYPED_ARRAY_SUPPORT))
    for (var n = 0; n < t; ++n) e[n] = 0
  return e
}
function cu(e, t) {
  var n = t.length < 0 ? 0 : 0 | pu(t.length)
  e = uu(e, n)
...
function mu(e, t, n, r, i) {
  ...
  if (('string' == typeof t && (t = ou.from(t, r)), fu(t)))
    return 0 === t.length ? -1 : yu(e, t, n, r, i)
  if ('number' == typeof t)
    return (
      (t &= 255),
      ou.TYPED_ARRAY_SUPPORT &&
...
function Eu(e, t, n, r) {
  return Vu(Ru(t, e.length - n), e, n, r)
}
function bu(e, t, n, r) {
  return Vu(
    (function (e) {
...
function Fu(e, t, n) {
  return 0 === t && n === e.length ? Zi(e) : Zi(e.slice(t, n))
}
function xu(e, t, n) {
...
;(ou.TYPED_ARRAY_SUPPORT =
  void 0 === On.TYPED_ARRAY_SUPPORT || On.TYPED_ARRAY_SUPPORT),
  (ou.poolSize = 8192),
  (ou._augment = function (e) {
    return (e.__proto__ = ou.prototype), e
  }),
  (ou.from = function (e, t, n) {
    return su(null, e, t, n)
  }),
  ou.TYPED_ARRAY_SUPPORT &&
    ((ou.prototype.__proto__ = Uint8Array.prototype),
    (ou.__proto__ = Uint8Array)),
  (ou.alloc = function (e, t, n) {
  ...
  (ou.allocUnsafe = function (e) {
    return lu(null, e)
  }),
  (ou.allocUnsafeSlow = function (e) {
    return lu(null, e)
  }),
  (ou.isBuffer = qu),
  (ou.compare = function (e, t) {
    if (!fu(e) || !fu(t)) throw new TypeError('Arguments must be Buffers')
    if (e === t) return 0
  ...
  (ou.concat = function (e, t) {
    if (!ru(e))
      throw new TypeError('"list" argument must be an Array of Buffers')
    if (0 === e.length) return ou.alloc(0)
    var n
    if (void 0 === t) for (t = 0, n = 0; n < e.length; ++n) t += e[n].length
    var r = ou.allocUnsafe(t),
      i = 0
  ...
  (ou.byteLength = du),
  (ou.prototype._isBuffer = !0),
  (ou.prototype.swap16 = function () {
    var e = this.length
    if (e % 2 != 0)
  ...
  (ou.prototype.equals = function (e) {
    if (!fu(e)) throw new TypeError('Argument must be a Buffer')
    return this === e || 0 === ou.compare(this, e)
  }),
  (ou.prototype.inspect = function () {
    var e = ''
    return (
      this.length > 0 &&
  ...
  (ou.prototype.compare = function (e, t, n, r, i) {
    if (!fu(e)) throw new TypeError('Argument must be a Buffer')
    if (
      (void 0 === t && (t = 0),
  ...
  (ou.prototype.includes = function (e, t, n) {
    return -1 !== this.indexOf(e, t, n)
  }),
  (ou.prototype.indexOf = function (e, t, n) {
    return mu(this, e, t, n, !0)
  }),
  (ou.prototype.lastIndexOf = function (e, t, n) {
    return mu(this, e, t, n, !1)
  }),
  (ou.prototype.write = function (e, t, n, r) {
    ...
    for (var u = !1; ; )
      switch (r) {
        ...
        case 'ascii':
          return bu(this, e, t, n)
        case 'latin1':
        case 'binary':
          return Cu(this, e, t, n)
        case 'base64':
          return vu(this, e, t, n)
        case 'ucs2':
        case 'ucs-2':
        case 'utf16le':
        case 'utf-16le':
...
function Nu(e, t, n, r, i, u) {
  if (!fu(e)) throw new TypeError('"buffer" argument must be a Buffer instance')
...
function Iu(e, t, n, r, i, u) {
  if (n + r > e.length) throw new RangeError('Index out of range')
  if (n < 0) throw new RangeError('Index out of range')
}
function ju(e, t, n, r, i) {
  return i || Iu(e, 0, n, 4), tu(e, t, n, r, 23, 4), n + 4
}
function Lu(e, t, n, r, i) {
  return i || Iu(e, 0, n, 8), tu(e, t, n, r, 52, 8), n + 8
}
;(ou.prototype.slice = function (e, t) {
  var n,
    r = this.length
  if (
    ...
    (n = this.subarray(e, t)).__proto__ = ou.prototype
  else {
    var i = t - e
    n = new ou(i, void 0)
  ...
  (ou.prototype.readUIntLE = function (e, t, n) {
    ;(e |= 0), (t |= 0), n || ku(e, t, this.length)
    for (var r = this[e], i = 1, u = 0; ++u < t && (i *= 256); )
      r += this[e + u] * i
    return r
  }),
  (ou.prototype.readUIntBE = function (e, t, n) {
    ;(e |= 0), (t |= 0), n || ku(e, t, this.length)
    for (var r = this[e + --t], i = 1; t > 0 && (i *= 256); )
      r += this[e + --t] * i
    return r
  }),
  (ou.prototype.readUInt8 = function (e, t) {
    return t || ku(e, 1, this.length), this[e]
  }),
  (ou.prototype.readUInt16LE = function (e, t) {
    return t || ku(e, 2, this.length), this[e] | (this[e + 1] << 8)
  }),
  (ou.prototype.readUInt16BE = function (e, t) {
    return t || ku(e, 2, this.length), (this[e] << 8) | this[e + 1]
  }),
  (ou.prototype.readUInt32LE = function (e, t) {
    return (
      t || ku(e, 4, this.length),
      (this[e] | (this[e + 1] << 8) | (this[e + 2] << 16)) +
        16777216 * this[e + 3]
    )
  }),
  (ou.prototype.readUInt32BE = function (e, t) {
    return (
      t || ku(e, 4, this.length),
      16777216 * this[e] +
  ...
  (ou.prototype.readIntLE = function (e, t, n) {
    ;(e |= 0), (t |= 0), n || ku(e, t, this.length)
    for (var r = this[e], i = 1, u = 0; ++u < t && (i *= 256); )
      r += this[e + u] * i
    return r >= (i *= 128) && (r -= Math.pow(2, 8 * t)), r
  }),
  (ou.prototype.readIntBE = function (e, t, n) {
    ;(e |= 0), (t |= 0), n || ku(e, t, this.length)
    for (var r = t, i = 1, u = this[e + --r]; r > 0 && (i *= 256); )
      u += this[e + --r] * i
    return u >= (i *= 128) && (u -= Math.pow(2, 8 * t)), u
  }),
  (ou.prototype.readInt8 = function (e, t) {
    return (
      t || ku(e, 1, this.length),
      128 & this[e] ? -1 * (255 - this[e] + 1) : this[e]
    )
  }),
  (ou.prototype.readInt16LE = function (e, t) {
    t || ku(e, 2, this.length)
    var n = this[e] | (this[e + 1] << 8)
    return 32768 & n ? 4294901760 | n : n
  }),
  (ou.prototype.readInt16BE = function (e, t) {
    t || ku(e, 2, this.length)
    var n = this[e + 1] | (this[e] << 8)
    return 32768 & n ? 4294901760 | n : n
  }),
  (ou.prototype.readInt32LE = function (e, t) {
    return (
      t || ku(e, 4, this.length),
      this[e] | (this[e + 1] << 8) | (this[e + 2] << 16) | (this[e + 3] << 24)
    )
  }),
  (ou.prototype.readInt32BE = function (e, t) {
    return (
      t || ku(e, 4, this.length),
      (this[e] << 24) | (this[e + 1] << 16) | (this[e + 2] << 8) | this[e + 3]
    )
  }),
  (ou.prototype.readFloatLE = function (e, t) {
    return t || ku(e, 4, this.length), eu(this, e, !0, 23, 4)
  }),
  (ou.prototype.readFloatBE = function (e, t) {
    return t || ku(e, 4, this.length), eu(this, e, !1, 23, 4)
  }),
  (ou.prototype.readDoubleLE = function (e, t) {
    return t || ku(e, 8, this.length), eu(this, e, !0, 52, 8)
  }),
  (ou.prototype.readDoubleBE = function (e, t) {
    return t || ku(e, 8, this.length), eu(this, e, !1, 52, 8)
  }),
  (ou.prototype.writeUIntLE = function (e, t, n, r) {
    ;((e = +e), (t |= 0), (n |= 0), r) ||
      Nu(this, e, t, n, Math.pow(2, 8 * n) - 1, 0)
    var i = 1,
      u = 0
    for (this[t] = 255 & e; ++u < n && (i *= 256); ) this[t + u] = (e / i) & 255
    return t + n
  }),
  (ou.prototype.writeUIntBE = function (e, t, n, r) {
    ;((e = +e), (t |= 0), (n |= 0), r) ||
      Nu(this, e, t, n, Math.pow(2, 8 * n) - 1, 0)
    var i = n - 1,
      u = 1
  ...
  (ou.prototype.writeUInt8 = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 1, 255, 0),
      ou.TYPED_ARRAY_SUPPORT || (e = Math.floor(e)),
      (this[t] = 255 & e),
      t + 1
    )
  }),
  (ou.prototype.writeUInt16LE = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 2, 65535, 0),
      ou.TYPED_ARRAY_SUPPORT
  ...
  (ou.prototype.writeUInt16BE = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 2, 65535, 0),
  ...
  (ou.prototype.writeUInt32LE = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 4, 4294967295, 0),
      ou.TYPED_ARRAY_SUPPORT
        ? ((this[t + 3] = e >>> 24),
          (this[t + 2] = e >>> 16),
          (this[t + 1] = e >>> 8),
  ...
  (ou.prototype.writeUInt32BE = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 4, 4294967295, 0),
  ...
  (ou.prototype.writeIntLE = function (e, t, n, r) {
    if (((e = +e), (t |= 0), !r)) {
  ...
  (ou.prototype.writeIntBE = function (e, t, n, r) {
    if (((e = +e), (t |= 0), !r)) {
      var i = Math.pow(2, 8 * n - 1)
      Nu(this, e, t, n, i - 1, -i)
    }
  ...
  (ou.prototype.writeInt8 = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 1, 127, -128),
      ou.TYPED_ARRAY_SUPPORT || (e = Math.floor(e)),
      e < 0 && (e = 255 + e + 1),
      (this[t] = 255 & e),
      t + 1
  ...
  (ou.prototype.writeInt16LE = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 2, 32767, -32768),
      ou.TYPED_ARRAY_SUPPORT
        ? ((this[t] = 255 & e), (this[t + 1] = e >>> 8))
        : Pu(this, e, t, !0),
      t + 2
  ...
  (ou.prototype.writeInt16BE = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 2, 32767, -32768),
  ...
  (ou.prototype.writeInt32LE = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 4, 2147483647, -2147483648),
      ou.TYPED_ARRAY_SUPPORT
        ? ((this[t] = 255 & e),
          (this[t + 1] = e >>> 8),
          (this[t + 2] = e >>> 16),
  ...
  (ou.prototype.writeInt32BE = function (e, t, n) {
    return (
      (e = +e),
      (t |= 0),
      n || Nu(this, e, t, 4, 2147483647, -2147483648),
  ...
  (ou.prototype.writeFloatLE = function (e, t, n) {
    return ju(this, e, t, !0, n)
  }),
  (ou.prototype.writeFloatBE = function (e, t, n) {
    return ju(this, e, t, !1, n)
  }),
  (ou.prototype.writeDoubleLE = function (e, t, n) {
    return Lu(this, e, t, !0, n)
  }),
  (ou.prototype.writeDoubleBE = function (e, t, n) {
    return Lu(this, e, t, !1, n)
  }),
  (ou.prototype.copy = function (e, t, n, r) {
    if (
      (n || (n = 0),
      r || 0 === r || (r = this.length),
  ...
  (ou.prototype.fill = function (e, t, n, r) {
    if ('string' == typeof e) {
      ...
      if ('string' == typeof r && !ou.isEncoding(r))
    ...
    if (
      ...
      var o = fu(e) ? e : Ru(new ou(e, r).toString()),
        s = o.length
      for (u = 0; u < n - t; ++u) this[u + t] = o[u % s]
    }
    return this
  })
var _u = /[^+\/0-9A-Za-z-_]/g
function Mu(e) {
...
function $u(e) {
  return (function (e) {
    ...
    return (
      2 === u
        ? ((i = (Ji[e.charCodeAt(t)] << 2) | (Ji[e.charCodeAt(t + 1)] >> 4)),
          (o[a++] = 255 & i))
        : 1 === u &&
          ((i =
...
var zu = class {
  constructor(e, t) {
    ;(t = t || {}).readChunk || (t.readChunk = 1024),
      ...
      (this.fd = 'number' == typeof e ? e : Uu.openSync(e, 'r')),
      (this.options = t),
  ...
  close() {
    Uu.closeSync(this.fd), (this.fd = null)
  }
  _extractLines(e) {
    let t
    const n = []
  ...
  _readChunk(e) {
    ...
    const r = []
    do {
      const e = new ou(this.options.readChunk)
      ;(t = Uu.readSync(
        this.fd,
        e,
        0,
    ...
    return (
      ...
      n &&
        ...
        e && (this.linesCache[0] = ou.concat([e, this.linesCache[0]]))),
      n
    )
  }
  next() {
...
var Yu = {
    ConfigError: Gu,
    DebugError: Hu,
    UndefinedParserError: Ju,
    ArgExpansionBailout: Xu,
  },
  Ku = function (e, t) {
    return (Ku =
...
var no = Object.freeze({
    ...
    __decorate: function (e, t, n, r) {
      ...
      if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
        ...
        for (var s = e.length - 1; s >= 0; s--)
          (i = e[s]) && (o = (u < 3 ? i(o) : u > 3 ? i(t, n, o) : i(t, n)) || o)
    ...
    __asyncGenerator: function (e, t, n) {
      ...
      function s(e, t) {
        try {
          ;(n = i[e](t)).value instanceof to
            ? Promise.resolve(n.value.v).then(a, l)
            : c(u[0][2], n)
        } catch (e) {
          c(u[0][3], e)
        }
        ...
        value(e) {
          ...
          return 0 === n.length
            ...
            : `{ ${n
                .map(
                  (n) =>
                    `${t.apiDescriptor.key(n)}: ${t.apiDescriptor.value(e[n])}`
                )
                .join(', ')} }`
        },
  ...
  ao = i(function (e) {
    var t = {}
    for (var n in so) so.hasOwnProperty(n) && (t[so[n]] = n)
    var r = (e.exports = {
...
function lo(e) {
  var t = (function () {
      for (var e = {}, t = Object.keys(ao), n = t.length, r = 0; r < n; r++)
  ...
  for (t[e].distance = 0; n.length; )
    for (
      var r = n.pop(), i = Object.keys(ao[r]), u = i.length, o = 0;
      o < u;
      o++
    ) {
      var s = i[o],
...
function po(e, t) {
  for (
    var n = [t[e].parent, e], r = ao[t[e].parent][e], i = t[e].parent;
    t[i].parent;

  )
    n.unshift(t[i].parent), (r = co(ao[t[i].parent][i], r)), (i = t[i].parent)
  return (r.conversion = n), r
}
var fo = {}
Object.keys(ao).forEach(function (e) {
  ;(fo[e] = {}),
    Object.defineProperty(fo[e], 'channels', { value: ao[e].channels }),
    Object.defineProperty(fo[e], 'labels', { value: ao[e].labels })
  var t = (function (e) {
    for (
      var t = lo(e), n = {}, r = Object.keys(t), i = r.length, u = 0;
      u < i;
      u++
    ) {
      var o = r[u]
      null !== t[o].parent && (n[o] = po(o, t))
    }
    return n
  })(e)
  ...
  mo = i(function (e) {
    ...
    Object.defineProperty(e, 'exports', {
      ...
      get: function () {
        ...
        for (let e of Object.keys(go)) {
          if ('object' != typeof go[e]) continue
          const u = go[e]
          'ansi16' === e && (e = 'ansi'),
            'ansi16' in u &&
...
function Do() {
  return void 0 !== On.location ? On.location.hostname : ''
}
function Eo() {
  return []
}
...
function xo() {
  return void 0 !== On.navigator ? On.navigator.appVersion : ''
}
function So() {}
function wo() {}
function To() {
...
var No = ko,
  Po = {
    ...
    tmpdir: No,
    tmpDir: ko,
    networkInterfaces: So,
    getNetworkInterfaces: wo,
    release: xo,
    type: Fo,
    cpus: Ao,
    totalmem: vo,
...
function _o(e) {
  return (function (e) {
    ...
    (function (e) {
      if (!1 === Lo) return 0
      if (Oo('color=16m') || Oo('color=full') || Oo('color=truecolor')) return 3
      if (Oo('color=256')) return 2
      if (e && !e.isTTY && !0 !== Lo) return 0
      const t = Lo ? 1 : 0
      if ('win32' === rr.platform) {
        const e = Io.release().split('.')
        return Number(rr.versions.node.split('.')[0]) >= 8 &&
          Number(e[0]) >= 10 &&
          Number(e[2]) >= 10586
          ? Number(e[2]) >= 14931
            ? 3
      ...
      if ('CI' in jo)
        return ['TRAVIS', 'CIRCLECI', 'APPVEYOR', 'GITLAB_CI'].some(
          ...
          ? 1
          : t
      if ('TEAMCITY_VERSION' in jo)
        return /^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(jo.TEAMCITY_VERSION) ? 1 : 0
      if ('truecolor' === jo.COLORTERM) return 3
      if ('TERM_PROGRAM' in jo) {
        const e = parseInt((jo.TERM_PROGRAM_VERSION || '').split('.')[0], 10)
        switch (jo.TERM_PROGRAM) {
          case 'iTerm.app':
            return e >= 3 ? 3 : 2
          case 'Apple_Terminal':
            return 2
      ...
      return /-256(color)?$/i.test(jo.TERM)
        ? 2
...
Oo('no-color') || Oo('no-colors') || Oo('color=false')
  ? (Lo = !1)
  : (Oo('color') || Oo('colors') || Oo('color=true') || Oo('color=always')) &&
    (Lo = !0),
  'FORCE_COLOR' in jo &&
    (Lo = 0 === jo.FORCE_COLOR.length || 0 !== parseInt(jo.FORCE_COLOR, 10))
var Mo = { supportsColor: _o, stdout: _o(rr.stdout), stderr: _o(rr.stderr) }
const Ro =
    /(?:\\(u[a-f\d]{4}|x[a-f\d]{2}|.))|(?:\{(~)?(\w+(?:\([^)]*\))?(?:\.\w+(?:\([^)]*\))?)*)(?:[ \t]|(?=\r?\n)))|(\})|((?:.|[\r\n\f])+?)/gi,
  $o = /(?:^|\.)(\w+)(?:\(([^)]*)\))?/g,
  Vo = /^(['"])((?:\\.|(?!\1)[^\\])*)\1$/,
  qo = /\\(u[a-f\d]{4}|x[a-f\d]{2}|.)|([^\\])/gi,
  Wo = new Map([
    ['n', '\n'],
    ['r', '\r'],
    ['t', '\t'],
...
function zo(e, t) {
  ...
  for (const t of r)
    if (isNaN(t)) {
      ...
      n.push(i[2].replace(qo, (e, t, n) => (t ? Uo(t) : n)))
...
var Jo = (e, t) => {
    ...
    let i = []
    if (
      (t.replace(Ro, (t, u, o, s, a, l) => {
        if (u) i.push(Uo(u))
        else if (s) {
          const t = i.join('')
          ;(i = []),
            r.push(0 === n.length ? t : Ho(e, n)(t)),
            n.push({ inverse: o, styles: Go(s) })
        } else if (a) {
          if (0 === n.length)
            throw new Error('Found extraneous } in Chalk template literal')
          r.push(Ho(e, n)(i.join(''))), (i = []), n.pop()
        } else i.push(l)
      }),
      r.push(i.join('')),
      n.length > 0)
  ...
  Xo = i(function (e) {
    const t = Mo.stdout,
      n =
        'win32' === rr.platform &&
        !(rr.env.TERM || '').toLowerCase().startsWith('xterm'),
    ...
    n && (mo.blue.open = '\x1b[94m')
    for (const e of Object.keys(mo))
      (mo[e].closeRe = new RegExp(oo(mo[e].close), 'g')),
        (u[e] = {
          get() {
            const t = mo[e]
            return l.call(
    ...
    ;(u.visible = {
      ...
      (mo.color.closeRe = new RegExp(oo(mo.color.close), 'g'))
    for (const e of Object.keys(mo.color.ansi))
      i.has(e) ||
        (u[e] = {
          get() {
            const t = this.level
            return function () {
              const n = mo.color[r[t]][e].apply(null, arguments),
                i = {
                  open: n,
                  close: mo.color.close,
                  closeRe: mo.color.closeRe,
                }
              return l.call(
                this,
    ...
    mo.bgColor.closeRe = new RegExp(oo(mo.bgColor.close), 'g')
    for (const e of Object.keys(mo.bgColor.ansi)) {
      if (i.has(e)) continue
      u['bg' + e[0].toUpperCase() + e.slice(1)] = {
        get() {
          const t = this.level
          return function () {
            const n = mo.bgColor[r[t]][e].apply(null, arguments),
              i = {
                open: n,
                close: mo.bgColor.close,
                closeRe: mo.bgColor.closeRe,
              }
            return l.call(
              this,
              this._styles ? this._styles.concat(i) : [i],
  ...
  Yo = Object.defineProperty(
    {
      commonDeprecatedHandler: (e, t, { descriptor: n }) => {
        ...
        return (
          t &&
            r.push(
              `we now treat it as ${Xo.default.blue(
  ...
  Ko = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      no.__exportStar(Yo, t)
  }),
  Qo = Object.defineProperty(
    {
      commonInvalidHandler: (e, t, n) =>
        [
          `Invalid ${Xo.default.red(n.descriptor.key(e))} value.`,
          `Expected ${Xo.default.blue(n.schemas[e].expected(n))},`,
          `but received ${Xo.default.red(n.descriptor.value(t))}.`,
        ].join(' '),
    },
    '__esModule',
    { value: !0 }
  ...
  Zo = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      no.__exportStar(Qo, t)
  }),
  es = [],
  ts = [],
  ns = Object.defineProperty(
    {
      levenUnknownHandler: (e, t, { descriptor: n, logger: r, schemas: i }) => {
        const u = [
            `Ignored unknown option ${Xo.default.yellow(
              ...
              (t) =>
                (function (e, t) {
                  ...
                  for (
                    ...
                    l++
                  if (((i -= l), 0 == (r -= l))) return i
                  for (var c = 0, p = 0; c < r; )
                    (ts[l + c] = e.charCodeAt(l + c)), (es[c] = ++c)
                  for (; p < i; )
                    for (
                      u = t.charCodeAt(l + p), s = p++, o = p, c = 0;
                      c < r;
                      c++
                    )
                      (a = u === ts[l + c] ? s : s + 1),
        ...
        o && u.push(`Did you mean ${Xo.default.blue(n.key(o))}?`),
          r.warn(u.join(' '))
      },
    },
    '__esModule',
  ...
  rs = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      no.__exportStar(ns, t)
  }),
  is = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      no.__exportStar(Ko, t),
      no.__exportStar(Zo, t),
      no.__exportStar(rs, t)
  })
const us = [
  'default',
  'expected',
...
function os(e, t) {
  const n = new e(t),
    r = Object.create(n)
  for (const e of us) e in t && (r[e] = cs(t[e], n, as.prototype[e].length))
  return r
}
var ss = os
class as {
...
var ps = Object.defineProperty({ createSchema: ss, Schema: ls }, '__esModule', {
  value: !0,
})
class fs extends ps.Schema {
  constructor(e) {
...
var ds = fs,
  hs = Object.defineProperty({ AliasSchema: ds }, '__esModule', {
    value: !0,
  })
class gs extends ps.Schema {
  expected() {
    return 'anything'
  }
  validate() {
...
var ms = gs,
  ys = Object.defineProperty({ AnySchema: ms }, '__esModule', { value: !0 })
class Ds extends ps.Schema {
  constructor(e) {
    var { valueSchema: t, name: n = t.name } = e,
      r = no.__rest(e, ['valueSchema', 'name'])
  ...
  redirect(e, t) {
    ...
    for (const i of e) {
      ...
      'remain' in e && n.push(e.remain), r.push(...e.redirect.map(bs))
    }
...
var Cs = Object.defineProperty({ ArraySchema: Es }, '__esModule', {
  value: !0,
})
class vs extends ps.Schema {
  expected() {
...
var As = vs,
  Fs = Object.defineProperty({ BooleanSchema: As }, '__esModule', {
    value: !0,
  })
var xs = function (e, t) {
...
var _s = Ls
var Ms = function (e, t) {
    const n = Ls('object' == typeof e && 'redirect' in e ? e.redirect : e, t)
    return 0 === n.length
      ? { remain: t, redirect: n }
  ...
  Rs = Object.defineProperty(
    {
      recordFromArray: xs,
      mapFromArray: Ss,
      createAutoChecklist: ws,
      partition: Ts,
      isInt: Bs,
      comparePrimitive: ks,
      normalizeDefaultResult: Ns,
      normalizeValidateResult: Ps,
      normalizeDeprecatedResult: Os,
      normalizeTransferResult: js,
      normalizeForwardResult: _s,
      normalizeRedirectResult: Ms,
    },
    '__esModule',
    { value: !0 }
  )
class $s extends ps.Schema {
  constructor(e) {
    super(e),
      (this._choices = Rs.mapFromArray(
...
var Vs = $s,
  qs = Object.defineProperty({ ChoiceSchema: Vs }, '__esModule', {
    value: !0,
  })
class Ws extends ps.Schema {
  expected() {
    return 'a number'
  }
  validate(e, t) {
...
var Us = Ws,
  zs = Object.defineProperty({ NumberSchema: Us }, '__esModule', {
    value: !0,
  })
class Gs extends zs.NumberSchema {
  expected() {
    return 'an integer'
  }
  validate(e, t) {
    return (
      !0 === t.normalizeValidateResult(super.validate(e, t), e) && Rs.isInt(e)
    )
  }
}
var Hs = Gs,
  Js = Object.defineProperty({ IntegerSchema: Hs }, '__esModule', {
    value: !0,
  })
class Xs extends ps.Schema {
  expected() {
    return 'a string'
  }
  validate(e) {
...
var Ys = Xs,
  Ks = Object.defineProperty({ StringSchema: Ys }, '__esModule', {
    value: !0,
  }),
  Qs = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      no.__exportStar(hs, t),
      no.__exportStar(ys, t),
      no.__exportStar(Cs, t),
      no.__exportStar(Fs, t),
      no.__exportStar(qs, t),
      no.__exportStar(Js, t),
      no.__exportStar(zs, t),
      no.__exportStar(Ks, t)
  }),
  Zs = ro.apiDescriptor,
  ea = ns.levenUnknownHandler,
  ta = Zo.commonInvalidHandler,
  na = Yo.commonDeprecatedHandler,
  ra = Object.defineProperty(
    {
      defaultDescriptor: Zs,
      defaultUnknownHandler: ea,
      defaultInvalidHandler: ta,
      defaultDeprecatedHandler: na,
    },
    '__esModule',
    { value: !0 }
  )
class ia {
  constructor(e, t) {
    const {
      logger: n = console,
      descriptor: r = ra.defaultDescriptor,
      unknown: i = ra.defaultUnknownHandler,
      invalid: u = ra.defaultInvalidHandler,
      deprecated: o = ra.defaultDeprecatedHandler,
    } = t || {}
    ;(this._utils = {
      descriptor: r,
      logger: n || { warn: () => {} },
      schemas: Rs.recordFromArray(e, 'name'),
      normalizeDefaultResult: Rs.normalizeDefaultResult,
      normalizeDeprecatedResult: Rs.normalizeDeprecatedResult,
      normalizeForwardResult: Rs.normalizeForwardResult,
      normalizeRedirectResult: Rs.normalizeRedirectResult,
      normalizeValidateResult: Rs.normalizeValidateResult,
    }),
  ...
  cleanHistory() {
    this._hasDeprecationWarned = Rs.createAutoChecklist()
  }
  normalize(e) {
    const t = {},
      n = [e],
    ...
    for (const e of Object.keys(this._utils.schemas)) {
      ...
      if (!(e in t)) {
        const t = Rs.normalizeDefaultResult(r.default(this._utils))
  ...
  _applyNormalization(e, t) {
    const n = [],
      [r, i] = Rs.partition(Object.keys(e), (e) => e in this._utils.schemas)
    for (const i of r) {
      const r = this._utils.schemas[i],
        u = r.preprocess(e[i], this._utils),
        o = Rs.normalizeValidateResult(r.validate(u, this._utils), u)
      if (!0 !== o) {
        const { value: e } = o,
      ...
      const s = ({ from: e, to: t }) => {
        ...
        a = ({ value: e, redirectTo: t }) => {
          const n = Rs.normalizeDeprecatedResult(
      ...
      Rs.normalizeForwardResult(r.forward(u, this._utils), u).forEach(s)
      const l = Rs.normalizeRedirectResult(r.redirect(u, this._utils), u)
      if ((l.redirect.forEach(s), 'remain' in l)) {
        const e = l.remain
        ;(t[i] = i in t ? r.overlap(t[i], e, this._utils) : e), a({ value: e })
      }
      for (const { from: e, to: t } of l.redirect)
        a({ value: e, redirectTo: t })
    }
    for (const r of i) {
      const i = e[r],
...
var ua = ia,
  oa = Object.defineProperty(
    { normalize: (e, t, n) => new ia(t, n).normalize(e), Normalizer: ua },
    '__esModule',
    { value: !0 }
  ),
  sa = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 }),
      no.__exportStar(io, t),
      no.__exportStar(is, t),
      no.__exportStar(Qs, t),
      no.__exportStar(oa, t),
      no.__exportStar(ps, t)
  })
const aa = [],
  la = [],
  ca = (e, t) => {
    ...
    let u,
      ...
      a,
      l = 0
    for (; l < r && e.charCodeAt(l) === t.charCodeAt(l); ) l++
    if (((r -= l), (i -= l), 0 === r)) return i
    let c = 0,
      p = 0
    for (; c < r; ) (la[c] = e.charCodeAt(l + c)), (aa[c] = ++c)
    for (; p < i; )
      for (u = t.charCodeAt(l + p), s = p++, o = p, c = 0; c < r; c++)
        (a = u === la[c] ? s : s + 1),
          (s = aa[c]),
          (o = aa[c] = s > o ? (a > o ? o + 1 : a) : a > s ? s + 1 : a)
    return o
  }
var pa = ca,
  fa = ca
...
const ha = {}
for (const e of Object.keys(da)) ha[da[e]] = e
const ga = {
  rgb: { channels: 3, labels: 'rgb' },
  hsl: { channels: 3, labels: 'hsl' },
  hsv: { channels: 3, labels: 'hsv' },
...
for (const e of Object.keys(ga)) {
  if (!('channels' in ga[e])) throw new Error('missing channels property: ' + e)
  if (!('labels' in ga[e]))
    throw new Error('missing channel labels property: ' + e)
  if (ga[e].labels.length !== ga[e].channels)
    throw new Error('channel and label counts mismatch: ' + e)
  const { channels: t, labels: n } = ga[e]
  delete ga[e].channels,
    delete ga[e].labels,
    Object.defineProperty(ga[e], 'channels', { value: t }),
    Object.defineProperty(ga[e], 'labels', { value: n })
}
function ya(e) {
  const t = (function () {
      const e = {},
...
function Ea(e, t) {
  ...
  let r = ma[t[e].parent][e],
    i = t[e].parent
  for (; t[i].parent; )
    n.unshift(t[i].parent), (r = Da(ma[t[i].parent][i], r)), (i = t[i].parent)
  return (r.conversion = n), r
}
;(ga.rgb.hsl = function (e) {
  const t = e[0] / 255,
    n = e[1] / 255,
    r = e[2] / 255,
    i = Math.min(t, n, r),
  ...
  const l = (i + u) / 2
  return (
    (a = u === i ? 0 : l <= 0.5 ? o / (u + i) : o / (2 - u - i)),
    [s, 100 * a, 100 * l]
  )
}),
  (ga.rgb.hsv = function (e) {
    let t, n, r, i, u
    const o = e[0] / 255,
      s = e[1] / 255,
      a = e[2] / 255,
  ...
  (ga.rgb.keyword = function (e) {
    const t = ha[e]
    if (t) return t
    let n,
      r = 1 / 0
    for (const t of Object.keys(da)) {
      const o =
        ((u = da[t]),
  ...
  (ga.keyword.rgb = function (e) {
    return da[e]
  }),
  (ga.rgb.xyz = function (e) {
    let t = e[0] / 255,
      n = e[1] / 255,
      r = e[2] / 255
  ...
  (ga.rgb.lab = function (e) {
    const t = ga.rgb.xyz(e)
    let n = t[0],
      r = t[1],
      i = t[2]
    ;(n /= 95.047),
  ...
  (ga.lch.lab = function (e) {
    const t = e[0],
      n = e[1],
      r = (e[2] / 360) * 2 * Math.PI
    return [t, n * Math.cos(r), n * Math.sin(r)]
  }),
  (ga.rgb.ansi16 = function (e, t = null) {
    const [n, r, i] = e
    let u = null === t ? ga.rgb.hsv(e)[2] : t
  ...
  (ga.hsv.ansi16 = function (e) {
    return ga.rgb.ansi16(ga.hsv.rgb(e), e[2])
  }),
  (ga.rgb.ansi256 = function (e) {
    const t = e[0],
      n = e[1],
      r = e[2]
    if (t === n && n === r)
  ...
  (ga.hcg.hsv = function (e) {
    const t = e[1] / 100,
      n = t + (e[2] / 100) * (1 - t)
    let r = 0
    return n > 0 && (r = t / n), [e[0], 100 * r, 100 * n]
  }),
  (ga.hcg.hsl = function (e) {
    const t = e[1] / 100,
      n = (e[2] / 100) * (1 - t) + 0.5 * t
    let r = 0
    return (
  ...
  (ga.hcg.hwb = function (e) {
    const t = e[1] / 100,
      n = t + (e[2] / 100) * (1 - t)
    return [e[0], 100 * (n - t), 100 * (1 - n)]
  }),
  (ga.hwb.hcg = function (e) {
    const t = e[1] / 100,
      n = 1 - e[2] / 100,
      r = n - t
    let i = 0
  ...
  (ga.apple.rgb = function (e) {
    return [(e[0] / 65535) * 255, (e[1] / 65535) * 255, (e[2] / 65535) * 255]
  }),
  (ga.rgb.apple = function (e) {
    return [(e[0] / 255) * 65535, (e[1] / 255) * 65535, (e[2] / 255) * 65535]
  }),
  (ga.gray.rgb = function (e) {
    return [(e[0] / 100) * 255, (e[0] / 100) * 255, (e[0] / 100) * 255]
  }),
  (ga.gray.hsl = function (e) {
    return [0, 0, e[0]]
  }),
  (ga.gray.hsv = ga.gray.hsl),
  (ga.gray.hwb = function (e) {
    return [0, 100, e[0]]
  }),
  (ga.gray.cmyk = function (e) {
    return [0, 0, 0, e[0]]
  }),
  (ga.gray.lab = function (e) {
    return [e[0], 0, 0]
  }),
  (ga.gray.hex = function (e) {
    const t = 255 & Math.round((e[0] / 100) * 255),
      n = ((t << 16) + (t << 8) + t).toString(16).toUpperCase()
    return '000000'.substring(n.length) + n
  }),
  (ga.rgb.gray = function (e) {
    return [((e[0] + e[1] + e[2]) / 3 / 255) * 100]
  })
const ba = {}
Object.keys(ma).forEach((e) => {
  ;(ba[e] = {}),
    Object.defineProperty(ba[e], 'channels', { value: ma[e].channels }),
    Object.defineProperty(ba[e], 'labels', { value: ma[e].labels })
  const t = (function (e) {
    const t = ya(e),
      n = {},
      r = Object.keys(t)
  ...
  va = i(function (e) {
    ...
    const a = (e, t, n, r) => {
      ...
      for (const [r, o] of Object.entries(s)) {
        ...
        r === t ? (u[s] = e(n, i)) : 'object' == typeof o && (u[s] = e(o[t], i))
      }
      return u
    }
    Object.defineProperty(e, 'exports', {
...
var Sa = { isatty: Aa, ReadStream: Fa, WriteStream: xa },
  wa = (e, t = rr.argv) => {
    const n = e.startsWith('-') ? '' : 1 === e.length ? '-' : '--',
      r = t.indexOf(n + e),
      i = t.indexOf('--')
...
function Pa(e, t) {
  if (0 === ka) return 0
  if (wa('color=16m') || wa('color=full') || wa('color=truecolor')) return 3
  if (wa('color=256')) return 2
  if (e && !t && void 0 === ka) return 0
  const n = ka || 0
  if ('dumb' === Ba.TERM) return n
  if ('win32' === rr.platform) {
    const e = Io.release().split('.')
  ...
  if ('CI' in Ba)
    return [
      ...
      'GITHUB_ACTIONS',
      'BUILDKITE',
    ].some((e) => e in Ba) || 'codeship' === Ba.CI_NAME
      ? 1
      : n
  if ('TEAMCITY_VERSION' in Ba)
    return /^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(Ba.TEAMCITY_VERSION) ? 1 : 0
  if ('truecolor' === Ba.COLORTERM) return 3
  if ('TERM_PROGRAM' in Ba) {
    const e = parseInt((Ba.TERM_PROGRAM_VERSION || '').split('.')[0], 10)
    switch (Ba.TERM_PROGRAM) {
      case 'iTerm.app':
        return e >= 3 ? 3 : 2
      case 'Apple_Terminal':
        return 2
  ...
  return /-256(color)?$/i.test(Ba.TERM)
    ? 2
    : /^screen|^xterm|^vt100|^vt220|^rxvt|color|ansi|cygwin|linux/i.test(
        Ba.TERM
      ) || 'COLORTERM' in Ba
...
wa('no-color') || wa('no-colors') || wa('color=false') || wa('color=never')
  ? (ka = 0)
  : (wa('color') || wa('colors') || wa('color=true') || wa('color=always')) &&
    (ka = 1),
  'FORCE_COLOR' in Ba &&
    (ka =
      'true' === Ba.FORCE_COLOR
        ? 1
        : 'false' === Ba.FORCE_COLOR
        ? 0
        : 0 === Ba.FORCE_COLOR.length
        ? 1
        : Math.min(parseInt(Ba.FORCE_COLOR, 10), 3))
var Oa = {
  supportsColor: function (e) {
    return Na(Pa(e, e && e.isTTY))
  },
  stdout: Na(Pa(!0, Ta.isatty(1))),
  stderr: Na(Pa(!0, Ta.isatty(2))),
}
var Ia = {
...
const ja =
  ...
  La = /(?:^|\.)(\w+)(?:\(([^)]*)\))?/g,
  _a = /^(['"])((?:\\.|(?!\1)[^\\])*)\1$/,
  Ma = /\\(u(?:[a-f\d]{4}|{[a-f\d]{1,6}})|x[a-f\d]{2}|.)|([^\\])/gi,
  Ra = new Map([
    ['n', '\n'],
    ['r', '\r'],
    ['t', '\t'],
...
function Va(e, t) {
  ...
  for (const t of r) {
    ...
    if (Number.isNaN(r)) {
      ...
      n.push(i[2].replace(Ma, (e, t, n) => (t ? $a(t) : n)))
    } else n.push(r)
  }
  return n
}
...
var Ua = (e, t) => {
  ...
  let i = []
  if (
    (t.replace(ja, (t, u, o, s, a, l) => {
      if (u) i.push($a(u))
      else if (s) {
        const t = i.join('')
        ;(i = []),
          r.push(0 === n.length ? t : Wa(e, n)(t)),
          n.push({ inverse: o, styles: qa(s) })
      } else if (a) {
        if (0 === n.length)
          throw new Error('Found extraneous } in Chalk template literal')
        r.push(Wa(e, n)(i.join(''))), (i = []), n.pop()
      } else i.push(l)
    }),
    r.push(i.join('')),
    n.length > 0)
...
const { stdout: za, stderr: Ga } = Oa,
  { stringReplaceAll: Ha, stringEncaseCRLFWithFirstIndex: Ja } = Ia,
  { isArray: Xa } = Array,
...
const Za = (e) => {
  ...
  return (
    ((e, t = {}) => {
      ...
      const n = za ? za.level : 0
      e.level = void 0 === t.level ? n : t.level
    })(t, e),
    (t.template = (...e) => sl(t.template, ...e)),
    Object.setPrototypeOf(t, el.prototype),
    Object.setPrototypeOf(t.template, t),
...
for (const [e, t] of Object.entries(va))
  Ka[e] = {
    get() {
      const n = il(this, rl(t.open, t.close, this._styler), this._isEmpty)
      return Object.defineProperty(this, e, { value: n }), n
    },
  }
Ka.visible = {
  get() {
    const e = il(this, this._styler, !0)
    return Object.defineProperty(this, 'visible', { value: e }), e
  },
}
const tl = ['rgb', 'hex', 'keyword', 'hsl', 'hsv', 'hwb', 'ansi', 'ansi256']
for (const e of tl)
  Ka[e] = {
    get() {
      const { level: t } = this
      return function (...n) {
        const r = rl(va.color[Ya[t]][e](...n), va.color.close, this._styler)
        return il(this, r, this._isEmpty)
      }
    },
  }
for (const e of tl) {
  Ka['bg' + e[0].toUpperCase() + e.slice(1)] = {
    get() {
      const { level: t } = this
      return function (...n) {
        const r = rl(va.bgColor[Ya[t]][e](...n), va.bgColor.close, this._styler)
        return il(this, r, this._isEmpty)
      }
    },
  }
}
const nl = Object.defineProperties(
    () => {},
    Object.assign(
      Object.assign({}, Ka),
      {},
  ...
  il = (e, t, n) => {
    const r = (...e) =>
      Xa(e[0]) && Xa(e[0].raw)
        ? ul(r, sl(r, ...e))
        : ul(r, 1 === e.length ? '' + e[0] : e.join(' '))
    return (
      Object.setPrototypeOf(r, nl),
      (r._generator = e),
      (r._styler = t),
      (r._isEmpty = n),
      r
  ...
  ul = (e, t) => {
    ...
    if (-1 !== t.indexOf('\x1b'))
      for (; void 0 !== n; ) (t = Ha(t, n.close, n.open)), (n = n.parent)
    const u = t.indexOf('\n')
    return -1 !== u && (t = Ja(t, i, r, u)), r + t + i
  }
let ol
const sl = (e, ...t) => {
  const [n] = t
  if (!Xa(n) || !Xa(n.raw)) return t.join(' ')
  const r = t.slice(1),
    i = [n.raw[0]]
  for (let e = 1; e < n.length; e++)
    i.push(String(r[e - 1]).replace(/[{}\\]/g, '\\$&'), String(n.raw[e]))
  return void 0 === ol && (ol = Ua), ol(e, i.join(''))
}
Object.defineProperties(el.prototype, Ka)
const al = el()
;(al.supportsColor = za),
  (al.stderr = el({ level: Ga ? Ga.level : 0 })),
  (al.stderr.supportsColor = Ga)
var ll = al
const cl = ['_'],
  pl = {
    key: (e) => (1 === e.length ? `-${e}` : `--${e}`),
    value: (e) => sa.apiDescriptor.value(e),
    pair: ({ key: e, value: t }) =>
      !1 === t
        ? `--no-${e}`
        : !0 === t
        ? pl.key(e)
        : '' === t
        ? `${pl.key(e)} without an argument`
        : `${pl.key(e)}=${t}`,
  }
class fl extends sa.ChoiceSchema {
  constructor({ name: e, flags: t }) {
    super({ name: e, choices: t }), (this._flags = [...t].sort())
  }
  preprocess(e, t) {
    if ('string' == typeof e && e.length > 0 && !this._flags.includes(e)) {
      const n = this._flags.find((t) => pa(t, e) < 3)
      if (n)
        return (
          t.logger.warn(
            [
              `Unknown flag ${ll.yellow(t.descriptor.value(e))},`,
              `did you mean ${ll.blue(t.descriptor.value(n))}?`,
            ].join(' ')
          ),
          n
        )
...
let dl
function hl(t, n, { logger: r, isCLI: i = !1, passThrough: u = !1 } = {}) {
  const o = u
      ? Array.isArray(u)
        ? (e, t) => (u.includes(e) ? { [e]: t } : void 0)
        : (e, t) => ({ [e]: t })
      : (t, n, r) => {
          const i = e(r.schemas, cl)
          return sa.levenUnknownHandler(
            t,
            n,
            Object.assign(Object.assign({}, r), {}, { schemas: i })
          )
        },
    s = i ? pl : sa.apiDescriptor,
    a = (function (e, { isCLI: t }) {
      const n = []
      t && n.push(sa.AnySchema.create({ name: '_' }))
      for (const r of e)
        n.push(gl(r, { isCLI: t, optionInfos: e })),
          r.alias &&
            t &&
            n.push(
              sa.AliasSchema.create({
                name: r.alias,
                sourceName: r.name,
              })
            )
    ...
    l = new sa.Normalizer(a, { logger: r, unknown: o, descriptor: s }),
    c = !1 !== r
  c && dl && (l._hasDeprecationWarned = dl)
  const p = l.normalize(t)
  return c && (dl = l._hasDeprecationWarned), p
}
function gl(e, { isCLI: t, optionInfos: n }) {
  let r
  const i = { name: e.name },
    u = {}
  switch (e.type) {
    case 'int':
      ;(r = sa.IntegerSchema), t && (i.preprocess = (e) => Number(e))
      break
    case 'string':
      r = sa.StringSchema
      break
  ...
  if (
    ...
    i.preprocess = (t, n, r) => n.preprocess(e(Array.isArray(t) ? Be(t) : t), r)
  }
  return e.array
    ? sa.ArraySchema.create(
        Object.assign(
          Object.assign(
            Object.assign(
              {},
...
var ml = {
  ...
  normalizeCliOptions: function (e, t, n) {
    return hl(e, t, Object.assign({ isCLI: !0 }, n))
  },
}
const { isNonEmptyArray: yl } = Jr
function Dl(e, t) {
  const { ignoreDecorators: n } = t || {}
  if (!n) {
    const t = (e.declaration && e.declaration.decorators) || e.decorators
    if (yl(t)) return Dl(t[0])
  }
...
var Cl = {
  ...
  xl = function (e) {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      if (t) {
        if (((t = !1), !Ol(r))) return !1
      } else if (!Il(r)) return !1
    }
    return !t
  }
let Sl =
  ...
  return e < 65
    ...
    : e <= 90 ||
        (e < 97
          ...
          : e <= 122 ||
            (e <= 65535
              ? e >= 170 && Tl.test(String.fromCharCode(e))
              : Pl(e, kl)))
}
function Il(e) {
  return e < 48
        ...
        (!(e < 65) &&
          (e <= 90 ||
            (e < 97
              ...
              : e <= 122 ||
                (e <= 65535
                  ? e >= 170 && Bl.test(String.fromCharCode(e))
                  : Pl(e, kl) || Pl(e, Nl)))))
}
var jl = Object.defineProperty(
    { isIdentifierStart: Al, isIdentifierChar: Fl, isIdentifierName: xl },
    '__esModule',
    { value: !0 }
  ),
  Ll = Gl,
...
var Xl = Object.defineProperty(
    {
      isReservedWord: Ll,
      isStrictReservedWord: _l,
      isStrictBindOnlyReservedWord: Ml,
      isStrictBindReservedWord: Rl,
      isKeyword: $l,
    },
    '__esModule',
    { value: !0 }
  ...
  ec = i(function (e) {
    var t = {}
    for (var n in Zl) Zl.hasOwnProperty(n) && (t[Zl[n]] = n)
    var r = (e.exports = {
      rgb: { channels: 3, labels: 'rgb' },
      hsl: { channels: 3, labels: 'hsl' },
      hsv: { channels: 3, labels: 'hsv' },
...
function tc(e) {
  var t = (function () {
      for (var e = {}, t = Object.keys(ec), n = t.length, r = 0; r < n; r++)
        e[t[r]] = { distance: -1, parent: null }
      return e
    })(),
    n = [e]
  for (t[e].distance = 0; n.length; )
    for (
      var r = n.pop(), i = Object.keys(ec[r]), u = i.length, o = 0;
      o < u;
      o++
    ) {
      var s = i[o],
...
function rc(e, t) {
  for (
    var n = [t[e].parent, e], r = ec[t[e].parent][e], i = t[e].parent;
    t[i].parent;

  )
    n.unshift(t[i].parent), (r = nc(ec[t[i].parent][i], r)), (i = t[i].parent)
  return (r.conversion = n), r
}
var ic = {}
Object.keys(ec).forEach(function (e) {
  ;(ic[e] = {}),
    Object.defineProperty(ic[e], 'channels', { value: ec[e].channels }),
    Object.defineProperty(ic[e], 'labels', { value: ec[e].labels })
  var t = (function (e) {
    for (
      var t = tc(e), n = {}, r = Object.keys(t), i = r.length, u = 0;
      u < i;
      u++
    ) {
      var o = r[u]
      null !== t[o].parent && (n[o] = rc(o, t))
    }
    return n
  })(e)
  Object.keys(t).forEach(function (n) {
    ...
    Object.defineProperty(e, 'exports', {
      ...
      get: function () {
        ...
        for (let e of Object.keys(uc)) {
          if ('object' != typeof uc[e]) continue
          const u = uc[e]
          'ansi16' === e && (e = 'ansi'),
            'ansi16' in u &&
              ((i.color.ansi[e] = t(u.ansi16, 0)),
...
function cc(e) {
  return (function (e) {
    ...
    (function (e) {
      if (!1 === lc) return 0
      if (sc('color=16m') || sc('color=full') || sc('color=truecolor')) return 3
      if (sc('color=256')) return 2
      if (e && !e.isTTY && !0 !== lc) return 0
      const t = lc ? 1 : 0
      if ('win32' === rr.platform) {
        const e = Io.release().split('.')
        return Number(rr.versions.node.split('.')[0]) >= 8 &&
      ...
      if ('CI' in ac)
        return ['TRAVIS', 'CIRCLECI', 'APPVEYOR', 'GITLAB_CI'].some(
          ...
          ? 1
          : t
      if ('TEAMCITY_VERSION' in ac)
        return /^(9\.(0*[1-9]\d*)\.|\d{2,}\.)/.test(ac.TEAMCITY_VERSION) ? 1 : 0
      if ('truecolor' === ac.COLORTERM) return 3
      if ('TERM_PROGRAM' in ac) {
        const e = parseInt((ac.TERM_PROGRAM_VERSION || '').split('.')[0], 10)
        switch (ac.TERM_PROGRAM) {
          case 'iTerm.app':
            return e >= 3 ? 3 : 2
          case 'Apple_Terminal':
            return 2
      ...
      return /-256(color)?$/i.test(ac.TERM)
        ? 2
        : /^screen|^xterm|^vt100|^vt220|^rxvt|color|ansi|cygwin|linux/i.test(
            ac.TERM
          ) || 'COLORTERM' in ac
...
sc('no-color') || sc('no-colors') || sc('color=false')
  ? (lc = !1)
  : (sc('color') || sc('colors') || sc('color=true') || sc('color=always')) &&
    (lc = !0),
  'FORCE_COLOR' in ac &&
    (lc = 0 === ac.FORCE_COLOR.length || 0 !== parseInt(ac.FORCE_COLOR, 10))
var pc = { supportsColor: cc, stdout: cc(rr.stdout), stderr: cc(rr.stderr) }
const fc =
    /(?:\\(u[a-f\d]{4}|x[a-f\d]{2}|.))|(?:\{(~)?(\w+(?:\([^)]*\))?(?:\.\w+(?:\([^)]*\))?)*)(?:[ \t]|(?=\r?\n)))|(\})|((?:.|[\r\n\f])+?)/gi,
  dc = /(?:^|\.)(\w+)(?:\(([^)]*)\))?/g,
  hc = /^(['"])((?:\\.|(?!\1)[^\\])*)\1$/,
  gc = /\\(u[a-f\d]{4}|x[a-f\d]{2}|.)|([^\\])/gi,
  mc = new Map([
    ['n', '\n'],
    ['r', '\r'],
    ['t', '\t'],
...
function Dc(e, t) {
  ...
  for (const t of r)
    if (isNaN(t)) {
      ...
      n.push(i[2].replace(gc, (e, t, n) => (t ? yc(t) : n)))
    } else n.push(Number(t))
  return n
}
function Ec(e) {
...
var Cc = (e, t) => {
    ...
    let i = []
    if (
      (t.replace(fc, (t, u, o, s, a, l) => {
        if (u) i.push(yc(u))
        else if (s) {
          const t = i.join('')
          ;(i = []),
            r.push(0 === n.length ? t : bc(e, n)(t)),
            n.push({ inverse: o, styles: Ec(s) })
        } else if (a) {
          if (0 === n.length)
            throw new Error('Found extraneous } in Chalk template literal')
  ...
  vc = i(function (e) {
    ...
    n && (oc.blue.open = '\x1b[94m')
    for (const e of Object.keys(oc))
      (oc[e].closeRe = new RegExp(Ql(oc[e].close), 'g')),
        (u[e] = {
          get() {
            const t = oc[e]
            return l.call(
    ...
    ;(u.visible = {
      ...
      (oc.color.closeRe = new RegExp(Ql(oc.color.close), 'g'))
    for (const e of Object.keys(oc.color.ansi))
      i.has(e) ||
        (u[e] = {
          get() {
            const t = this.level
            return function () {
              const n = oc.color[r[t]][e].apply(null, arguments),
                i = {
                  open: n,
                  close: oc.color.close,
                  closeRe: oc.color.closeRe,
                }
              return l.call(
                this,
                this._styles ? this._styles.concat(i) : [i],
    ...
    oc.bgColor.closeRe = new RegExp(Ql(oc.bgColor.close), 'g')
    for (const e of Object.keys(oc.bgColor.ansi)) {
      if (i.has(e)) continue
      u['bg' + e[0].toUpperCase() + e.slice(1)] = {
        get() {
          const t = this.level
          return function () {
            const n = oc.bgColor[r[t]][e].apply(null, arguments),
              i = {
                open: n,
                close: oc.bgColor.close,
                closeRe: oc.bgColor.closeRe,
              }
            return l.call(
              this,
              this._styles ? this._styles.concat(i) : [i],
    ...
    function c() {
      ...
      if (!this.enabled || this.level <= 0 || !r) return this._empty ? '' : r
      const i = oc.dim.open
      n && this.hasGrey && (oc.dim.open = '')
      for (const e of this._styles.slice().reverse())
        (r = e.open + r.replace(e.closeRe, e.open) + e.close),
          (r = r.replace(/\r?\n/g, `${e.close}$&${e.open}`))
      return (oc.dim.open = i), r
    }
    function p(e, t) {
      if (!Array.isArray(t)) return [].slice.call(arguments, 1).join(' ')
      const n = [].slice.call(arguments, 2),
  ...
  xc = function (e, t = {}) {
    if (Oc(t)) {
      ...
      return (function (e, t) {
        let n = ''
        for (const { type: r, value: i } of Pc(t)) {
          const t = e[r]
          n += t
            ? i
                .split(kc)
...
const Bc = new Set(['as', 'async', 'from', 'get', 'of', 'set'])
const kc = /\r\n|[\n\r\u2028\u2029]/,
  Nc = /^[()[\]{}]$/
let Pc
{
  const { matchToToken: e } = Sc,
    t = /^[a-z][\w-]*$/i,
    n = function (e, n, r) {
      if ('name' === e.type) {
        if (
          (0, Yl.isKeyword)(e.value) ||
          (0, Yl.isStrictReservedWord)(e.value, !0) ||
          Bc.has(e.value)
        )
          return 'keyword'
        if (t.test(e.value) && ('<' === r[n - 1] || '</' == r.substr(n - 2, 2)))
          return 'jsxIdentifier'
        if (e.value[0] !== e.value[0].toLowerCase()) return 'capitalized'
      }
      return 'punctuator' === e.type && Nc.test(e.value)
        ? 'bracket'
  ...
  Pc = function* (t) {
    let r
    for (; (r = Sc.default.exec(t)); ) {
      const i = e(r)
      yield { type: n(i, r.index, t), value: i.value }
    }
  }
}
function Oc(e) {
  return !!wc.default.supportsColor || e.forceColor
}
function Ic(e) {
  return e.forceColor
    ? new wc.default.constructor({ enabled: !0, level: 1 })
    : wc.default
}
var jc = Vc,
  Lc = function (e, t, n, r = {}) {
    if (!Rc) {
      ...
      if (rr.emitWarning) rr.emitWarning(e, 'DeprecationWarning')
      else {
        ;(new Error(e).name = 'DeprecationWarning'), console.warn(new Error(e))
      }
    }
    n = Math.max(n, 0)
    return Vc(e, { start: { column: n, line: t } }, r)
  },
  _c = (function (e) {
    if (e && e.__esModule) return e
    if (null === e || ('object' != typeof e && 'function' != typeof e))
    ...
    Object.defineProperty(
      { shouldHighlight: Ac, getChalk: Fc, default: xc },
      '__esModule',
      { value: !0 }
    )
  )
...
const $c = /\r\n|[\n\r\u2028\u2029]/
function Vc(e, t, n = {}) {
  const r = (n.highlightCode || n.forceColor) && (0, _c.shouldHighlight)(n),
    i = (0, _c.getChalk)(n),
    u = (function (e) {
      ...
      if (s) {
        ...
        if (Array.isArray(s)) {
          ...
          ;(t = [
            ...
            l && n.message && (t += ' ' + o(u.message, n.message))
        }
        return [
          o(u.marker, '>'),
          o(u.gutter, i),
...
var qc = Object.defineProperty(
    { codeFrameColumns: jc, default: Lc },
    '__esModule',
    { value: !0 }
  ),
  Wc = r(Gi)
const { ConfigError: Uc } = Yu,
  { locStart: zc, locEnd: Gc } = Cl,
...
function Xc(e) {
  ...
  for (const n of e.plugins)
    if (n.parsers)
      for (const e of Hc(n.parsers))
        Object.defineProperty(t, e, Jc(n.parsers, e))
  return t
}
function Yc(e, t = Xc(e)) {
...
const { UndefinedParserError: Qc } = Yu,
  { getSupportInfo: Zc } = Br,
  { resolveParser: ep } = Kc,
  tp = {
    astFormat: 'estree',
    printer: {},
...
function np(e, t) {
  const n = Wc.basename(e).toLowerCase(),
    r = Zc({ plugins: t }).languages.filter((e) => null !== e.since)
  let i = r.find(
    (e) =>
  ...
  if (!i && !n.includes('.')) {
    const t = (function (e) {
      ...
      try {
        const e = new zu(t).next().toString('utf8'),
...
var rp = {
  normalize: function (e, t = {}) {
    ...
    if (!n.parser)
      if (n.filepath) {
        if (((n.parser = np(n.filepath, n.plugins)), !n.parser))
          throw new Qc(`No parser could be inferred for file: ${n.filepath}`)
      } else {
    ...
    const u = ep(
      ml.normalizeApiOptions(n, [r.find((e) => 'parser' === e.name)], {
        passThrough: !0,
        logger: !1,
      })
    )
    ...
    return (
      ...
      ml.normalizeApiOptions(
        n,
        r,
        Object.assign({ passThrough: Object.keys(tp) }, t)
      )
    )
  },
  hiddenDefaults: tp,
...
function op(e, t) {
  var n = { seen: [], stylize: ap }
  return (
    arguments.length >= 3 && (n.depth = arguments[2]),
    arguments.length >= 4 && (n.colors = arguments[3]),
    fp(t) ? (n.showHidden = t) : t && Ap(n, t),
    gp(n.showHidden) && (n.showHidden = !1),
    gp(n.depth) && (n.depth = 2),
    gp(n.colors) && (n.colors = !1),
    gp(n.customInspect) && (n.customInspect = !0),
    n.colors && (n.stylize = sp),
    lp(n, e, n.depth)
  )
}
function sp(e, t) {
  var n = op.styles[t]
  return n
    ? '\x1b[' + op.colors[n][0] + 'm' + e + '\x1b[' + op.colors[n][1] + 'm'
    : e
}
function ap(e, t) {
  return e
...
function lp(e, t, n) {
  if (
    ...
    var r = t.inspect(n, e)
    return hp(r) || (r = lp(e, r, n)), r
  }
  var i = (function (e, t) {
    if (gp(t)) return e.stylize('undefined', 'undefined')
    if (hp(t)) {
      var n =
        "'" +
        JSON.stringify(t)
    ...
    var r
    if (fp(t)) return e.stylize('' + t, 'boolean')
    if (dp(t)) return e.stylize('null', 'null')
  })(e, t)
  if (i) return i
  var u = Object.keys(t),
    o = (function (e) {
  ...
  if (
    ...
    Ep(t) && (u.indexOf('message') >= 0 || u.indexOf('description') >= 0))
  )
    return cp(t)
  if (0 === u.length) {
    if (bp(t)) {
    ...
    if (mp(t)) return e.stylize(RegExp.prototype.toString.call(t), 'regexp')
    if (Dp(t)) return e.stylize(Date.prototype.toString.call(t), 'date')
    if (Ep(t)) return cp(t)
  }
  var a,
    l,
    ...
    p = !1,
    f = ['{', '}']
  ;((a = t), Array.isArray(a) && ((p = !0), (f = ['[', ']'])), bp(t)) &&
    (c = ' [Function' + (t.name ? ': ' + t.name : '') + ']')
  return (
    mp(t) && (c = ' ' + RegExp.prototype.toString.call(t)),
    Dp(t) && (c = ' ' + Date.prototype.toUTCString.call(t)),
    Ep(t) && (c = ' ' + cp(t)),
  ...
  if (
    ...
    s ||
      (e.seen.indexOf(a.value) < 0
        ? (s = dp(n) ? lp(e, a.value, null) : lp(e, a.value, n - 1)).indexOf(
            '\n'
          ) > -1 &&
          (s = u
            ? s
...
function mp(e) {
  return yp(e) && '[object RegExp]' === vp(e)
}
function yp(e) {
  return 'object' == typeof e && null !== e
}
function Dp(e) {
  return yp(e) && '[object Date]' === vp(e)
}
function Ep(e) {
  return yp(e) && ('[object Error]' === vp(e) || e instanceof Error)
}
function bp(e) {
  return 'function' == typeof e
}
...
var Sp,
  ...
  Tp =
    ...
    function (e) {
      var t = []
      for (var n in e) wp.call(e, n) && t.push(n)
      return t
    },
  Bp = Array.prototype.slice
function kp() {
  return void 0 !== Sp ? Sp : (Sp = 'foo' === function () {}.name)
}
function Np(e) {
  return Object.prototype.toString.call(e)
}
function Pp(e) {
  return (
    !qu(e) &&
    'function' == typeof On.ArrayBuffer &&
    ('function' == typeof ArrayBuffer.isView
...
var Ip = /\s*function\s+([^\(\s]*)\s*/
function jp(e) {
  if (bp(e)) {
    if (kp()) return e.name
    var t = e.toString().match(Ip)
    return t && t[1]
  }
}
function Lp(e) {
    ...
    e.message
      ...
      : ((this.message = (function (e) {
          return (
            ...
            e.operator +
            ' ' +
            _p(Mp(e.expected), 128)
          )
        })(this)),
        (this.generatedMessage = !0))
  var t = e.stackStartFunction || Rp
...
function Wp(e, t, n) {
  zp(e, t, !1) || Rp(e, t, n, 'deepEqual', Wp)
}
function Up(e, t, n) {
  zp(e, t, !0) || Rp(e, t, n, 'deepStrictEqual', Up)
}
function zp(e, t, n, r) {
  if (e === t) return !0
  if (qu(e) && qu(t)) return 0 === xp(e, t)
  if (Dp(e) && Dp(t)) return e.getTime() === t.getTime()
  if (mp(e) && mp(t))
    return (
      e.source === t.source &&
      e.global === t.global &&
  ...
  if (
    ...
    if (
      ...
      return 0 === xp(new Uint8Array(e.buffer), new Uint8Array(t.buffer))
    if (qu(e) !== qu(t)) return !1
    ...
    return (
      ...
      (function (e, t, n, r) {
        ...
        if (Cp(e) || Cp(t)) return e === t
        if (n && Object.getPrototypeOf(e) !== Object.getPrototypeOf(t))
          return !1
        var i = Gp(e),
          u = Gp(t)
        if ((i && !u) || (!i && u)) return !1
        if (i) return zp((e = Bp.call(e)), (t = Bp.call(t)), n)
        var o,
          s,
          a = Tp(e),
          l = Tp(t)
        if (a.length !== l.length) return !1
        for (a.sort(), l.sort(), s = a.length - 1; s >= 0; s--)
          if (a[s] !== l[s]) return !1
        for (s = a.length - 1; s >= 0; s--)
          if (!zp(e[(o = a[s])], t[o], n, r)) return !1
        return !0
      })(e, t, n, r))
    )
  }
...
function Hp(e, t, n) {
  zp(e, t, !1) && Rp(e, t, n, 'notDeepEqual', Hp)
}
function Jp(e, t, n) {
  zp(e, t, !0) && Rp(e, t, n, 'notDeepStrictEqual', Jp)
}
function Xp(e, t, n) {
  e !== t && Rp(e, t, n, '===', Xp)
}
...
function Qp(e, t, n, r) {
  ...
  'string' == typeof n && ((r = n), (n = null)),
    ...
    e && !i && Rp(i, n, 'Missing expected exception' + r)
  var u = 'string' == typeof r,
    o = !e && i && !n
  if (
    (((!e && Ep(i) && u && Kp(i, n)) || o) &&
      Rp(i, n, 'Got unwanted exception' + r),
    (e && i && n && !Kp(i, n)) || (!e && i))
  )
    throw i
}
...
;(Op.AssertionError = Lp),
  ...
  (Op.notEqual = qp),
  (Op.deepEqual = Wp),
  (Op.deepStrictEqual = Up),
  (Op.notDeepEqual = Hp),
  (Op.notDeepStrictEqual = Jp),
  (Op.strictEqual = Xp),
  (Op.notStrictEqual = Yp),
  (Op.throws = Zp),
  (Op.doesNotThrow = ef),
  (Op.ifError = tf)
var nf = r(
...
const {
  ...
  } = ki,
  {
    ...
    skipNewline: ff,
    skipSpaces: df,
    isPreviousLineEmpty: hf,
    addLeadingComment: gf,
    addDanglingComment: mf,
    addTrailingComment: yf,
  } = Jr,
  Df = new WeakMap()
function Ef(e, t, n) {
  if (!e) return
  ...
  } else if (Df.has(e)) return Df.get(e)
  const o =
...
function bf(e, t, n, r) {
  ...
  if (r && 'TemplateLiteral' === r.type) {
    const { quasis: e } = r,
      i = wf(e, t, n)
    l && wf(e, l, n) !== i && (l = null), c && wf(e, c, n) !== i && (c = null)
  }
...
function xf(e, t, n) {
  ...
  let a,
    l = n.locStart(u)
  for (a = r; a > 0; --a) {
    const { comment: r, precedingNode: o, followingNode: c } = e[a - 1]
    nf.strictEqual(o, i), nf.strictEqual(c, u)
    const p = t.slice(n.locEnd(r), l)
    if (!s.test(p)) break
    l = n.locStart(r)
  }
  for (const [t, { comment: n }] of e.entries()) t < a ? yf(i, n) : gf(u, n)
  for (const e of [i, u])
    e.comments &&
      e.comments.length > 1 &&
      ...
      i
        ? o.push(
            (function (e, t) {
              ...
              const a = ff(u, df(u, s(n)))
              return !1 !== a && pf(u, a) && r.push(uf), r
            })(e, t)
          )
        : u &&
          s.push(
            (function (e, t) {
              ...
              let a = [' ', r]
              return s || (a = [af(a), of]), a
            })(e, t)
          )
    }, 'comments'),
    u && (o.unshift(cf), s.push(cf)),
...
var Bf = {
  attach: function (e, t, n, r) {
    ...
    for (const [e, t] of f.entries()) {
      ...
      if (
        ...
        (n.placement = 'ownLine'),
          l(...D) || (d ? gf(d, n) : r ? yf(r, n) : mf(s || m, n))
      else if (Ff(h, g, f, e))
        (n.placement = 'endOfLine'),
          c(...D) || (r ? yf(r, n) : d ? gf(d, n) : mf(s || m, n))
      else if (((n.placement = 'remaining'), p(...D)));
      else if (r && d) {
        const e = i.length
        if (e > 0) {
          i[e - 1].followingNode !== d && xf(i, h, g)
        }
        i.push(t)
      } else r ? yf(r, n) : d ? gf(d, n) : mf(s || m, n)
    }
    if ((xf(i, n, r), !a))
      for (const t of e)
  ...
  printComments: function (e, t, n, r) {
    const { leading: i, trailing: u } = Tf(e, n, r)
    return i || u ? [i, t, u] : t
  },
  printCommentsSeparately: Tf,
  printDanglingComments: function (e, t, n, r) {
    ...
    return u && u.comments
      ? (e.each(() => {
          const n = e.getValue()
          n.leading || n.trailing || (r && !r(n)) || i.push(Sf(e, t))
        }, 'comments'),
        0 === i.length ? '' : n ? lf(uf, i) : sf([uf, lf(uf, i)]))
      : ''
  },
  getSortedChildNodes: Ef,
...
const {
    utils: { stripTrailingHardline: Of },
  } = ki,
  { normalize: If } = rp
var jf = {
      ...
      return n.printer.embed(
        ...
        (e, t, i) =>
          (function (e, t, n, r, { stripTrailingHardline: i = !1 } = {}) {
            ...
            const l = r(s, u)
            if ((Bf.ensureAllCommentsPrinted(a), i))
              return 'string' == typeof l ? l.replace(/(?:\r?\n)*$/, '') : Of(l)
            return l
          })(e, t, n, r, i),
        n
      )
...
const {
    builders: { hardline: Lf, addAlignmentToDoc: _f },
    utils: { propagateBreaks: Mf },
  } = ki,
  { printComments: Rf } = Bf
function $f(e, t, r = 0) {
  const { printer: i } = t
  ...
  const u = new Map(),
    o = new Pf(e)
  let s = a()
  return r > 0 && (s = _f([Lf, s], r, t.tabWidth)), Mf(s), s
  function a(e, t) {
    return void 0 === e || e === o
      ? l(t)
      : Array.isArray(e)
  ...
  function l(e) {
    ...
    const s = (function (e, t, r, i) {
      ...
      if (o.hasPrettierIgnore && o.hasPrettierIgnore(e))
        ...
        if (u)
          try {
            s = jf.printSubtree(e, r, t, $f)
          } catch (e) {
            if (n.PRETTIER_DEBUG) throw e
          }
        s || (s = o.print(e, t, r, i))
      }
...
function Wf(e, t, n, r, i = [], u) {
  ...
  if (
    ...
    for (const o of Bf.getSortedChildNodes(e, n)) {
      const s = Wf(o, t, n, r, [e, ...i], u)
      if (s) return s
    }
...
var Hf = {
  calculateRange: function (e, t, n) {
    ...
    const l = Wf(n, r, t, (e, n) => Gf(t, e, n), [], 'rangeStart'),
      c = a ? l : Wf(n, i, t, (e) => Gf(t, e), [], 'rangeEnd')
    ...
    if (
      ...
      const e = (function (e, t) {
        ...
        return n.find((e) => Uf.has(e.type) && r.has(e))
      })(l, c)
      ;(p = e), (f = e)
    } else
      ({ startNode: p, endNode: f } = (function (
        ...
        const o = n(e.node)
        for (const e of qf(t.parentNodes)) {
          if (!(n(e) >= o)) break
          u = e
        }
        const s = r(t.node)
        for (const t of qf(e.parentNodes)) {
          if (!(r(t) <= s)) break
          i = t
        }
...
const {
    printer: { printDocToString: Jf },
    debug: { printDocToDebug: Xf },
  } = ki,
  { getAlignmentSize: Yf } = Jr,
  {
    guessEndOfLine: Kf,
    convertEndOfLineToChars: Qf,
    countEndOfLineChars: Zf,
    normalizeEndOfLine: ed,
  } = Xr,
  td = rp.normalize,
  nd = Symbol('cursor')
function rd(e, t, n) {
  const r = t.comments
  return (
    r && (delete t.comments, Bf.attach(r, t, e, n)),
...
function id(e, t, n = 0) {
  ...
  const { ast: r, text: i } = Kc.parse(e, t)
  if (t.cursorOffset >= 0) {
    const e = Hf.findNodeAtOffset(r, t.cursorOffset, t)
    e && e.node && (t.cursorNode = e.node)
  }
  const u = rd(i, r, t),
    o = Vf(r, t, n),
    s = Jf(o, t)
  if ((Bf.ensureAllCommentsPrinted(u), n > 0)) {
    const e = s.formatted.trim()
    void 0 !== s.cursorNodeStart &&
      (s.cursorNodeStart -= s.formatted.indexOf(e)),
      (s.formatted = e + Qf(t.endOfLine))
  }
  if (t.cursorOffset >= 0) {
    let e, n, r, o, a
    if (
      (t.cursorNode && s.cursorNodeText
        ? ((e = t.locStart(t.cursorNode)),
          ...
          (o = s.cursorNodeStart),
          (a = s.cursorNodeText))
        : ((e = 0), (n = i), (r = t.cursorOffset), (o = 0), (a = s.formatted)),
      n === a)
    )
...
function sd(e, t) {
  let { cursorOffset: n, rangeStart: r, rangeEnd: i, endOfLine: u } = od(e, t)
  const o = '\ufeff' === e.charAt(0)
  if (
    (o && ((e = e.slice(1)), n--, r--, i--),
    'auto' === u && (u = Kf(e)),
    ...
    const t = (t) => Zf(e.slice(0, Math.max(t, 0)), '\r\n')
    ;(n -= t(n)), (r -= t(r)), (i -= t(i)), (e = ed(e))
  }
  return {
    hasBOM: o,
    text: e,
...
function ad(e, t) {
  const n = Kc.resolveParser(t)
  return !n.hasPragma || n.hasPragma(e)
}
function ld(e, t) {
  let n,
    { hasBOM: r, text: i, options: u } = sd(e, td(t))
  return (u.rangeStart >= u.rangeEnd && '' !== i) ||
    (u.requirePragma && !ad(i, u))
    ? { formatted: e, cursorOffset: t.cursorOffset, comments: [] }
    : (u.rangeStart > 0 || u.rangeEnd < i.length
        ? (n = (function (e, t) {
            const { ast: n, text: r } = Kc.parse(e, t),
              { rangeStart: i, rangeEnd: u } = Hf.calculateRange(r, t, n),
              o = r.slice(i, u),
            ...
            f > u
              ? (f += p.length - o.length)
              : c.cursorOffset >= 0 && (f = c.cursorOffset + i)
            let d = r.slice(0, i) + p + r.slice(u)
            if ('lf' !== t.endOfLine) {
              const e = Qf(t.endOfLine)
              f >= 0 && '\r\n' === e && (f += Zf(d.slice(0, f), '\n')),
                (d = d.replace(/\n/g, e))
            }
            return {
...
var cd = {
  formatWithCursor: ld,
  parse(e, t, n) {
    const { text: r, options: i } = sd(e, td(t)),
      u = Kc.parse(r, i)
    return n && (u.ast = ip(u.ast, i)), u
  },
  formatAST(e, t) {
    t = td(t)
    const n = Vf(e, t)
  ...
  printToDoc(e, t) {
    t = td(t)
    const { ast: n, text: r } = Kc.parse(e, t)
    return rd(r, n, t), Vf(n, t)
  },
  printDocToString: (e, t) => Jf(e, td(t)),
}
const {
  ...
  skipNewline: Dd,
  skipToLineEnd: Ed,
  skipEverythingButNewLine: bd,
  skipInlineComment: Cd,
  skipTrailingComment: vd,
  hasNewline: Ad,
  hasNewlineInRange: Fd,
  hasSpaces: xd,
  isNextLineEmpty: Sd,
  isNextLineEmptyAfterIndex: wd,
  isPreviousLineEmpty: Td,
  getNextNonSpaceNonCommentCharacterIndex: Bd,
  makeString: kd,
  addLeadingComment: Nd,
  addDanglingComment: Pd,
  addTrailingComment: Od,
} = Jr
var Id = {
  getMaxContinuousCount: pd,
  getStringWidth: fd,
...
const jd = ['languageId']
var Ld = function (t, n) {
    const { languageId: r } = t,
      i = e(t, jd)
    return Object.assign(Object.assign({ linguistLanguageId: r }, i), n(t))
  },
  _d = i(function (e) {
    !(function () {
      function t(e) {
  ...
  Md = i(function (e) {
    !(function () {
      ...
      for (
        ...
        i[o] =
          (o >= 97 && o <= 122) || (o >= 65 && o <= 90) || 36 === o || 95 === o
...
const $d = i(function (e, t) {
    ;(t.ast = _d), (t.code = Md), (t.keyword = Rd)
  }).keyword.isIdentifierNameES5,
  {
    ...
    skipWhitespace: Wd,
    isNonEmptyArray: Ud,
    isNextLineEmptyAfterIndex: zd,
  } = Jr,
  { locStart: Gd, locEnd: Hd, hasSameLocStart: Jd } = Cl,
  Xd = new RegExp('^(?:(?=.)\\s)*:'),
  Yd = new RegExp('^(?:(?=.)\\s)*::')
function Kd(e) {
  return (
...
const ch = /^(skip|[fx]?(it|describe|test))$/
function ph(e) {
  return (
...
for (const [e, t] of [
  ...
  for (const n of t) Eh[n] = e
function bh(e) {
  return Eh[e]
}
const Ch = new WeakMap()
function vh(e) {
  if (Ch.has(e)) return Ch.get(e)
  const t = []
  return (
...
function Sh(e) {
  return e && (e.prettierIgnore || Bh(e, wh.PrettierIgnore))
}
const wh = {
    Leading: 2,
    Trailing: 4,
  ...
  Th = (e, t) => {
    if (('function' == typeof e && ((t = e), (e = 0)), e || t))
      return (n, r, i) =>
        !(
          (e & wh.Leading && !n.leading) ||
          (e & wh.Trailing && !n.trailing) ||
          (e & wh.Dangling && (n.leading || n.trailing)) ||
          (e & wh.Block && !Kd(n)) ||
          (e & wh.Line && !Qd(n)) ||
          (e & wh.First && 0 !== r) ||
          (e & wh.Last && r !== i.length - 1) ||
          (e & wh.PrettierIgnore && !xh(n)) ||
          (t && !t(n))
        )
  }
function Bh(e, t, n) {
  if (!e || !Ud(e.comments)) return !1
  const r = Th(t, n)
...
function Nh(e) {
  return ph(e) || 'NewExpression' === e.type || 'ImportExpression' === e.type
}
var Ph = {
  getFunctionParameters: vh,
  ...
  hasRestParameter: function (e) {
    if (e.rest) return !0
    const t = vh(e)
    return t.length > 0 && 'RestElement' === Vd(t).type
  },
  ...
  getParentExportDeclaration: function (e) {
    ...
    return 'declaration' === e.getName() && eh(t) ? t : null
  },
  getTypeScriptMappedTypeModifier: function (e, t) {
    return '+' === e ? '+' + t : '-' === e ? '-' + t : t
  },
  hasFlowAnnotationComment: function (e) {
    return e && Kd(e[0]) && Yd.test(e[0].value)
  },
  hasFlowShorthandAnnotationComment: function (e) {
    return (
      e.extra &&
      e.extra.parenthesized &&
      Ud(e.trailingComments) &&
      Kd(e.trailingComments[0]) &&
      Xd.test(e.trailingComments[0].value)
    )
  },
  hasLeadingOwnLineComment: function (e, t) {
    return uh(t) ? Sh(t) : Bh(t, wh.Leading, (t) => qd(e, Hd(t)))
  },
  ...
  hasIgnoreComment: function (e) {
    return Sh(e.getValue())
  },
  hasNodeIgnoreComment: Sh,
  identity: function (e) {
    return e
  },
  isBinaryish: function (e) {
    return ah.has(e.type)
  },
  isBlockComment: Kd,
  isCallLikeExpression: Nh,
  isLineComment: Qd,
  isPrettierIgnoreComment: xh,
  isCallExpression: ph,
  isMemberExpression: fh,
  isExportDeclaration: eh,
  ...
  isFunctionCompositionArgs: function (e) {
    ...
    for (const n of e)
      if (rh(n)) {
        if (((t += 1), t > 1)) return !0
      } else if (ph(n)) for (const e of n.arguments) if (rh(e)) return !0
    return !1
  },
  isFunctionNotation: sh,
  isFunctionOrArrowExpression: rh,
  isGetterOrSetter: oh,
    ...
    return (
      ...
      ('Literal' === t.type ||
        ...
        ('TemplateLiteral' === t.type
          ...
          : Nh(t)
          ? ('ImportExpression' === t.type || e(t.callee, n)) && Fh(t).every(r)
          : fh(t)
  ...
  isMemberish: function (e) {
    return fh(e) || ('BindExpression' === e.type && Boolean(e.object))
  },
  isNumericLiteral: th,
  ...
  isSimpleType: function (e) {
    return (
      !!e &&
      (!(
        ('GenericTypeAnnotation' !== e.type && 'TSTypeReference' !== e.type) ||
        e.typeParameters
      ) ||
        !!lh.has(e.type))
    )
  ...
  isStringPropSafeToUnquote: function (e, t) {
    return (
      'json' !== t.parser &&
      nh(e.key) &&
      gh(e.key).slice(1, -1) === e.key.value &&
      (($d(e.key.value) &&
        !(
  ...
  isTemplateOnItsOwnLine: function (e, t) {
    return (
      (('TemplateLiteral' === e.type && hh(e)) ||
        ('TaggedTemplateExpression' === e.type && hh(e.quasi))) &&
      !qd(t, Gd(e), { backwards: !0 })
    )
  },
  isTestCall: function e(t, n) {
    if ('CallExpression' !== t.type) return !1
    if (1 === t.arguments.length) {
      if (ih(t) && n && e(n)) return rh(t.arguments[0])
      if (
        (function (e) {
          return (
            'Identifier' === e.callee.type &&
      ...
      return (
        !(t.arguments[2] && !th(t.arguments[2])) &&
        ((2 === t.arguments.length
          ...
          : (function (e) {
            ...
            })(t.arguments[1]) && vh(t.arguments[1]).length <= 1) ||
          ih(t.arguments[1]))
      )
    return !1
  },
  isTheOnlyJsxElementInMarkdown: function (e, t) {
    ...
    const n = t.getNode()
    if (!n.expression || !uh(n.expression)) return !1
  ...
  isTypeAnnotationAFunction: function (e) {
    return !(
      ...
      e.static ||
      Jd(e, e.typeAnnotation)
    )
  },
  isNextLineEmpty: (e, { originalText: t }) => zd(t, Hd(e)),
  needsHardlineAfterDanglingComment: function (e) {
    if (!Bh(e)) return !1
    const t = Vd(kh(e, wh.Dangling))
    return t && !Kd(t)
  },
  rawText: gh,
  ...
  hasComment: Bh,
  getComments: kh,
  CommentCheckFlags: wh,
}
const { getStringWidth: Oh, getIndentSize: Ih } = Jr,
  {
    builders: {
      join: jh,
      hardline: Lh,
      ...
      indent: Rh,
      align: $h,
      lineSuffixBoundary: Vh,
      addAlignmentToDoc: qh,
    },
    printer: { printDocToString: Wh },
    utils: { mapDoc: Uh },
  } = ki,
  {
    isBinaryish: zh,
    isJestEachTemplateLiteral: Gh,
    isSimpleTemplateLiteral: Hh,
    hasComment: Jh,
...
var Kh = {
  printTemplateLiteral: function (e, t, n) {
    const r = e.getValue()
    if ('TemplateLiteral' === r.type && Gh(r, e.getParentNode())) {
                ...
                jh(
                  ...
                  p.map((e) =>
                    jh(
                      ' | ',
                      e.cells.map((t, n) =>
                        e.hasLineBreak ? t : t + ' '.repeat(c[n] - Oh(t))
                      )
                    )
                  )
                ),
    ...
    return (
      ...
      e.each((e) => {
        ...
        if ((u.push(t()), a < o.length)) {
          ...
          const f =
            0 === c && l.value.raw.endsWith('\n')
              ? $h(Number.NEGATIVE_INFINITY, p)
              : qh(p, c, t)
          u.push(Mh(['${', f, Vh, '}']))
        }
      }, 'quasis'),
    ...
    return e.map(
      (e) =>
        (function (e, t) {
          const n = e.getValue()
          let r = t()
          return Jh(n) && (r = Mh([Rh([_h, r]), _h])), ['${', r, Vh, '}']
        })(e, t),
      'expressions'
    )
  },
  escapeTemplateCharacters: function (e, t) {
    return Uh(e, (e) =>
      'string' == typeof e ? (t ? e.replace(/(\\*)`/g, '$1$1\\`') : Yh(e)) : e
    )
  },
  uncookTemplateElementValue: Yh,
}
const {
    builders: { indent: Qh, softline: Zh, literalline: eg, dedentToRoot: tg },
  } = ki,
  { escapeTemplateCharacters: ng } = Kh
var rg = function (e, t, n) {
  ...
  return ['`', u ? Qh([Zh, o]) : [eg, tg(o)], Zh, '`']
}
const { isNonEmptyArray: ig } = Jr,
  {
    builders: { indent: ug, hardline: og, softline: sg },
    utils: { mapDoc: ag, replaceNewlinesWithLiterallines: lg, cleanDoc: cg },
  } = ki,
  { printTemplateExpressions: pg } = Kh
...
const {
    builders: { indent: dg, join: hg, hardline: gg },
  } = ki,
  { escapeTemplateCharacters: mg, printTemplateExpressions: yg } = Kh
function Dg(e) {
  const t = []
  let n = !1
  const r = e.map((e) => e.trim())
  for (const [e, i] of r.entries())
    '' !== i && ('' === r[e - 1] && n ? t.push([gg, i]) : t.push(i), (n = !0))
  return 0 === t.length ? null : hg(gg, t)
}
var Eg = function (e, t, n) {
  ...
  for (let e = 0; e < i; e++) {
    const t = 0 === e,
      ...
      c = l.length,
      p = u[e],
      f = c > 2 && '' === l[0].trim() && '' === l[1].trim(),
      d = c > 2 && '' === l[c - 1].trim() && '' === l[c - 2].trim(),
      h = l.every((e) => /^\s*(?:#[^\n\r]*)?$/.test(e))
  ...
  return ['`', dg([gg, hg(gg, o)]), gg, '`']
}
const {
    builders: { indent: bg, line: Cg, hardline: vg, group: Ag },
    utils: { mapDoc: Fg },
  } = ki,
  { printTemplateExpressions: xg, uncookTemplateElementValue: Sg } = Kh
let wg = 0
var Tg = function (e, t, n, r, { parser: i }) {
  const u = e.getValue(),
    o = wg
  wg = (wg + 1) >>> 0
  const s = (e) => `PRETTIER_HTML_PLACEHOLDER_${e}_${o}_IN_JS`,
    a = u.quasis
      ...
      .join(''),
    l = xg(e, t)
  if (0 === l.length && 0 === a.trim().length) return '``'
  const c = new RegExp(s('(\\d+)'), 'g')
  let p = 0
  const f = n(
      a,
      {
    ...
    d = Fg(f, (e) => {
      ...
      for (let e = 0; e < n.length; e++) {
        ...
        if (e % 2 == 0) {
          i &&
            ((i = Sg(i)),
            r.__embeddedInHtml && (i = i.replace(/<\/(script)\b/gi, '<\\/$1')),
            t.push(i))
          continue
        }
        const u = Number(i)
    ...
    h = /^\s/.test(a) ? ' ' : '',
    g = /\s$/.test(a) ? ' ' : '',
    m = 'ignore' === r.htmlWhitespaceSensitivity ? vg : h && g ? Cg : null
  return Ag(
    m
      ? ['`', bg([m, Ag(d)]), m, '`']
      : ['`', h, p > 1 ? bg(Ag(d)) : Ag(d), g, '`']
  )
}
const { hasComment: Bg, CommentCheckFlags: kg, isObjectProperty: Ng } = Ph
function Pg(e) {
  return (function (e) {
    const t = e.getValue(),
      n = e.getParentNode(),
    ...
    return (
      ...
      (n &&
        ...
        ('global' === n.tag.property.name || 'resolve' === n.tag.property.name))
    )
  })(e) ||
    (function (e) {
      const t = e.getParentNode()
...
function Lg(e, t) {
  return Bg(e, kg.Block | kg.Leading, ({ value: e }) => e === ` ${t} `)
}
var _g = function (e, t, n, r) {
  const i = e.getValue()
  if (
...
function Vg(e, t, n) {
  ...
  if (
    ...
    for (const [e, r] of t.expression.arguments[0].properties.entries())
      switch (n[e].key.name) {
        case 'styles':
          'ArrayExpression' === r.value.type && $g(r.value.elements[0])
          break
        case 'template':
          'TemplateLiteral' === r.value.type && $g(r.value)
      }
  }
  if (
    ('TaggedTemplateExpression' !== e.type ||
    ...
    ;((e.leadingComments &&
      e.leadingComments.some(
        (e) => Mg(e) && ['GraphQL', 'HTML'].some((t) => e.value === ` ${t} `)
      )) ||
...
var Ug = Wg
Ug.graceful = (e) => ('string' == typeof e && Wg(e)) || '\n'
var zg = function (e) {
    const t = e.match(em)
  ...
  Jg = sm,
  Xg = function ({ comments: e = '', pragmas: t = {} }) {
    const n = (0, Kg().default)(e) || Yg().EOL,
      r = ' *',
      i = Object.keys(t),
      u = i
        .map((e) => am(e, t[e]))
...
const Qg = /\*\/$/,
  ...
  om = []
function sm(e) {
  const t = (0, Kg().default)(e) || Yg().EOL
  e = e.replace(Zg, '').replace(Qg, '').replace(um, '$1')
  let n = ''
  for (; n !== e; ) (n = e), (e = e.replace(rm, `${t}$1 $2${t}`))
  e = e.replace(nm, '').trimRight()
  const r = Object.create(null),
    i = e.replace(im, '').replace(nm, '').trimRight()
  let u
  for (; (u = im.exec(e)); ) {
    const e = u[2].replace(tm, '')
    'string' == typeof r[u[1]] || Array.isArray(r[u[1]])
      ? (r[u[1]] = om.concat(r[u[1]], e))
      : (r[u[1]] = e)
  }
  return { comments: i, pragmas: r }
}
function am(e, t) {
  return om.concat(t).map((t) => `@${e} ${t}`.trim())
}
var lm = Object.defineProperty(
  { extract: zg, strip: Gg, parse: Hg, parseWithComments: Jg, print: Xg },
  '__esModule',
  { value: !0 }
)
const { parseWithComments: cm, strip: pm, extract: fm, print: dm } = lm,
  { getShebang: hm } = Jr,
  { normalizeEndOfLine: gm } = Xr
function mm(e) {
  const t = hm(e)
  t && (e = e.slice(t.length + 1))
  const n = fm(e),
    { pragmas: r, comments: i } = cm(n)
...
const {
    getLast: Dm,
    hasNewline: Em,
    getNextNonSpaceNonCommentCharacterIndexWithStartIndex: bm,
    getNextNonSpaceNonCommentCharacter: Cm,
    hasNewlineInRange: vm,
    addLeadingComment: Am,
    addTrailingComment: Fm,
    addDanglingComment: xm,
    getNextNonSpaceNonCommentCharacterIndex: Sm,
    isNonEmptyArray: wm,
  } = Jr,
  {
    isBlockComment: Tm,
    getFunctionParameters: Bm,
    isPrettierIgnoreComment: km,
    isJsxNode: Nm,
    hasFlowShorthandAnnotationComment: Pm,
    hasFlowAnnotationComment: Om,
    hasIgnoreComment: Im,
    isCallLikeExpression: jm,
    getCallArguments: Lm,
    isCallExpression: _m,
    isMemberExpression: Mm,
    isObjectProperty: Rm,
  } = Ph,
  { locStart: $m, locEnd: Vm } = Cl
function qm(e, t) {
...
function Wm(e, t) {
  'BlockStatement' === e.type ? qm(e, t) : Am(e, t)
}
function Um({ comment: e, followingNode: t }) {
  return !(!t || !Ey(e)) && (Am(t, e), !0)
}
function zm({
  comment: e,
  precedingNode: t,
  ...
  return ')' === Cm(i, e, Vm)
    ...
    ? ('BlockStatement' === t.type ? Fm(t, e) : xm(n, e), !0)
    : 'BlockStatement' === r.type
    ? (qm(r, e), !0)
    : 'IfStatement' === r.type
    ? (Wm(r.consequent, e), !0)
    : n.consequent === r && (Am(r, e), !0)
}
function Gm({
  comment: e,
  precedingNode: t,
...
function Hm({
  ...
  return (
    ...
    ('CatchClause' === n.type && t
      ...
      : 'TryStatement' === r.type
      ? (Wm(r.finalizer, e), !0)
      : 'CatchClause' === r.type && (Wm(r.body, e), !0))
  )
}
function Jm({ comment: e, enclosingNode: t, followingNode: n }) {
  return !(!Mm(t) || !n || 'Identifier' !== n.type) && (Am(t, e), !0)
}
function Xm({
  comment: e,
  precedingNode: t,
  ...
  const u = t && !vm(i, Vm(t), $m(e))
  return (
    !(
      (t && u) ||
      !n ||
      ('ConditionalExpression' !== n.type && 'TSConditionalType' !== n.type) ||
      !r
    ) && (Am(r, e), !0)
  )
}
function Ym({ comment: e, precedingNode: t, enclosingNode: n }) {
  return (
    !(
      !Rm(n) ||
      !n.shorthand ||
...
function Km({
  ...
  if (
    ...
    if (wm(n.decorators) && (!r || 'Decorator' !== r.type))
      return Fm(Dm(n.decorators), e), !0
    if (n.body && r === n.body) return qm(n.body, e), !0
    if (r)
...
function Qm({ comment: e, precedingNode: t, enclosingNode: n, text: r }) {
  return (
    ((n &&
      t &&
      ('Property' === n.type ||
...
function Zm({ comment: e, precedingNode: t, enclosingNode: n, text: r }) {
  return (
    '(' === Cm(r, e, Vm) &&
    !(
      !t ||
...
function ey({ comment: e, enclosingNode: t, text: n }) {
  if (!t || 'ArrowFunctionExpression' !== t.type) return !1
  const r = Sm(n, e, Vm)
  return !1 !== r && '=>' === n.slice(r, r + 2) && (xm(t, e), !0)
}
function ty({ comment: e, enclosingNode: t, text: n }) {
  return (
    ')' === Cm(n, e, Vm) &&
    (t && ((Dy(t) && 0 === Bm(t).length) || (jm(t) && 0 === Lm(t).length))
      ? (xm(t, e), !0)
      : !(
          !t ||
...
function ny({
  ...
  if (
    ...
    const t = (() => {
      const e = Bm(n)
      if (e.length > 0) return bm(i, Vm(Dm(e)))
      const t = bm(i, Vm(n.id))
      return !1 !== t && bm(i, t + 1)
    })()
    if ($m(e) > t) return qm(r, e), !0
  }
  return !1
}
function ry({ comment: e, enclosingNode: t }) {
  return !(!t || 'ImportSpecifier' !== t.type) && (Am(t, e), !0)
}
function iy({ comment: e, enclosingNode: t }) {
  return !(!t || 'LabeledStatement' !== t.type) && (Am(t, e), !0)
}
function uy({ comment: e, enclosingNode: t }) {
  return (
    !(
      !t ||
...
function oy({ comment: e, precedingNode: t, enclosingNode: n }) {
  return (
    !!(_m(n) && t && n.callee === t && n.arguments.length > 0) &&
    (Am(n.arguments[0], e), !0)
  )
}
function sy({
  comment: e,
  ...
  return !n || ('UnionTypeAnnotation' !== n.type && 'TSUnionType' !== n.type)
    ? (r &&
      ...
      !1)
    : (km(e) && ((r.prettierIgnore = !0), (e.unignore = !0)),
      !!t && (Fm(t, e), !0))
}
function ay({ comment: e, enclosingNode: t }) {
  return !!Rm(t) && (Am(t, e), !0)
}
function ly({
  comment: e,
  enclosingNode: t,
  ...
  return r && r.body && 0 === r.body.length
    ? (i ? xm(r, e) : Am(r, e), !0)
    : t && 'Program' === t.type && 0 === t.body.length && !wm(t.directives)
    ? (i ? xm(t, e) : Am(t, e), !0)
    : !(
        !n ||
        'Program' !== n.type ||
...
function cy({ comment: e, enclosingNode: t }) {
  return (
    !(!t || ('ForInStatement' !== t.type && 'ForOfStatement' !== t.type)) &&
    (Am(t, e), !0)
  )
}
function py({ comment: e, precedingNode: t, enclosingNode: n, text: r }) {
  return (
    !!(
      t &&
...
function fy({ comment: e, enclosingNode: t }) {
  return !(!t || 'AssignmentPattern' !== t.type) && (Am(t, e), !0)
}
function dy({ comment: e, enclosingNode: t }) {
  return !(!t || 'TypeAlias' !== t.type) && (Am(t, e), !0)
}
function hy({ comment: e, enclosingNode: t, followingNode: n }) {
  return (
    !(
      !t ||
      ('VariableDeclarator' !== t.type && 'AssignmentExpression' !== t.type) ||
      !n ||
...
function gy({ comment: e, enclosingNode: t, followingNode: n, text: r }) {
  return (
    !(
      n ||
      !t ||
...
function Ey(e) {
  return Tm(e) && '*' === e.value[0] && /@type\b/.test(e.value)
}
var by = {
  handleOwnLineComment: function (e) {
    return [my, ny, Jm, zm, Gm, Hm, Km, ry, cy, sy, ly, py, fy, Qm, iy].some(
      (t) => t(e)
    )
  },
  handleEndOfLineComment: function (e) {
    return [Um, ny, Xm, ry, zm, Gm, Hm, Km, iy, oy, ay, ly, dy, hy].some((t) =>
      t(e)
    )
  },
  handleRemainingComment: function (e) {
    return [my, zm, Gm, Ym, ty, Qm, ly, ey, Zm, yy, uy, gy].some((t) => t(e))
  },
  isTypeCastComment: Ey,
  ...
  willPrintOwnComments: function (e) {
    ...
    return (
      ((t &&
        (Nm(t) ||
          Pm(t) ||
          (_m(n) && (Om(t.leadingComments) || Om(t.trailingComments))))) ||
        (n &&
          ('JSXSpreadAttribute' === n.type ||
            ...
            (('ClassDeclaration' === n.type || 'ClassExpression' === n.type) &&
              n.superClass === t)))) &&
      (!Im(e) || 'UnionTypeAnnotation' === n.type || 'TSUnionType' === n.type)
    )
  },
}
const {
  getFunctionParameters: Cy,
  getLeftSidePathName: vy,
  hasFlowShorthandAnnotationComment: Ay,
  hasNakedLeftSide: Fy,
  hasNode: xy,
  isBitwiseOperator: Sy,
  startsWithNoLookaheadToken: wy,
  shouldFlatten: Ty,
  getPrecedence: By,
  isCallExpression: ky,
  isMemberExpression: Ny,
  isObjectProperty: Py,
} = Ph
function Oy(e, t) {
  ...
  if (
    ...
    return !1
  if ('flow' !== t.parser && Ay(e.getValue())) return !0
  ...
  switch (n.type) {
    ...
    case 'ExportDefaultDeclaration':
      return jy(e, t) || 'SequenceExpression' === i.type
    case 'Decorator':
      if ('expression' === r) {
        let e = !1,
          t = !1,
    ...
    case 'ArrowFunctionExpression':
      if ('body' === r && 'SequenceExpression' !== i.type && wy(i, !1))
        return !0
  }
  switch (i.type) {
    case 'UpdateExpression':
    ...
    case 'NGPipeExpression':
      return !(
        ...
        ('ObjectProperty' === n.type && (!i.extra || !i.extra.parenthesized)) ||
        'ArrayExpression' === n.type ||
        (ky(n) && n.arguments[r] === i) ||
    ...
    case 'JSXElement':
      return (
        'callee' === r ||
        ('left' === r && 'BinaryExpression' === n.type && '<' === n.operator) ||
        ('ArrayExpression' !== n.type &&
          ...
          return xy(
            ...
            (e) =>
              ('ObjectTypeAnnotation' === e.type &&
                xy(e, (e) => 'FunctionTypeAnnotation' === e.type || void 0)) ||
              void 0
          )
        })(i)
      )
  ...
  switch (n.type) {
    case 'NGPipeExpression':
      if (
        ...
        return e.callParent(Iy)
      break
    case 'ObjectProperty':
      if ('value' === r) {
        const t = e.getParentNode(1)
        return Be(t.properties) === n
      }
      break
    case 'BinaryExpression':
    case 'LogicalExpression':
      if ('right' === r) return e.callParent(Iy)
      break
    case 'ConditionalExpression':
      if ('alternate' === r) return e.callParent(Iy)
      break
    case 'UnaryExpression':
      if (n.prefix) return e.callParent(Iy)
  }
  return !1
}
function jy(e, t) {
  ...
  return 'FunctionExpression' === n.type || 'ClassExpression' === n.type
    ? 'ExportDefaultDeclaration' === r.type || !Oy(e, t)
    : !(!Fy(n) || ('ExportDefaultDeclaration' !== r.type && Oy(e, t))) &&
        e.call((e) => jy(e, t), ...vy(e, n))
}
var Ly = Oy
var _y = function (e, t) {
  switch (t.parser) {
...
const {
  builders: { join: My, line: Ry, group: $y, softline: Vy, indent: qy },
} = ki
var Wy = {
  ...
  printHtmlBinding: function (e, t, n) {
    ...
    if (
      ...
      return t.__isVueForBindingLeft
        ? e.call(
            (e) => {
              const t = My([',', Ry], e.map(n, 'params')),
                { params: r } = e.getValue()
              return 1 === r.length ? t : ['(', qy([Vy, $y(t)]), Vy, ')']
            },
            'program',
            'body',
            0
        ...
        : t.__isVueBindings
        ? e.call((e) => My([',', Ry], e.map(n, 'params')), 'program', 'body', 0)
        : void 0
  },
}
const { printComments: Uy } = Bf,
  { getLast: zy } = Jr,
  {
    builders: {
      join: Gy,
    ...
    utils: { cleanDoc: eD, getDocParts: tD, isConcat: nD },
  } = ki,
  {
    hasLeadingOwnLineComment: rD,
    isBinaryish: iD,
    isJsxNode: uD,
    shouldFlatten: oD,
    hasComment: sD,
    CommentCheckFlags: aD,
    isCallExpression: lD,
    isMemberExpression: cD,
    isObjectProperty: pD,
  } = Ph
let fD = 0
function dD(e, t, n, r, i) {
  ...
  const o = e.getValue()
  if (iD(o)) {
    oD(o.operator, o.left.operator)
      ? (u = [...u, ...e.call((e) => dD(e, t, n, !0, i), 'left')])
      : u.push(Xy(t('left')))
    const s = hD(o),
      a =
        ('|>' === o.operator ||
        ...
        !rD(n.originalText, o.right),
      l = 'NGPipeExpression' === o.type ? '|' : o.operator,
      c =
        'NGPipeExpression' === o.type && o.arguments.length > 0
          ? Xy(
              Yy([
                ...
                Gy(
                  [Jy, ':', Qy(' ')],
                  e.map(t, 'arguments').map((e) => Ky(2, Xy(e)))
                ),
              ])
            )
          : '',
      p = s
        ? [l, ' ', t('right'), c]
        : [a ? Hy : '', l, a ? ' ' : Hy, t('right'), c],
      f = e.getParentNode(),
      d = sD(o.left, aD.Trailing | aD.Line),
      h =
        d ||
        (!(i && 'LogicalExpression' === o.type) &&
          ...
          o.left.type !== o.type &&
          o.right.type !== o.type)
    if ((u.push(a ? '' : ' ', h ? Xy(p, { shouldBreak: d }) : p), r && sD(o))) {
      const t = eD(Uy(e, u, n))
      u = nD(t) || 'fill' === t.type ? tD(t) : [t]
    }
  } else u.push(Xy(t()))
  return u
}
  ...
  printBinaryishExpression: function (e, t, n) {
    ...
    const a =
      ...
      l =
        ...
        pD(i),
      c = iD(r.left) && oD(r.operator, r.left.operator)
    if (a || (hD(r) && !c) || (!hD(r) && l)) return Xy(s)
    ...
    const p = uD(r.right),
      ...
      g = Symbol('logicalChain-' + ++fD),
      m = Xy([...d, Yy(h)], { id: g })
    if (!p) return m
    const y = zy(s)
    return Xy([m, Zy(y, { groupId: g })])
  },
  shouldInlineLogicalExpression: hD,
}
const {
    builders: { join: mD, line: yD, group: DD },
  } = ki,
  { hasNode: ED, hasComment: bD, getComments: CD } = Ph,
  { printBinaryishExpression: vD } = gD
function AD(e, t, n) {
  return (
    ...
    if (r.type.startsWith('NG'))
      switch (r.type) {
        case 'NGRoot':
          return [
            n('node'),
            bD(r.node) ? ' //' + CD(r.node)[0].value.trimEnd() : '',
          ]
        case 'NGPipeExpression':
          return vD(e, t, n)
        ...
        case 'NGMicrosyntaxExpression':
          return [n('expression'), null === r.alias ? '' : [' as ', n('alias')]]
        case 'NGMicrosyntaxKeyedExpression': {
          const t = e.getName(),
            i = e.getParentNode(),
            u =
              AD(r, t, i) ||
              (((1 === t && ('then' === r.key.name || 'else' === r.key.name)) ||
                (2 === t &&
                  'else' === r.key.name &&
        ...
        case 'NGMicrosyntaxLet':
          return ['let ', n('key'), null === r.value ? '' : [' = ', n('value')]]
...
const { printComments: xD, printDanglingComments: SD } = Bf,
  {
    builders: {
      line: wD,
      hardline: TD,
      ...
      fill: OD,
      ifBreak: ID,
      lineSuffixBoundary: jD,
      join: LD,
    },
    utils: { willBreak: _D },
  } = ki,
  { getLast: MD, getPreferredQuote: RD } = Jr,
  {
    isJsxNode: $D,
    rawText: VD,
    isLiteral: qD,
    ...
    isBinaryish: zD,
    hasComment: GD,
    CommentCheckFlags: HD,
    hasNodeIgnoreComment: JD,
  } = Ph,
  { willPrintOwnComments: XD } = by,
  YD = (e) => '' === e || e === wD || e === TD || e === BD
function KD(e, t, n) {
  const r = e.getValue()
  if (
    'JSXElement' === r.type &&
  ...
  const o = r.children.filter($D).length > 0,
    s =
      r.children.filter((e) => 'JSXExpressionContainer' === e.type).length > 1,
    a = 'JSXElement' === r.type && r.openingElement.attributes.length > 1
  let l = _D(i) || o || a || s
  const c = 'mdx' === e.getParentNode().rootMarker,
    p = t.singleQuote ? "{' '}" : '{" "}',
    f = c ? ' ' : ID([p, BD], ' '),
        ...
        e.each((e, t, o) => {
          ...
          if (qD(s)) {
            ...
            if (uE(s)) {
              ...
              let a
              if (('' === MD(n) && (n.pop(), (a = n.pop())), 0 === n.length))
                return
              for (const [e, t] of n.entries())
                e % 2 == 1 ? u.push(wD) : u.push(t)
              if (void 0 !== a)
                if (/\n/.test(a)) {
                  const e = o[t + 1]
                  u.push(ZD(i, MD(u), s, e))
                } else u.push(r)
              else {
                const e = o[t + 1]
                u.push(QD(i, MD(u), s, e))
              }
            } else
              /\n/.test(e)
                ? e.match(/\n/g).length > 1 && u.push('', TD)
                : u.push('', r)
          } else {
            const e = n()
            u.push(e)
    ...
    h = r.children.some((e) => uE(e))
  for (let e = d.length - 2; e >= 0; e--) {
    const t = '' === d[e] && '' === d[e + 1],
      n = d[e] === TD && '' === d[e + 1] && d[e + 2] === TD,
      r = (d[e] === BD || d[e] === TD) && '' === d[e + 1] && d[e + 2] === f,
      i = d[e] === f && '' === d[e + 1] && (d[e + 2] === BD || d[e + 2] === TD),
      u = d[e] === f && '' === d[e + 1] && d[e + 2] === f,
      o =
        (d[e] === BD && '' === d[e + 1] && d[e + 2] === TD) ||
        (d[e] === TD && '' === d[e + 1] && d[e + 2] === BD)
    ;(n && h) || t || r || u || o ? d.splice(e, 2) : i && d.splice(e + 1, 2)
  }
  for (; d.length > 0 && YD(MD(d)); ) d.pop()
  for (; d.length > 1 && YD(d[0]) && YD(d[1]); ) d.shift(), d.shift()
  const g = []
  ...
  const m = h ? OD(g) : kD(g, { shouldBreak: !0 })
  if (c) return m
  const y = kD([i, ND([TD, m]), TD, u])
  return l ? y : PD([kD([i, ...d, u]), y])
}
function QD(e, t, n, r) {
  return e
    ? ''
...
function eE(e, t, n) {
  return (function (e, t, n) {
    ...
    const i = e.match(
      ...
      u = Ly(e, n)
    return kD([u ? '' : ID('('), ND([BD, t]), BD, u ? '' : ID(')')], {
      shouldBreak: i,
    })
  })(e, xD(e, KD(e, t, n), t), t)
}
  ...
  return [
    ...
    e.call(
      (e) => {
        const r = ['...', n()],
          i = e.getValue()
        return GD(i) && XD(e) ? [ND([BD, xD(e, r, t)]), BD] : r
      },
...
const nE = new RegExp('([ \n\r\t]+)'),
  rE = new RegExp('[^ \n\r\t]'),
  iE = (e) =>
    e.replace(new RegExp('(?:^' + nE.source + '|' + nE.source + '$)'), '')
function uE(e) {
  return qD(e) && (rE.test(VD(e)) || !/\n/.test(VD(e)))
}
var oE = {
  hasJsxIgnoreComment: function (e) {
    const t = e.getValue(),
      n = e.getParentNode()
    if (!(n && t && $D(t) && $D(n))) return !1
    let r = null
    for (let e = n.children.indexOf(t); e > 0; e--) {
      const t = n.children[e - 1]
      if ('JSXText' !== t.type || uE(t)) {
        r = t
        break
      }
    }
    ...
    if (r.type.startsWith('JSX'))
      switch (r.type) {
        ...
        case 'JSXNamespacedName':
          return LD(':', [n('namespace'), n('name')])
        case 'JSXMemberExpression':
          return LD('.', [n('object'), n('property')])
        case 'JSXSpreadAttribute':
          return tE(e, t, n)
        case 'JSXSpreadChild':
          return tE(e, t, n)
        ...
        case 'JSXOpeningElement':
          return (function (e, t, n) {
            const r = e.getValue(),
              i =
                (r.name && GD(r.name)) ||
                (r.typeParameters && GD(r.typeParameters))
            ...
            const u =
                r.attributes.length > 0 && GD(MD(r.attributes), HD.Trailing),
              o =
                (0 === r.attributes.length && !i) ||
                (t.jsxBracketSameLine && (!i || r.attributes.length > 0) && !u),
              s =
                r.attributes &&
                r.attributes.some(
                  (e) => e.value && UD(e.value) && e.value.value.includes('\n')
                )
            return kD(
              [
                '<',
                n('name'),
                n('typeParameters'),
                ND(e.map(() => [wD, n()], 'attributes')),
                r.selfClosing ? wD : o ? '>' : BD,
                r.selfClosing ? '/>' : o ? '' : '>',
              ],
              { shouldBreak: s }
            )
        ...
        case 'JSXClosingElement':
          return (function (e, t, n) {
            ...
            const u = n('name')
            return (
              GD(r.name, HD.Leading | HD.Line)
                ? i.push(ND([TD, u]), TD)
                : GD(r.name, HD.Leading | HD.Block)
                ? i.push(' ', u)
                : i.push(u),
              i.push('>'),
              i
  ...
  { target: 'Array', proto: !0 },
  {
    flat: function () {
      var e = arguments.length ? arguments[0] : void 0,
        ...
        n = _t(t.length),
        r = bn(t, 0)
      return (r.length = sn(r, t, t, n, 0, void 0 === e ? 1 : jt(e))), r
    },
  }
)
const { isNonEmptyArray: sE } = Jr,
  {
    builders: { indent: aE, join: lE, line: cE },
  } = ki,
  { isFlowAnnotationComment: pE } = Ph
function fE(e, t, n) {
  const r = e.getValue()
  ...
  return pE(t.originalText, r.typeAnnotation)
    ? [' /*: ', n('typeAnnotation'), ' */']
...
var dE = {
  ...
  printTypeScriptModifiers: function (e, t, n) {
    const r = e.getValue()
    return sE(r.modifiers) ? [lE(' ', e.map(n, 'modifiers')), ' '] : ''
  },
  printTypeAnnotation: fE,
  printRestSpread: function (e, t, n) {
    return ['...', n('argument'), fE(e, t, n)]
  },
...
const { printDanglingComments: hE } = Bf,
  {
    builders: {
      line: gE,
      softline: mE,
  ...
  { getLast: vE, hasNewline: AE } = Jr,
  {
    shouldPrintComma: FE,
    hasComment: xE,
    CommentCheckFlags: SE,
    isNextLineEmpty: wE,
    isNumericLiteral: TE,
    isSignedNumericLiteral: BE,
  } = Ph,
  { locStart: kE } = Cl,
  { printOptionalToken: NE, printTypeAnnotation: PE } = dE
function OE(e, t) {
  return (
    e.elements.length > 1 &&
    e.elements.every(
      (e) =>
        e &&
        (TE(e) || (BE(e) && !xE(e.argument))) &&
        !xE(
          e,
          SE.Trailing | SE.Line,
          (e) => !AE(t.originalText, kE(e), { backwards: !0 })
        )
    )
  )
}
function IE(e, t, n, r) {
  ...
  return (
    e.each((e) => {
      i.push(u, DE(r())),
        (u = [',', gE]),
        e.getValue() && wE(e.getValue(), t) && u.push(mE)
    }, n),
    i
  )
}
...
var LE = {
  printArray: function (e, t, n) {
    ...
    if (0 === r.elements.length)
      xE(r, SE.Dangling) ? i.push(DE([u, hE(e, t), mE, ']'])) : i.push(u, ']')
    else {
      const o = vE(r.elements),
      ...
      i.push(
        DE(
          [
            ...
            EE([
              mE,
              p ? jE(e, t, n, f) : [IE(e, t, 'elements', n), f],
              hE(e, t, !0),
            ]),
            mE,
            ']',
    ...
    return i.push(NE(e), PE(e, t, n)), i
  },
  printArrayItems: IE,
  isConciselyPrintedArray: OE,
}
const { printDanglingComments: _E } = Bf,
  { getLast: ME, getPenultimate: RE } = Jr,
  {
    getFunctionParameters: $E,
    hasComment: VE,
    CommentCheckFlags: qE,
    isFunctionCompositionArgs: WE,
    isJsxNode: UE,
    isLongCurriedCallExpression: zE,
    shouldPrintComma: GE,
    getCallArguments: HE,
    iterateCallArgumentsPath: JE,
    isNextLineEmpty: XE,
    isCallExpression: YE,
    isStringLiteral: KE,
    isObjectProperty: QE,
  ...
  { ArgExpansionBailout: ab } = Yu,
  { isConciselyPrintedArray: lb } = LE
function cb(e, t = !1) {
  return (
    ('ObjectExpression' === e.type && (e.properties.length > 0 || VE(e))) ||
    ('ArrayExpression' === e.type && (e.elements.length > 0 || VE(e))) ||
    ('TSTypeAssertion' === e.type && cb(e.expression)) ||
    ('TSAsExpression' === e.type && cb(e.expression)) ||
    'FunctionExpression' === e.type ||
    ('ArrowFunctionExpression' === e.type &&
      (!e.returnType ||
        ...
        ('BlockStatement' === (n = e.body).type &&
          (n.body.some((e) => 'EmptyStatement' !== e.type) ||
            VE(n, qE.Dangling)))) &&
      ('BlockStatement' === e.body.type ||
        ('ArrowFunctionExpression' === e.body.type && cb(e.body, !0)) ||
        'ObjectExpression' === e.body.type ||
        'ArrayExpression' === e.body.type ||
        (!t && (YE(e.body) || 'ConditionalExpression' === e.body.type)) ||
        UE(e.body))) ||
    'DoExpression' === e.type ||
...
var pb = function (e, t, n) {
  ...
  JE(e, (e, r) => {
    ...
    r === a ||
      (XE(i, t)
        ? (0 === r && (s = !0), (o = !0), u.push(',', eb, eb))
        : u.push(',', ZE)),
      l.push(u)
  })
  const c =
    i || (r.callee && 'Import' === r.callee.type) || !GE(t, 'all') ? '' : ','
  function p() {
    return nb(['(', rb([ZE, ...l]), c, ZE, ')'], { shouldBreak: !0 })
  }
  if (o || ('Decorator' !== e.getParentNode().type && WE(u))) return p()
  const f = (function (e) {
    ...
    d = (function (e, t) {
      ...
      return (
        ...
        (2 !== e.length ||
          ...
          'ArrayExpression' !== n.type) &&
        !(e.length > 1 && 'ArrayExpression' === n.type && lb(n, t))
      )
    })(u, t)
  if (f || d) {
    if (f ? l.slice(1).some(sb) : l.slice(0, -1).some(sb)) return p()
    let t = []
    try {
      e.try(() => {
        JE(e, (e, r) => {
          f &&
            ...
            d &&
              r === a &&
              (t = [...l.slice(0, -1), n([], { expandLastArg: !0 })])
        })
      })
    } catch (e) {
      if (e instanceof ab) return p()
      throw e
    }
    return [
      l.some(sb) ? ob : '',
      ib([
        ['(', ...t, ')'],
        f
          ? ['(', nb(t[0], { shouldBreak: !0 }), ...t.slice(1), ')']
          : ['(', ...l.slice(0, -1), nb(ME(t), { shouldBreak: !0 }), ')'],
        p(),
      ]),
    ]
  }
  const h = ['(', rb([tb, ...l]), ub(c), tb, ')']
  return zE(e) ? h : nb(h, { shouldBreak: l.some(sb) || o })
}
const {
    builders: { softline: fb, group: db, indent: hb, label: gb },
  } = ki,
  { isNumericLiteral: mb, isMemberExpression: yb, isCallExpression: Db } = Ph,
  { printOptionalToken: Eb } = dE
function bb(e, t, n) {
  const r = n('property'),
    i = e.getValue(),
    u = Eb(e)
  return i.computed
    ? !i.property || mb(i.property)
      ? [u, '[', r, ']']
      : db([u, '[', hb([fb, r]), fb, ']'])
    : [u, '.', r]
}
var Cb = {
  printMemberExpression: function (e, t, n) {
    ...
    } while (u && (yb(u) || 'TSNonNullExpression' === u.type))
    const s = n('object'),
      a = bb(e, t, n),
      l =
        (u &&
        ...
        (('AssignmentExpression' === i.type ||
          'VariableDeclarator' === i.type) &&
          ((Db(r.object) && r.object.arguments.length > 0) ||
            ('TSNonNullExpression' === r.object.type &&
              Db(r.object.expression) &&
              r.object.expression.arguments.length > 0) ||
            'member-chain' === s.label))
    return gb('member-chain' === s.label ? 'member-chain' : 'member', [
      s,
      l ? a : db(hb([fb, a])),
    ])
  },
  printMemberLookup: bb,
}
const { printComments: vb } = Bf,
  {
    getLast: Ab,
    isNextLineEmptyAfterIndex: Fb,
    getNextNonSpaceNonCommentCharacterIndex: xb,
  } = Jr,
  {
    isCallExpression: Sb,
    isMemberExpression: wb,
    isFunctionOrArrowExpression: Tb,
    isLongCurriedCallExpression: Bb,
    isMemberish: kb,
    isNumericLiteral: Nb,
    isSimpleCallArgument: Pb,
    hasComment: Ob,
  ...
  { printMemberLookup: zb } = Cb,
  {
    printOptionalToken: Gb,
    printFunctionTypeParameters: Hb,
    printBindExpressionCallee: Jb,
  } = dE
var Xb = function (e, t, n) {
  ...
  function o(e) {
    const { originalText: n } = t,
      r = xb(n, e, Lb)
    return ')' === n.charAt(r) ? !1 !== r && Fb(n, r + 1) : jb(e, t)
  }
  function s(e) {
    const r = e.getValue()
    Sb(r) && (kb(r.callee) || Sb(r.callee))
      ? (u.unshift({
          node: r,
          printed: [
            vb(e, [Gb(e), Hb(e, t, n), pb(e, t, n)], t),
            o(r) ? Mb : '',
          ],
        }),
        e.call((e) => s(e), 'callee'))
      ...
      ? (u.unshift({
          node: r,
          needsParens: Ly(e, t),
          printed: vb(e, wb(r) ? zb(e, t, n) : Jb(e, t, n), t),
        }),
        e.call((e) => s(e), 'object'))
      : 'TSNonNullExpression' === r.type
      ? (u.unshift({ node: r, printed: vb(e, '!', t) }),
        e.call((e) => s(e), 'expression'))
      : u.unshift({ node: r, printed: n() })
  }
  const a = e.getValue()
  u.unshift({ node: a, printed: [Gb(e), Hb(e, t, n), pb(e, t, n)] }),
  ...
  for (
    ...
    ('TSNonNullExpression' === u[p].node.type ||
      Sb(u[p].node) ||
      (wb(u[p].node) && u[p].node.computed && Nb(u[p].node.property)));
    ++p
  )
    c.push(u[p])
  if (!Sb(u[0].node))
    for (; p + 1 < u.length && kb(u[p].node) && kb(u[p + 1].node); ++p)
      c.push(u[p])
  l.push(c), (c = [])
  let f = !1
  for (; p < u.length; ++p) {
    if (f && kb(u[p].node)) {
      if (u[p].node.computed && Nb(u[p].node.property)) {
        c.push(u[p])
        continue
      }
      l.push(c), (c = []), (f = !1)
    }
    ;(Sb(u[p].node) || 'ImportExpression' === u[p].node.type) && (f = !0),
      c.push(u[p]),
      Ob(u[p].node, Ib.Trailing) && (l.push(c), (c = []), (f = !1))
  }
  function d(e) {
    return /^[A-Z]|^[$_]+$/.test(e)
  }
  ...
  const h =
    ...
    (function (e) {
      ...
      const r = Ab(e[0]).node
      return (
        wb(r) && 'Identifier' === r.property.type && (d(r.property.name) || n)
      )
    })(l)
  function g(e) {
    const t = e.map((e) => e.printed)
    return e.length > 0 && Ab(e).needsParens ? ['(', ...t, ')'] : t
  }
  const m = l.map(g),
    y = m,
    D = h ? 3 : 2,
    E = l.flat(),
    b =
      E.slice(1, -1).some((e) => Ob(e.node, Ib.Leading)) ||
      E.slice(0, -1).some((e) => Ob(e.node, Ib.Trailing)) ||
      (l[D] && Ob(l[D][0].node, Ib.Leading))
  if (l.length <= D && !b) return Bb(e) ? y : Rb(y)
  const C = Ab(l[h ? 1 : 0]).node,
    v = !Sb(C) && o(C),
    A = [
      g(l[0]),
      h ? l.slice(1, 2).map(g) : '',
      v ? Mb : '',
      (function (e) {
        return 0 === e.length ? '' : $b(Rb([Mb, _b(Mb, e.map(g))]))
      })(l.slice(h ? 2 : 1)),
    ],
    F = u.map(({ node: e }) => e).filter(Sb)
  let x
  return (
    (x =
      b ||
      (F.length > 2 && F.some((e) => !e.arguments.every((e) => Pb(e, 0)))) ||
      m.slice(0, -1).some(Ub) ||
      (function () {
        const e = Ab(Ab(l)).node,
          t = Ab(m)
        return (
          Sb(e) && Ub(t) && F.slice(0, -1).some((e) => e.arguments.some(Tb))
        )
      })()
        ? Rb(A)
        : [Ub(y) || v ? qb : '', Vb([y, A])]),
...
const {
    builders: { join: Yb, group: Kb },
  } = ki,
  {
    getCallArguments: Qb,
    hasFlowAnnotationComment: Zb,
    isCallExpression: eC,
    isMemberish: tC,
    isStringLiteral: nC,
    isTemplateOnItsOwnLine: rC,
    isTestCall: iC,
    iterateCallArgumentsPath: uC,
  } = Ph,
  { printOptionalToken: oC, printFunctionTypeParameters: sC } = dE
var aC = {
          ...
          if ('define' === e.callee.name) {
            ...
            return (
              ...
              (1 === n.length ||
                ...
                (3 === n.length && nC(n[0]) && 'ArrayExpression' === n[1].type))
            )
          }
          return !1
        })(r, i)) ||
        (1 === a.length && rC(a[0], t.originalText)) ||
        (!u && iC(r, i)))
    ) {
      const r = []
      return (
        ...
        [u ? 'new ' : '', n('callee'), s, sC(e, t, n), '(', Yb(', ', r), ')']
      )
    }
    const l =
      ...
      Zb(r.callee.trailingComments)
    if (
      (l && (r.callee.trailingComments[0].printed = !0),
      !o && !u && tC(r.callee) && !e.call((e) => Ly(e, t), 'callee'))
    )
      return Xb(e, t, n)
    const c = [
      u ? 'new ' : '',
      o ? 'import' : n('callee'),
      s,
      l ? `/*:: ${r.callee.trailingComments[0].value.slice(2).trim()} */` : '',
      sC(e, t, n),
      pb(e, t, n),
    ]
    return o || eC(r.callee) ? Kb(c) : c
  },
}
const { isNonEmptyArray: lC, getStringWidth: cC } = Jr,
  {
    builders: { line: pC, group: fC, indent: dC, indentIfBreak: hC },
    utils: { cleanDoc: gC, willBreak: mC },
  } = ki,
  {
    hasLeadingOwnLineComment: yC,
    isBinaryish: DC,
    isStringLiteral: EC,
    isLiteral: bC,
    isNumericLiteral: CC,
    isCallExpression: vC,
    isMemberExpression: AC,
    getCallArguments: FC,
    rawText: xC,
    hasComment: SC,
    isSignedNumericLiteral: wC,
    isObjectProperty: TC,
  } = Ph,
  { shouldInlineLogicalExpression: BC } = gD,
  { printCallExpression: kC } = aC
function NC(e, t, n, r, i, u) {
  const o = (function (e, t, n, r, i) {
      ...
      if (
        ...
        return s
          ? 'ArrowFunctionExpression' === o.type &&
            ...
            : 'chain-tail'
          : 'chain'
      if ((!s && PC(o.right)) || yC(t.originalText, o))
      ...
      if (
        ...
        (function (e) {
          const t = (function (e) {
            if (
              (function (e) {
                return (
                  'TSTypeAliasDeclaration' === e.type || 'TypeAlias' === e.type
                )
              })(e) &&
              e.typeParameters &&
        ...
        (function (e) {
          ...
          const n = IC(t.typeAnnotation)
          return (
            lC(n) &&
            n.length > 1 &&
            n.some((e) => lC(IC(e)) || 'TSConditionalType' === e.type)
          )
        })(u)
      )
        return 'break-lhs'
      const a = (function (e, t, n) {
        ...
        t = gC(t)
        const r = 3
        return 'string' == typeof t && cC(t) < n.tabWidth + r
      })(u, r, t)
      if (
        e.call(
          () =>
            (function (e, t, n, r) {
              ...
              if (EC(u) || e.call(() => jC(e, t, n), ...o)) return !0
              return !1
            })(e, t, n, a),
          i
        )
  ...
  switch (o) {
    case 'break-after-operator':
      return fC([fC(r), i, fC(dC([pC, s]))])
    case 'never-break-after-operator':
      return fC([fC(r), i, ' ', s])
    case 'fluid': {
      const e = Symbol('assignment')
      return fC([fC(r), i, fC(dC(pC), { id: e }), hC(s, { groupId: e })])
    }
    case 'break-lhs':
      return fC([r, i, ' ', fC(s)])
    case 'chain':
...
function OC(e) {
  return PC(e) || 'VariableDeclarator' === e.type
}
function IC(e) {
  return (function (e) {
...
function jC(e, t, n, r = !1) {
  ...
  if (vC(i)) {
    if ('member-chain' === kC(e, t, n).label) return !1
    const r = FC(i)
    return (
      !!(
        0 === r.length ||
...
var LC = {
  printVariableDeclarator: function (e, t, n) {
    return NC(e, t, n, n('id'), ' =', 'init')
  },
  printAssignmentExpression: function (e, t, n) {
    const r = e.getValue()
    return NC(e, t, n, n('left'), [' ', r.operator], 'right')
  },
  printAssignment: NC,
}
const { getNextNonSpaceNonCommentCharacter: _C } = Jr,
  { printDanglingComments: MC } = Bf,
  {
    builders: {
      line: RC,
      hardline: $C,
    ...
    utils: { removeLines: zC, willBreak: GC },
  } = ki,
  {
    getFunctionParameters: HC,
    iterateFunctionParametersPath: JC,
    isSimpleType: XC,
    isTestCall: YC,
    isTypeAnnotationAFunction: KC,
    isObjectType: QC,
    isObjectTypePropertyAFunction: ZC,
    hasRestParameter: ev,
    shouldPrintComma: tv,
    hasComment: nv,
    isNextLineEmpty: rv,
  ...
  { locEnd: iv } = Cl,
  { ArgExpansionBailout: uv } = Yu,
  { printFunctionTypeParameters: ov } = dE
function sv(e) {
  if (!e) return !1
  const t = HC(e)
  ...
  return (
    ...
    ('ObjectPattern' === n.type ||
      ...
      ('Identifier' === n.type &&
        ...
        QC(n.typeAnnotation.typeAnnotation)) ||
      ('FunctionTypeParam' === n.type && QC(n.typeAnnotation)) ||
      ('AssignmentPattern' === n.type &&
...
var av = {
  printFunctionParameters: function (e, t, n, r, i) {
    ...
    if (0 === o.length)
      return [
        s,
        '(',
        MC(e, n, !0, (e) => ')' === _C(n.originalText, e, iv)),
        ')',
      ]
    ...
    if (
      (JC(e, (e, r) => {
        ...
        i && u.rest && p.push('...'),
          ...
          i ||
            (p.push(','),
            l || c ? p.push(' ') : rv(o[r], n) ? p.push($C, $C) : p.push(RC))
      }),
      r)
    ) {
      if (GC(s) || GC(p)) throw new uv()
      return qC([zC(s), '(', zC(p), ')'])
    }
    ...
    return (c && f) || l
      ...
      : (ZC(a) ||
        ...
        XC(o[0].typeAnnotation) &&
        !u.rest
      ? 'always' === n.arrowParens
        ? ['(', ...p, ')']
        : p
      : [s, '(', WC([VC, ...p]), UC(!ev(u) && tv(n, 'all') ? ',' : ''), VC, ')']
  },
  shouldHugFunctionParameters: sv,
  shouldGroupFunctionParameters: function (e, t) {
    ...
    return 1 === HC(e).length && (QC(n) || GC(t))
  },
}
const { printComments: lv, printDanglingComments: cv } = Bf,
  { getLast: pv } = Jr,
  {
    builders: {
      group: fv,
  ...
  { locStart: Ev } = Cl,
  {
    isSimpleType: bv,
    isObjectType: Cv,
    hasLeadingOwnLineComment: vv,
    isObjectTypePropertyAFunction: Av,
    shouldPrintComma: Fv,
  } = Ph,
  { printAssignment: xv } = LC,
  { printFunctionParameters: Sv, shouldGroupFunctionParameters: wv } = av,
  { printArrayItems: Tv } = LE
function Bv(e) {
  if (bv(e) || Cv(e)) return !0
...
var kv = {
  ...
  printIntersectionType: function (e, t, n) {
    ...
    for (let e = 0; e < i.length; ++e)
      0 === e
        ? u.push(i[e])
        : Cv(r.types[e - 1]) && Cv(r.types[e])
        ? u.push([' & ', o ? mv(i[e]) : i[e]])
        : Cv(r.types[e - 1]) || Cv(r.types[e])
        ? (e > 1 && (o = !0), u.push(' & ', e > 1 ? mv(i[e]) : i[e]))
        : u.push(mv([' &', hv, i[e]]))
    return fv(u)
  },
  printUnionType: function (e, t, n) {
    const r = e.getValue(),
      ...
      s = e.map((e) => {
        let r = n()
        return o || (r = yv(2, r)), lv(e, r, t)
      }, 'types')
    if (o) return dv(' | ', s)
    const a = u && !vv(t.originalText, r),
      l = [Dv([a ? hv : '', '| ']), dv([hv, '| '], s)]
    return Ly(e, t)
      ? fv([mv(l), gv])
  ...
  printFunctionType: function (e, t, n) {
    ...
    let a =
      ...
      l = a && ('TypeAnnotation' === u.type || 'TSTypeAnnotation' === u.type)
    const c =
      l &&
      a &&
      ('TypeAnnotation' === u.type || 'TSTypeAnnotation' === u.type) &&
      'ArrowFunctionExpression' === o.type
    Av(u) && ((a = !0), (l = !0)), c && i.push('(')
    const p = Sv(e, n, t, !1, !0),
      f =
        r.returnType || r.predicate || r.typeAnnotation
          ...
          : '',
      d = wv(r, f)
    return i.push(d ? fv(p) : p), f && i.push(f), c && i.push(')'), fv(i)
  },
  printTupleType: function (e, t, n) {
    const r = e.getValue(),
      i = 'TSTupleType' === r.type ? 'elementTypes' : 'types',
      u = r[i].length > 0 && 'TSRestType' === pv(r[i]).type
    return fv([
      '[',
      mv([gv, Tv(e, t, i, n)]),
      Dv(Fv(t, 'all') && !u ? ',' : ''),
...
const { printDanglingComments: Nv } = Bf,
  {
    builders: {
      join: Pv,
      line: Ov,
  ...
  } = ki,
  {
    isTestCall: Rv,
    hasComment: $v,
    CommentCheckFlags: Vv,
    isTSXFile: qv,
    shouldPrintComma: Wv,
    getFunctionParameters: Uv,
  } = Ph,
  { createGroupIdMapper: zv } = Jr,
  { shouldHugType: Gv } = kv,
  Hv = zv('typeParameters')
function Jv(e, t) {
  const n = e.getValue()
  if (!$v(n, Vv.Dangling)) return ''
  const r = !$v(n, Vv.Line),
    i = Nv(e, t, r)
  return r ? i : [i, Iv]
}
var Xv = {
  ...
  printTypeParameters: function (e, t, n, r) {
    ...
    if (
      ...
      0 === i[r].length ||
      (1 === i[r].length &&
        (Gv(i[r][0]) || 'NullableTypeAnnotation' === i[r][0].type))
    )
      return ['<', Pv(', ', e.map(n, r)), Jv(e, t), '>']
    const o =
      'TSTypeParameterInstantiation' === i.type
        ? ''
        : 1 === Uv(i).length &&
        ...
        ? Mv(',')
        : ''
    return Lv(['<', _v([jv, Pv([',', Ov], e.map(n, r))]), o, jv, '>'], {
      id: Hv(i),
    })
  },
  getTypeParametersGroupId: Hv,
}
const { printComments: Yv } = Bf,
  { printString: Kv, printNumber: Qv } = Jr,
  {
    isNumericLiteral: Zv,
    isSimpleNumber: eA,
    isStringLiteral: tA,
    isStringPropSafeToUnquote: nA,
    rawText: rA,
  } = Ph,
  { printAssignment: iA } = LC,
  uA = new WeakMap()
function oA(e, t, n) {
  const r = e.getNode()
  ...
  if ('ClassPrivateProperty' === r.type && 'Identifier' === u.type)
    return ['#', n('key')]
  if ('consistent' === t.quoteProps && !uA.has(i)) {
    const e = (i.properties || i.body || i.members).some(
      (e) => !e.computed && e.key && tA(e.key) && !nA(e, t)
    )
    uA.set(i, e)
  }
  if (
    ('Identifier' === u.type ||
      (Zv(u) &&
        eA(Qv(rA(u))) &&
        String(u.value) === Qv(rA(u)) &&
        'typescript' !== t.parser &&
        'babel-ts' !== t.parser)) &&
    ('json' === t.parser || ('consistent' === t.quoteProps && uA.get(i)))
  ) {
    const n = Kv(
      JSON.stringify('Identifier' === u.type ? u.name : u.value.toString()),
      t
    )
    return e.call((e) => Yv(e, n, t), 'key')
  }
  return nA(r, t) &&
    ('as-needed' === t.quoteProps ||
      ('consistent' === t.quoteProps && !uA.get(i)))
    ? e.call(
        (e) => Yv(e, /^\d/.test(u.value) ? Qv(u.value) : u.value, t),
        'key'
      )
    : n('key')
}
var sA = {
  printProperty: function (e, t, n) {
    return e.getValue().shorthand
      ? n('value')
      : iA(e, t, n, oA(e, t, n), ':', 'value')
  },
  printPropertyKey: oA,
}
const { printDanglingComments: aA, printCommentsSeparately: lA } = Bf,
  { getNextNonSpaceNonCommentCharacterIndex: cA } = Jr,
  {
    builders: {
      line: pA,
      softline: fA,
    ...
    utils: { removeLines: EA, willBreak: bA },
  } = ki,
  { ArgExpansionBailout: CA } = Yu,
  {
    getFunctionParameters: vA,
    hasLeadingOwnLineComment: AA,
    isFlowAnnotationComment: FA,
    isJsxNode: xA,
    isTemplateOnItsOwnLine: SA,
    shouldPrintComma: wA,
    startsWithNoLookaheadToken: TA,
    isBinaryish: BA,
    isLineComment: kA,
    hasComment: NA,
    getComments: PA,
    CommentCheckFlags: OA,
    isCallLikeExpression: IA,
    isCallExpression: jA,
    getCallArguments: LA,
    hasNakedLeftSide: _A,
    getLeftSide: MA,
  ...
  { locEnd: RA } = Cl,
  { printFunctionParameters: $A, shouldGroupFunctionParameters: VA } = av,
  { printPropertyKey: qA } = sA,
  { printFunctionTypeParameters: WA } = dE
function UA(e, t, n) {
  const r = e.getNode(),
    i = $A(e, n, t),
    u = GA(e, n, t),
    o = VA(r, u),
    s = [WA(e, t, n), dA([o ? dA(i) : i, u])]
...
function GA(e, t, n) {
  const r = e.getValue(),
    i = t('returnType')
  if (r.returnType && FA(n.originalText, r.returnType))
    return [' /*: ', i, ' */']
  const u = [i]
  return (
...
function HA(e, t, n) {
  ...
  r.argument &&
    (!(function (e, t) {
      if (AA(e.originalText, t)) return !0
      if (_A(t)) {
        let n,
          r = t
        for (; (n = MA(r)); ) if (((r = n), AA(e.originalText, r))) return !0
      }
      return !1
    })(t, r.argument)
      ? BA(r.argument) || 'SequenceExpression' === r.argument.type
        ? u.push(dA([gA(' (', ' '), hA([fA, n('argument')]), fA, gA(')')]))
        : u.push(' ', n('argument'))
      : u.push([' (', hA([mA, n('argument')]), mA, ')']))
  const o = PA(r),
    s = Be(o),
    a = s && kA(s)
  return (
    a && u.push(i),
    NA(r, OA.Dangling) && u.push(' ', aA(e, t, !0)),
    a || u.push(i),
    u
  )
}
var JA = {
  printFunction: function (e, t, n, r) {
    ...
    const s = $A(e, t, n, u),
      ...
      l = VA(i, a)
    return (
      o.push(WA(e, n, t), dA([l ? dA(s) : s, a]), i.body ? ' ' : '', t('body')),
    ...
    if (
      ((function a() {
        const l = (function (e, t, n, r) {
          const i = []
          if ((e.getValue().async && i.push('async '), zA(e, t)))
            i.push(n(['params', 0]))
          else {
            const u = r && (r.expandLastArg || r.expandFirstArg)
            let o = GA(e, n, t)
            if (u) {
              if (bA(o)) throw new CA()
              o = dA(EA(o))
            }
            i.push(dA([$A(e, n, t, u, !0), o]))
          }
          const u = aA(e, t, !0, (e) => {
            const n = cA(t.originalText, e, RA)
            return !1 !== n && '=>' === t.originalText.slice(n, n + 2)
          })
          return u && i.push(' ', u), i
        })(e, t, n, r)
        if (0 === u.length) u.push(l)
        else {
          const { leading: n, trailing: r } = lA(e, t)
          u.push([n, l]), o.unshift(r)
        }
        ;(s =
          s ||
          (i.returnType && vA(i).length > 0) ||
          i.typeParameters ||
          vA(i).some((e) => 'Identifier' !== e.type)),
      ...
      return (function (e, t, n, r, i, u) {
        const o = e.getName(),
          s = e.getParentNode(),
          a = IA(s) && 'callee' === o,
          l = Boolean(t && t.assignmentLayout),
          c =
            'BlockStatement' !== u.body.type &&
            'ObjectExpression' !== u.body.type,
          p =
            (a && c) || (t && 'chain-tail-arrow-chain' === t.assignmentLayout),
          f = Symbol('arrow-chain')
        return dA([
          dA(
            hA([a || l ? fA : '', dA(yA([' =>', pA], n), { shouldBreak: r })]),
            { id: f, shouldBreak: p }
          ),
          ' =>',
          DA(c ? hA([pA, i]) : [' ', i], { groupId: f }),
          a ? gA(fA, '', { groupId: f }) : '',
        ])
      })(e, r, u, s, o, i)
    const a = u
  ...
  printMethod: function (e, t, n) {
    ...
    return (
      i && 'init' !== i && 'method' !== i && 'constructor' !== i
        ? (nf.ok('get' === i || 'set' === i), o.push(i, ' '))
        : u.async && o.push('async '),
      u.generator && o.push('*'),
      o.push(qA(e, t, n), r.optional || r.key.optional ? '?' : ''),
      r === u
        ? o.push(UA(e, t, n))
        : 'FunctionExpression' === u.type
        ? o.push(e.call((e) => UA(e, t, n), 'value'))
        : o.push(n('value')),
      o
    )
  },
  ...
  printMethodInternal: UA,
  shouldPrintParamsWithoutParens: zA,
}
const { isNonEmptyArray: XA, hasNewline: YA } = Jr,
  {
    builders: { line: KA, hardline: QA, join: ZA, breakParent: eF, group: tF },
  } = ki,
  { locStart: nF, locEnd: rF } = Cl,
  { getParentExportDeclaration: iF } = Ph
function uF(e, t) {
  return e.decorators.some((e) => YA(t.originalText, rF(e)))
}
function oF(e) {
  if (
    'ExportDefaultDeclaration' !== e.type &&
  ...
  return XA(t) && nF(e, { ignoreDecorators: !0 }) > nF(t[0])
}
var sF = {
  printDecorators: function (e, t, n) {
    const r = e.getValue(),
      { decorators: i } = r
    if (!XA(i) || oF(e.getParentNode())) return
    const u =
      'ClassExpression' === r.type || 'ClassDeclaration' === r.type || uF(r, t)
    return [iF(e) ? QA : u ? eF : '', ZA(KA, e.map(n, 'decorators')), KA]
  },
  printClassMemberDecorators: function (e, t, n) {
    const r = e.getValue()
    return tF([ZA(KA, e.map(n, 'decorators')), uF(r, t) ? QA : KA])
  },
  printDecoratorsBeforeExport: function (e, t, n) {
    return [ZA(QA, e.map(n, 'declaration', 'decorators')), QA]
  },
  hasDecoratorsBeforeExport: oF,
}
const { isNonEmptyArray: aF, createGroupIdMapper: lF } = Jr,
  { printComments: cF, printDanglingComments: pF } = Bf,
  {
    builders: {
      join: fF,
      line: dF,
  ...
  { hasComment: EF, CommentCheckFlags: bF } = Ph,
  { getTypeParametersGroupId: CF } = Xv,
  { printMethod: vF } = JA,
  { printOptionalToken: AF, printTypeAnnotation: FF } = dE,
  { printPropertyKey: xF } = sA,
  { printAssignment: SF } = LC,
  { printClassMemberDecorators: wF } = sF
const TF = lF('heritageGroup')
function BF(e) {
  return (
    e.typeParameters &&
    !EF(e.typeParameters, bF.Trailing | bF.Line) &&
    !(function (e) {
      return (
...
function kF(e, t, n, r) {
  const i = e.getValue()
  if (!aF(i[r])) return ''
  const u = pF(e, t, !0, ({ marker: e }) => e === r)
  return [
    BF(i) ? DF(' ', dF, { groupId: CF(i.typeParameters) }) : dF,
    u,
    u && hF,
    r,
    mF(yF([dF, fF([',', dF], e.map(n, r))])),
  ]
}
function NF(e, t, n) {
...
var PF = {
  printClass: function (e, t, n) {
    ...
    r.declare && i.push('declare '),
      ...
      i.push('class')
    const u =
        (r.id && EF(r.id, bF.Trailing)) ||
        (r.superClass && EF(r.superClass)) ||
        aF(r.extends) ||
        aF(r.mixins) ||
        aF(r.implements),
      o = [],
      s = []
    if (
      (r.id && o.push(' ', n('id')), o.push(n('typeParameters')), r.superClass)
    ) {
      const r = ['extends ', NF(e, t, n), n('superTypeParameters')],
        i = e.call((e) => cF(e, r, t), 'superClass')
      u ? s.push(dF, mF(i)) : s.push(' ', i)
    } else s.push(kF(e, t, n, 'extends'))
    if ((s.push(kF(e, t, n, 'mixins'), kF(e, t, n, 'implements')), u)) {
      let e
      ;(e = BF(r) ? [...o, yF(s)] : yF([...o, s])), i.push(mF(e, { id: TF(r) }))
    } else i.push(...o, ...s)
  ...
  printClassMethod: function (e, t, n) {
    const r = e.getValue(),
      i = []
    return (
      aF(r.decorators) && i.push(wF(e, t, n)),
  ...
  printClassProperty: function (e, t, n) {
    ...
    return (
      ...
      r.readonly && i.push('readonly '),
      r.variance && i.push(n('variance')),
      i.push(xF(e, t, n), AF(e), FF(e, t, n)),
      [SF(e, t, n, i, ' =', 'value'), u]
    )
  },
  printHardlineAfterHeritage: function (e) {
    return DF(hF, '', { groupId: TF(e) })
  },
}
const { isNonEmptyArray: OF } = Jr,
  {
    builders: { join: IF, line: jF, group: LF, indent: _F, ifBreak: MF },
  } = ki,
  { hasComment: RF, identity: $F, CommentCheckFlags: VF } = Ph,
  { getTypeParametersGroupId: qF } = Xv,
  { printTypeScriptModifiers: WF } = dE
var UF = {
  printInterface: function (e, t, n) {
    ...
    r.declare && i.push('declare '),
      'TSInterfaceDeclaration' === r.type &&
        i.push(r.abstract ? 'abstract ' : '', WF(e, t, n)),
      i.push('interface')
    const u = [],
      o = []
    'InterfaceTypeAnnotation' !== r.type &&
      u.push(' ', n('id'), n('typeParameters'))
    const s = r.typeParameters && !RF(r.typeParameters, VF.Trailing | VF.Line)
    return (
      OF(r.extends) &&
        o.push(
          s ? MF(' ', jF, { groupId: qF(r.typeParameters) }) : jF,
          'extends ',
          (1 === r.extends.length ? $F : _F)(IF([',', jF], e.map(n, 'extends')))
        ),
      (r.id && RF(r.id, VF.Trailing)) || OF(r.extends)
        ? s
          ? i.push(LF([...u, _F(o)]))
          : i.push(LF(_F([...u, ...o])))
        : i.push(...u, ...o),
...
const { isNonEmptyArray: zF } = Jr,
  ...
  { printDanglingComments: ZF } = Bf,
  {
    hasComment: ex,
    CommentCheckFlags: tx,
    shouldPrintComma: nx,
    needsHardlineAfterDanglingComment: rx,
  } = Ph,
  { locStart: ix, hasSameLoc: ux } = Cl,
  { hasDecoratorsBeforeExport: ox, printDecoratorsBeforeExport: sx } = sF
function ax(e, t, n) {
  const r = e.getValue()
  if (!r.source) return ''
  const i = []
  return cx(r, t) || i.push(' from'), i.push(' ', n('source')), i
}
function lx(e, t, n) {
  const r = e.getValue()
  if (cx(r, t)) return ''
  ...
  if (zF(r.specifiers)) {
    ...
    if (
      ...
      u.length > 0 && i.push(', ')
      o.length > 1 || u.length > 0 || r.specifiers.some((e) => ex(e))
        ? i.push(
            HF([
              '{',
              JF([t.bracketSpacing ? YF : GF, XF([',', YF], o)]),
              KF(nx(t) ? ',' : ''),
              t.bracketSpacing ? YF : GF,
              '}',
            ])
          )
        : i.push([
...
function cx(e, t) {
  ...
  return (
    ...
    !zF(u) &&
    'type' !== r &&
    !/{\s*}/.test(t.originalText.slice(ix(e), ix(i)))
  )
}
function px(e, t, n) {
  const r = e.getNode()
  return zF(r.assertions)
    ? [
        ' assert {',
        t.bracketSpacing ? ' ' : '',
        XF(', ', e.map(n, 'assertions')),
        t.bracketSpacing ? ' ' : '',
        '}',
      ]
    : ''
...
var fx = {
  printImportDeclaration: function (e, t, n) {
    ...
    return (
      u.push('import'),
      o && 'value' !== o && u.push(' ', o),
      u.push(lx(e, t, n), ax(e, t, n), px(e, t, n), i),
      u
    )
  },
  ...
  printModuleSpecifier: function (e, t, n) {
    ...
    return (
      'ExportNamespaceSpecifier' === i || 'ImportNamespaceSpecifier' === i
        ? (c = '*')
        : r[a] && (c = n(a)),
      !r[l] || (r[a] && ux(r[a], r[l])) || (p = n(l)),
      o.push(c, c && p ? ' as ' : '', p),
      o
    )
  },
}
const { printDanglingComments: dx } = Bf,
  {
    builders: {
      line: hx,
      softline: gx,
  ...
  } = Jr,
  {
    ...
    hasComment: xx,
    getComments: Sx,
    CommentCheckFlags: wx,
    isNextLineEmpty: Tx,
  } = Ph,
  { locStart: Bx, locEnd: kx } = Cl,
  { printOptionalToken: Nx, printTypeAnnotation: Px } = dE,
  { shouldHugFunctionParameters: Ox } = av,
  { shouldHugType: Ix } = kv,
  { printHardlineAfterHeritage: jx } = PF
var Lx = {
  printObject: function (e, t, n) {
    ...
    const a = s.map((e) => i[e][0]).sort((e, t) => Bx(e) - Bx(t))[0],
      l = e.getParentNode(0),
      c =
        o &&
        l &&
      ...
      p =
        ...
        ('ObjectPattern' !== i.type && a && Cx(t.originalText, Bx(i), Bx(a))),
      f = c
        ? ';'
    ...
    if (i.inexact) {
      let n
      if (xx(i, wx.Dangling)) {
        const r = xx(i, wx.Line)
        n = [
          dx(e, t, !0),
          r || vx(t.originalText, kx(bx(Sx(i)))) ? Ex : hx,
          '...',
        ]
      } else n = ['...']
      y.push([...m, ...n])
    ...
    const D = bx(i[u]),
      E = !(
        ...
        (D &&
          ...
          xx(D, wx.PrettierIgnore))
      )
    let b
    if (0 === y.length) {
      if (!xx(i, wx.Dangling)) return [d, h, Px(e, t, n)]
      b = mx([d, dx(e, t), gx, h, Nx(e), Px(e, t, n)])
    } else
      b = [
        c && Ax(i.properties) ? jx(l) : '',
        d,
        yx([t.bracketSpacing ? hx : gx, ...y]),
        Dx(E && (',' !== f || Fx(t)) ? f : ''),
        t.bracketSpacing ? hx : gx,
        h,
        Nx(e),
        Px(e, t, n),
      ]
    return e.match(
      ...
      (!p &&
        e.match(
          ...
          (e) =>
            'AssignmentExpression' === e.type || 'VariableDeclarator' === e.type
        ))
      ? b
      : mx(b, { shouldBreak: p })
  },
}
const { printDanglingComments: _x } = Bf,
  { printString: Mx, printNumber: Rx } = Jr,
  {
    builders: { hardline: $x, softline: Vx, group: qx, indent: Wx },
  } = ki,
  {
    getParentExportDeclaration: Ux,
    isFunctionNotation: zx,
    isGetterOrSetter: Gx,
    rawText: Hx,
    shouldPrintComma: Jx,
  } = Ph,
  { locStart: Xx, locEnd: Yx } = Cl,
  { printClass: Kx } = PF,
  {
    printOpaqueType: Qx,
    printTypeAlias: Zx,
    printIntersectionType: eS,
    printUnionType: tS,
    printFunctionType: nS,
    printTupleType: rS,
    printIndexedAccessType: iS,
  } = kv,
  { printInterface: uS } = UF,
  { printTypeParameter: oS, printTypeParameters: sS } = Xv,
  { printExportDeclaration: aS, printExportAllDeclaration: lS } = fx,
  { printArrayItems: cS } = LE,
  { printObject: pS } = Lx,
  { printPropertyKey: fS } = sA,
  { printOptionalToken: dS, printTypeAnnotation: hS, printRestSpread: gS } = dE
function mS(e, t) {
  const n = Ux(e)
  return n
    ? (nf.strictEqual(n.type, 'DeclareExportDeclaration'), t)
    : ['declare ', t]
}
var yS = {
  printFlow: function (e, t, n) {
    ...
    switch (r.type) {
      ...
      case 'DeclareModule':
        return mS(e, ['module ', n('id'), ' ', n('body')])
      case 'DeclareModuleExports':
        return mS(e, ['module.exports', ': ', n('typeAnnotation'), i])
      case 'DeclareVariable':
        return mS(e, ['var ', n('id'), i])
      case 'DeclareOpaqueType':
        return mS(e, Qx(e, t, n))
      case 'DeclareInterface':
        return mS(e, uS(e, t, n))
      case 'DeclareTypeAlias':
        return mS(e, Zx(e, t, n))
      case 'DeclareExportDeclaration':
        return mS(e, aS(e, t, n))
      case 'DeclareExportAllDeclaration':
        return mS(e, lS(e, t, n))
      case 'OpaqueType':
        return Qx(e, t, n)
      case 'TypeAlias':
        return Zx(e, t, n)
      ...
      case 'GenericTypeAnnotation':
        return [n('id'), sS(e, t, n, 'typeParameters')]
          ...
          const i =
            r.members.length > 0
              ? [
                  $x,
                  cS(e, t, 'members', n),
                  r.hasUnknownMembers || Jx(t) ? ',' : '',
                ]
              : []
          u.push(
            qx([
              '{',
              Wx([...i, ...(r.hasUnknownMembers ? [$x, '...'] : [])]),
              _x(e, t, !0),
              $x,
              '}',
            ])
          )
        } else u.push(qx(['{', _x(e, t), Vx, '}']))
        return u
      ...
      case 'FunctionTypeParam': {
        const t = r.name
          ...
          ? 'this'
          : ''
        return [t, dS(e), t ? ': ' : '', n('typeAnnotation')]
      }
      ...
      case 'Variance': {
        const { kind: e } = r
        return nf.ok('plus' === e || 'minus' === e), 'plus' === e ? '+' : '-'
      }
      ...
      case 'NumberLiteralTypeAnnotation':
        nf.strictEqual(typeof r.value, 'number')
      case 'BigIntLiteralTypeAnnotation':
        return r.extra ? Rx(r.extra.raw) : Rx(r.raw)
      case 'TypeCastExpression':
        return ['(', n('expression'), hS(e, t, n), ')']
      case 'TypeParameterDeclaration':
      case 'TypeParameterInstantiation': {
        const i = sS(e, t, n, 'params')
        if ('flow' === t.parser) {
          const e = Xx(r),
            n = Yx(r),
...
const { hasNewlineInRange: DS } = Jr,
  {
    isJsxNode: ES,
    isBlockComment: bS,
    getComments: CS,
    isCallExpression: vS,
    isMemberExpression: AS,
  } = Ph,
  { locStart: FS, locEnd: xS } = Cl,
  {
    builders: {
      line: SS,
      softline: wS,
...
function IS(e, t, n) {
  const r = e.getValue(),
    ...
    o = e.getParentNode(),
    s = i ? n('test') : [n('checkType'), ' ', 'extends', ' ', n('extendsType')]
  return o.type === r.type && o[u] === r ? kS(2, s) : s
}
const jS = new Map([
    ...
    if (
      ...
      c.push(
        f.type !== r.type || f[o] === r || d
          ...
          : t.useTabs
          ? PS(BS(e))
          : kS(Math.max(0, t.tabWidth - 2), e)
      )
    }
    const b = [...s.map((e) => CS(r[e])), CS(a), CS(l)]
        .flat()
        .some((e) => bS(e) && DS(t.originalText, FS(e), xS(e))),
      C =
        !p &&
        (AS(f) || ('NGPipeExpression' === f.type && f.left === r)) &&
        !f.computed,
      v = (function (e) {
        const t = e.getValue()
        ...
        return r !== t && n[jS.get(n.type)] === r
      })(e),
      A =
        ((F = [IS(e, 0, n), m ? c : BS(c), i && C && !v ? wS : '']),
        f === D ? TS(F, { shouldBreak: b }) : b ? [F, OS] : F)
    var F
    return d || v ? TS([BS([wS, A]), wS]) : A
  },
}
const {
    builders: { hardline: _S },
  } = ki,
  {
    getLeftSidePathName: MS,
    hasNakedLeftSide: RS,
    isJsxNode: $S,
    isTheOnlyJsxElementInMarkdown: VS,
    hasComment: qS,
    CommentCheckFlags: WS,
    isNextLineEmpty: US,
  } = Ph,
  { shouldPrintParamsWithoutParens: zS } = JA
function GS(e, t, n, r) {
  const i = e.getValue(),
    u = [],
    o = 'ClassBody' === i.type,
  ...
  return (
    e.each((e, r, i) => {
      ...
      !(function (e, t) {
        ...
        return e.call((e) => HS(e, t), 'expression')
      })(e, t)
        ? u.push(l)
        : qS(a, WS.Leading)
        ...
        !t.semi &&
          ...
          u.push(';'),
        a !== s && (u.push(_S), US(a, t) && u.push(_S))
    }, r),
    u
  )
}
function HS(e, t) {
  ...
  return !!Ly(e, t) || (!!RS(n) && e.call((e) => HS(e, t), ...MS(e, n)))
}
const JS = ({ type: e }) =>
  'ClassProperty' === e ||
...
var XS = {
  printBody: function (e, t, n) {
    return GS(e, t, n, 'body')
  },
  printSwitchCaseConsequent: function (e, t, n) {
    return GS(e, t, n, 'consequent')
  },
}
const { printDanglingComments: YS } = Bf,
  { isNonEmptyArray: KS } = Jr,
  {
    builders: { hardline: QS, indent: ZS },
  } = ki,
  { hasComment: ew, CommentCheckFlags: tw, isNextLineEmpty: nw } = Ph,
  { printHardlineAfterHeritage: rw } = PF,
  { printBody: iw } = XS
function uw(e, t, n) {
  const r = e.getValue(),
    i = KS(r.directives),
  ...
  if (
    (i &&
      e.each((e, r, i) => {
        s.push(n()),
          (r < i.length - 1 || u || o) &&
            (s.push(QS), nw(e.getValue(), t) && s.push(QS))
      }, 'directives'),
    u && s.push(iw(e, t, n)),
    o && s.push(YS(e, t, !0)),
    'Program' === r.type)
    ...
    const t = e.getParentNode()
    ;(t && 'ModuleExpression' === t.type) || s.push(QS)
  }
  return s
}
var ow = {
...
const { printDanglingComments: sw } = Bf,
  { hasNewlineInRange: aw } = Jr,
  {
    builders: {
      join: lw,
      line: cw,
  ...
  {
    isLiteral: yw,
    getTypeScriptMappedTypeModifier: Dw,
    shouldPrintComma: Ew,
    isCallExpression: bw,
    isMemberExpression: Cw,
  } = Ph,
  { locStart: vw, locEnd: Aw } = Cl,
  { printOptionalToken: Fw, printTypeScriptModifiers: xw } = dE,
  { printTernary: Sw } = LS,
  { printFunctionParameters: ww, shouldGroupFunctionParameters: Tw } = av,
  { printTemplateLiteral: Bw } = Kh,
  { printArrayItems: kw } = LE,
  { printObject: Nw } = Lx,
  { printClassProperty: Pw, printClassMethod: Ow } = PF,
  { printTypeParameter: Iw, printTypeParameters: jw } = Xv,
  { printPropertyKey: Lw } = sA,
  { printFunction: _w, printMethodInternal: Mw } = JA,
  { printInterface: Rw } = UF,
  { printBlock: $w } = ow,
  {
    printTypeAlias: Vw,
    printIntersectionType: qw,
    printUnionType: Ww,
    printFunctionType: Uw,
    printTupleType: zw,
    printIndexedAccessType: Gw,
  } = kv
var Hw = {
    ...
    switch (r.type) {
      ...
      case 'TSTypeAssertion': {
        const e = !(
          ...
          t = dw(['<', hw([fw, n('typeAnnotation')]), fw, '>']),
          i = [mw('('), hw([fw, n('expression')]), fw, mw(')')]
        return e
          ? gw([
              [t, n('expression')],
              [t, dw(i, { shouldBreak: !0 })],
              [t, n('expression')],
            ])
          : dw([t, n('expression')])
      }
      ...
      case 'TSTypeParameterInstantiation':
        return jw(e, t, n, 'params')
      case 'TSTypeParameter':
        return Iw(e, t, n)
      case 'TSAsExpression': {
        u.push(n('expression'), ' as ', n('typeAnnotation'))
        const t = e.getParentNode()
        return (bw(t) && t.callee === r) || (Cw(t) && t.object === r)
          ? dw([hw([fw, ...u]), fw])
          : u
      }
      case 'TSArrayType':
      ...
      case 'TSIndexSignature': {
        const u = e.getParentNode(),
          o = r.parameters.length > 1 ? mw(Ew(t) ? ',' : '') : '',
          s = dw([hw([fw, lw([', ', fw], e.map(n, 'parameters'))]), o, fw])
        return [
          r.export ? 'export ' : '',
      ...
      case 'TSConstructorType':
        if (
          ('TSConstructorType' === r.type && r.abstract && u.push('abstract '),
          'TSCallSignatureDeclaration' !== r.type && u.push('new '),
          u.push(dw(ww(e, n, t, !1, !0))),
      ...
      case 'TSMappedType': {
        const u = aw(t.originalText, vw(r), Aw(r))
        return dw(
          [
            '{',
            hw([
              t.bracketSpacing ? cw : fw,
              r.readonly ? [Dw(r.readonly, 'readonly'), ' '] : '',
              xw(e, t, n),
              n('typeParameter'),
              r.optional ? Dw(r.optional, '?') : '',
              r.typeAnnotation ? ': ' : '',
              n('typeAnnotation'),
              mw(i),
            ]),
      ...
      case 'TSMethodSignature': {
        ...
        const o = ww(e, n, t, !1, !0),
          s = r.returnType ? 'returnType' : 'typeAnnotation',
          a = r[s],
          l = a ? n(s) : '',
          c = Tw(r, l)
        return u.push(c ? dw(o) : o), a && u.push(': ', dw(l)), dw(u)
      }
      case 'TSNamespaceExportDeclaration':
        return (
          u.push('export as namespace ', n('id')), t.semi && u.push(';'), dw(u)
        )
        ...
        return (
          ...
          0 === r.members.length
            ...
            : u.push(
                dw([
                  '{',
                  hw([pw, kw(e, t, 'members', n), Ew(t, 'es5') ? ',' : '']),
                  sw(e, t, !0),
                  pw,
                  '}',
                ])
      ...
      case 'TSImportEqualsDeclaration':
        return (
          ...
          u.push('import '),
          r.importKind && 'value' !== r.importKind && u.push(r.importKind, ' '),
      ...
      case 'TSModuleDeclaration': {
        const o = e.getParentNode(),
          ...
          l = r.body && 'TSModuleDeclaration' === r.body.type
        if (a) u.push('.')
        else {
          r.declare && u.push('declare '), u.push(xw(e, t, n))
          const i = t.originalText.slice(vw(r), vw(r.id))
          ;('Identifier' === r.id.type &&
            'global' === r.id.name &&
            !/namespace|module/.test(i)) ||
            u.push(s || /(^|\s)module(\s|$)/.test(i) ? 'module ' : 'namespace ')
        }
        return (
          u.push(n('id')),
          l
      ...
      case 'TSTypeReference':
        return [n('typeName'), jw(e, t, n, 'typeParameters')]
...
const { hasNewline: Jw } = Jr,
  {
    builders: { join: Xw, hardline: Yw },
    utils: { replaceNewlinesWithLiterallines: Kw },
  } = ki,
  { isLineComment: Qw, isBlockComment: Zw } = Ph,
  { locStart: eT, locEnd: tT } = Cl
var nT = {
  printComment: function (e, t) {
    const n = e.getValue()
    if (Qw(n)) return t.originalText.slice(eT(n), tT(n)).trimEnd()
    if (Zw(n)) {
      if (
        (function (e) {
        ...
        return n.trailing && !Jw(t.originalText, eT(n), { backwards: !0 })
          ? [Yw, e]
          : e
      }
      const e = tT(n),
...
const { printString: rT, printNumber: iT } = Jr
function uT(e) {
  return e.toLowerCase()
}
function oT({ pattern: e, flags: t }) {
  return `/${e}/${(t = t.split('').sort().join(''))}`
}
var sT = {
  printLiteral: function (e, t) {
    ...
    switch (n.type) {
      case 'RegExpLiteral':
        return oT(n)
      case 'BigIntLiteral':
        return uT(n.bigint || n.extra.raw)
      case 'NumericLiteral':
        return iT(n.extra.raw)
      case 'StringLiteral':
        return rT(n.extra.raw, t)
      case 'NullLiteral':
        return 'null'
      case 'BooleanLiteral':
      ...
      case 'DecimalLiteral':
        return iT(n.value) + 'm'
      case 'Literal': {
        if (n.regex) return oT(n.regex)
        if (n.bigint) return uT(n.raw)
        if (n.decimal) return iT(n.decimal) + 'm'
        const { value: e } = n
        return 'number' == typeof e
          ? iT(n.raw)
          : 'string' == typeof e
...
const { printDanglingComments: aT } = Bf,
  { hasNewline: lT } = Jr,
  {
    builders: {
      join: cT,
    ...
    utils: { replaceNewlinesWithLiterallines: mT },
  } = ki,
  { insertPragma: yT } = ym,
  {
    hasFlowShorthandAnnotationComment: DT,
    hasComment: ET,
    CommentCheckFlags: bT,
    isTheOnlyJsxElementInMarkdown: CT,
    isBlockComment: vT,
    isLineComment: AT,
    isNextLineEmpty: FT,
    ...
    hasIgnoreComment: wT,
    isCallExpression: TT,
    isMemberExpression: BT,
  } = Ph,
  { locStart: kT, locEnd: NT } = Cl,
  { printHtmlBinding: PT, isVueEventBindingExpression: OT } = Wy,
  { printAngular: IT } = FD,
  { printJsx: jT, hasJsxIgnoreComment: LT } = oE,
  { printFlow: _T } = yS,
  { printTypescript: MT } = Hw,
  {
    printOptionalToken: RT,
    printBindExpressionCallee: $T,
    printTypeAnnotation: VT,
    adjustClause: qT,
    printRestSpread: WT,
  } = dE,
  {
    printImportDeclaration: UT,
    printExportDeclaration: zT,
    printExportAllDeclaration: GT,
    printModuleSpecifier: HT,
  } = fx,
  { printTernary: JT } = LS,
  { printTemplateLiteral: XT } = Kh,
  { printArray: YT } = LE,
  { printObject: KT } = Lx,
  { printClass: QT, printClassMethod: ZT, printClassProperty: eB } = PF,
  { printProperty: tB } = sA,
  {
    printFunction: nB,
    printArrowFunction: rB,
    printMethod: iB,
    printReturnStatement: uB,
    printThrowStatement: oB,
  } = JA,
  { printCallExpression: sB } = aC,
  { printVariableDeclarator: aB, printAssignmentExpression: lB } = LC,
  { printBinaryishExpression: cB } = gD,
  { printSwitchCaseConsequent: pB } = XS,
  { printMemberExpression: fB } = Cb,
  { printBlock: dB, printBlockBody: hB } = ow,
  { printComment: gB } = nT,
  { printLiteral: mB } = sT,
  { printDecorators: yB } = sF
function DB(e, t) {
  const n = ST(e),
    r = n.slice(1, -1)
...
var EB = {
  ...
  print: function (e, t, n, r) {
    const i = (function (e, t, n, r) {
      ...
      for (const r of [mB, PT, IT, jT, _T, MT]) {
        const i = r(e, t, n)
      ...
      switch (i.type) {
        ...
        case 'EmptyStatement':
          return ''
        case 'ExpressionStatement':
          if (i.directive) return [DB(i.expression, t), u]
          if ('__vue_event_binding' === t.parser) {
            const t = e.getParentNode()
            if ('Program' === t.type && 1 === t.body.length && t.body[0] === i)
              return [n('expression'), OT(i.expression) ? ';' : '']
          }
          return [n('expression'), CT(t, e) ? '' : u]
        case 'ParenthesizedExpression':
          return !ET(i.expression) &&
            ('ObjectExpression' === i.expression.type ||
              'ArrayExpression' === i.expression.type)
            ? ['(', n('expression'), ')']
            : hT(['(', gT([dT, n('expression')]), dT, ')'])
        case 'AssignmentExpression':
          return lB(e, t, n)
        ...
        case 'BindExpression':
          return (
            ...
            o.push(hT(gT([dT, $T(e, t, n)]))),
            o
          )
        case 'Identifier':
          return [i.name, RT(e), VT(e, t, n)]
        ...
        case 'AwaitExpression':
          if ((o.push('await'), i.argument)) {
            o.push(' ', n('argument'))
            const t = e.getParentNode()
            if ((TT(t) && t.callee === i) || (BT(t) && t.object === i)) {
              o = [gT([dT, ...o]), dT]
              const t = e.findAncestor(
                (e) =>
                  'AwaitExpression' === e.type || 'BlockStatement' === e.type
              )
              if (!t || 'AwaitExpression' !== t.type) return hT(o)
            }
          }
          return o
        case 'ExportDefaultDeclaration':
        ...
        case 'SequenceExpression': {
          ...
          if ('ExpressionStatement' === t.type || 'ForStatement' === t.type) {
            ...
            return (
              e.each((e, r) => {
                0 === r ? t.push(n()) : t.push(',', gT([pT, n()]))
              }, 'expressions'),
              hT(t)
            )
          }
          return hT(cT([',', pT], e.map(n, 'expressions')))
        }
        case 'ThisExpression':
          return 'this'
        case 'Super':
        ...
        case 'VariableDeclaration': {
          ...
          let l
          return (
            1 !== t.length || ET(i.declarations[0])
              ? t.length > 0 && (l = gT(t[0]))
              : (l = t[0]),
            (o = [
              i.declare ? 'declare ' : '',
              i.kind,
              l ? [' ', l] : '',
              gT(t.slice(1).map((e) => [',', a && !s ? fT : pT, e])),
            ]),
            (s && r.body !== i) || o.push(u),
            hT(o)
          )
        ...
        case 'WithStatement':
          return hT(['with (', n('object'), ')', qT(i.body, n('body'))])
        case 'IfStatement': {
          const r = qT(i.consequent, n('consequent')),
            u = hT(['if (', hT([gT([dT, n('test')]), dT]), ')', r])
          if ((o.push(u), i.alternate)) {
            const r = ET(i.consequent, bT.Trailing | bT.Line) || xT(i),
              u = 'BlockStatement' === i.consequent.type && !r
            o.push(u ? ' ' : fT),
              ET(i, bT.Dangling) && o.push(aT(e, t, !0), r ? fT : ' '),
              o.push(
                'else',
                hT(
                  qT(
        ...
        case 'DoWhileStatement': {
          const e = qT(i.body, n('body'))
          return (
            (o = [hT(['do', e])]),
            'BlockStatement' === i.body.type ? o.push(' ') : o.push(fT),
            o.push('while (', hT([gT([dT, n('test')]), dT]), ')', u),
            o
          )
        }
        case 'DoExpression':
        ...
        case 'ContinueStatement':
          return (
            o.push('continue'), i.label && o.push(' ', n('label')), o.push(u), o
          )
        case 'LabeledStatement':
        ...
        case 'CatchClause':
          if (i.param) {
            const e = ET(
                ...
                (e) =>
                  !vT(e) ||
                  (e.leading && lT(t.originalText, NT(e))) ||
                  (e.trailing &&
                    lT(t.originalText, kT(e), {
                      backwards: !0,
                    }))
              ),
              r = n('param')
        ...
        case 'SwitchStatement':
          return [
            hT(['switch (', gT([dT, n('discriminant')]), dT, ')']),
            ' {',
            i.cases.length > 0
              ? gT([
                  fT,
                  cT(
                    ...
                    e.map((e, r, i) => {
                      const u = e.getValue()
                      return [n(), r !== i.length - 1 && FT(u, t) ? fT : '']
                    }, 'cases')
                  ),
                ])
              : '',
        ...
        case 'InterpreterDirective':
          return o.push('#!', i.value, fT), FT(i, t) && o.push(fT), o
        ...
        case 'ModuleExpression': {
          o.push('module {')
          const e = n('body')
          return e && o.push(gT([fT, e]), fT), o.push('}'), o
        }
        default:
    ...
    const s = yB(e, t, n)
    if (s) return hT([...s, i])
    if (!Ly(e, t)) return r && r.needsSemi ? [';', i] : i
  ...
  insertPragma: yT,
  massageAstNode: qg,
  hasPrettierIgnore: (e) => wT(e) || LT(e),
  willPrintOwnComments: by.willPrintOwnComments,
  ...
  handleComments: {
    avoidAstMutation: !0,
    ownLine: by.handleOwnLineComment,
    endOfLine: by.handleEndOfLineComment,
    remaining: by.handleRemainingComment,
  },
  getCommentChildNodes: by.getCommentChildNodes,
}
const {
  builders: { hardline: bB, indent: CB, join: vB },
} = ki
const AB = new Set([
  'start',
  'end',
  ...
  print: function (e, t, n) {
    ...
    switch (r.type) {
      ...
      case 'ArrayExpression': {
        ...
        return ['[', CB([bB, vB([',', bB], t)]), bB, ']']
      }
      case 'ObjectExpression':
        return 0 === r.properties.length
          ? '{}'
          : ['{', CB([bB, vB([',', bB], e.map(n, 'properties'))]), bB, '}']
      case 'ObjectProperty':
        return [n('key'), ': ', n('value')]
      case 'UnaryExpression':
...
var wB = {
    ...
    bracketSpacing: SB.bracketSpacing,
    jsxBracketSameLine: {
      since: '0.17.0',
      category: 'JavaScript',
      type: 'boolean',
...
var IB = {
  ...
  options: wB,
  printers: { estree: EB, 'estree-json': xB },
  parsers: {
    get babel() {
      return (() => {})('./parser-babel').parsers.babel
    },
    get 'babel-flow'() {
      return (() => {})('./parser-babel').parsers['babel-flow']
    },
    get 'babel-ts'() {
      return (() => {})('./parser-babel').parsers['babel-ts']
    },
    get json() {
      return (() => {})('./parser-babel').parsers.json
    },
    get json5() {
      return (() => {})('./parser-babel').parsers.json5
    },
    get 'json-stringify'() {
      return (() => {})('./parser-babel').parsers['json-stringify']
    },
    get __js_expression() {
      return (() => {})('./parser-babel').parsers.__js_expression
    },
    get __vue_expression() {
      return (() => {})('./parser-babel').parsers.__vue_expression
    },
    get __vue_event_binding() {
      return (() => {})('./parser-babel').parsers.__vue_event_binding
    },
    get flow() {
      return (() => {})('./parser-flow').parsers.flow
    },
    get typescript() {
      return (() => {})('./parser-typescript').parsers.typescript
    },
    get __ng_action() {
      return (() => {})('./parser-angular').parsers.__ng_action
    },
    get __ng_binding() {
      return (() => {})('./parser-angular').parsers.__ng_binding
    },
    get __ng_interpolation() {
      return (() => {})('./parser-angular').parsers.__ng_interpolation
    },
    get __ng_directive() {
      return (() => {})('./parser-angular').parsers.__ng_directive
    },
    get espree() {
      return (() => {})('./parser-espree').parsers.espree
    },
    get meriyah() {
      return (() => {})('./parser-meriyah').parsers.meriyah
    },
    get __babel_estree() {
      return (() => {})('./parser-babel').parsers.__babel_estree
    },
  },
}
const { isFrontMatterNode: jB } = Jr,
  LB = new Set([
    'raw',
    'raws',
    'sourceIndex',
...
function _B(e, t, n) {
  if (
    (jB(e) && 'yaml' === e.lang && delete t.value,
    'css-comment' === e.type && 'css-root' === n.type && n.nodes.length > 0)
  ) {
    if (
      (n.nodes[0] === e || (jB(n.nodes[0]) && n.nodes[1] === e)) &&
      (delete t.text, /^\*\s*@(format|prettier)\s*$/.test(e.text))
    )
      return null
    if ('css-root' === n.type && Be(n.nodes) === e) return null
  }
  if (
    ...
    ('media-feature' !== e.type &&
      ...
      'value-string' !== e.type) ||
      !t.value ||
      (t.value = t.value.replace(/'/g, '"').replace(/\\([^\dA-Fa-f])/g, '$1')),
    'selector-attribute' === e.type &&
...
_B.ignoredProperties = LB
var MB = _B
const {
  builders: { hardline: RB, markAsRoot: $B },
} = ki
var VB = function (e, t) {
  if ('yaml' === e.lang) {
    const n = e.value.trim(),
      r = n ? t(n, { parser: 'yaml' }, { stripTrailingHardline: !0 }) : ''
    return $B([e.startDelimiter, RB, r, r ? RB : '', e.endDelimiter])
  }
}
const {
  builders: { hardline: qB },
} = ki
var WB = function (e, t, n) {
  const r = e.getValue()
...
var GB = {
  hasPragma: function (e) {
    return ym.hasPragma(zB(e).content)
  },
  insertPragma: function (e) {
    const { frontMatter: t, content: n } = zB(e)
    return (t ? t.raw + '\n\n' : '') + ym.insertPragma(n)
  },
}
const { isNonEmptyArray: HB } = Jr,
  JB = new Set([
    'red',
    'green',
    'blue',
...
function rk(e) {
  return (
    'value-paren_group' === e.type && e.groups && e.groups[0] && nk(e.groups[0])
  )
}
function ik(e) {
...
var uk = {
    getAncestorCounter: XB,
    getAncestorNode: YB,
    getPropOfDeclNode: function (e) {
      const t = YB(e, 'css-decl')
    ...
    isMultiplicationNode: KB,
    isDivisionNode: QB,
    isAdditionNode: ZB,
    isSubtractionNode: ek,
    isModuloNode: tk,
    isMathOperatorNode: function (e) {
      return KB(e) || QB(e) || ZB(e) || ek(e) || tk(e)
    },
    ...
    isForKeywordNode: function (e) {
      return (
        'value-word' === e.type && ['from', 'through', 'end'].includes(e.value)
      )
    },
    ...
    isKeyValuePairNode: nk,
    isKeyValuePairInParenGroupNode: rk,
    ...
    isSCSSMapItemNode: function (e) {
      ...
      if (!(rk(t) || (n && rk(n)))) return !1
      const r = YB(e, 'css-decl')
      return (
    ...
    isColorAdjusterFuncNode: function (e) {
      return 'value-func' === e.type && JB.has(e.value.toLowerCase())
    },
...
const { getLast: sk, skipEverythingButNewLine: ak } = Jr
function lk(e, t) {
  return 'number' == typeof e.sourceIndex
    ? e.sourceIndex
    : e.source
    ? ok(e.source.start, t) - 1
    : null
}
function ck(e, t) {
  if ('css-comment' === e.type && e.inline) return ak(t, e.source.startOffset)
  const n = e.nodes && sk(e.nodes)
  return (
    n && e.source && !e.source.end && (e = n),
    e.source && e.source.end ? ok(e.source.end, t) : null
  )
}
function pk(e, t, n) {
  e.source &&
    ((e.source.startOffset = lk(e, n) + t), (e.source.endOffset = ck(e, n) + t))
  for (const r in e) {
    const i = e[r]
    'source' !== r && i && 'object' == typeof i && pk(i, t, n)
  }
}
function fk(e) {
  ...
  return (
    ...
    'css-atrule' === e.type &&
      ...
      (t += 1 + e.name.length + e.raws.afterName.match(/^\s*:?\s*/)[0].length),
    'css-atrule' !== e.type &&
      e.raws &&
...
var dk = {
  ...
  calculateLoc: function e(t, n) {
    t.source &&
      ((t.source.startOffset = lk(t, n)), (t.source.endOffset = ck(t, n)))
    for (const r in t) {
      const i = t[r]
      'source' !== r &&
        i &&
...
const {
  ...
  } = Jr,
  {
    ...
    utils: { removeLines: kk, getDocParts: Nk },
  } = ki,
  { insertPragma: Pk } = GB,
  {
    getAncestorNode: Ok,
    getPropOfDeclNode: Ik,
    maybeToLowerCase: jk,
    insideValueFunctionNode: Lk,
    insideICSSRuleNode: _k,
    insideAtRuleNode: Mk,
    insideURLFunctionInImportAtRuleNode: Rk,
    isKeyframeAtRuleKeywords: $k,
    isWideKeywords: Vk,
    isSCSS: qk,
    isLastNode: Wk,
    isLessParser: Uk,
    isSCSSControlDirectiveNode: zk,
    isDetachedRulesetDeclarationNode: Gk,
    isRelationalOperatorNode: Hk,
    isEqualityOperatorNode: Jk,
    isMultiplicationNode: Xk,
    isDivisionNode: Yk,
    isAdditionNode: Kk,
    isSubtractionNode: Qk,
    isMathOperatorNode: Zk,
    isEachKeywordNode: eN,
    isForKeywordNode: tN,
    isURLFunctionNode: nN,
    isIfElseKeywordNode: rN,
    hasComposesNode: iN,
    hasParensAroundNode: uN,
    hasEmptyRawBefore: oN,
    isKeyValuePairNode: sN,
    isKeyInValuePairNode: aN,
    isDetachedRulesetCallNode: lN,
    isTemplatePlaceholderNode: cN,
    isTemplatePropNode: pN,
    isPostcssSimpleVarNode: fN,
    isSCSSMapItemNode: dN,
    isInlineValueCommentNode: hN,
    isHashNode: gN,
    isLeftCurlyBraceNode: mN,
    isRightCurlyBraceNode: yN,
    isWordNode: DN,
    isColonNode: EN,
    isMediaAndSupportsKeywords: bN,
    isColorAdjusterFuncNode: CN,
    lastLineHasInlineComment: vN,
    isAtWordPlaceholderNode: AN,
  } = uk,
  { locStart: FN, locEnd: xN } = dk
function SN(e) {
  ...
  return (
    e.each((e, i, u) => {
      ...
      if (
        ...
        const n = e.getValue()
        r.push(t.originalText.slice(FN(n), xN(n)))
      } else r.push(n())
      i !== u.length - 1 &&
        (('css-comment' === u[i + 1].type &&
          !mk(t.originalText, FN(u[i + 1]), { backwards: !0 }) &&
          !yk(u[i])) ||
        ('css-atrule' === u[i + 1].type &&
          'else' === u[i + 1].name &&
          'css-comment' !== u[i].type)
          ? r.push(' ')
          : (r.push(t.__isHTMLStyleAttribute ? Ck : vk),
            Dk(t.originalText, e.getValue(), xN) && !yk(u[i]) && r.push(vk)))
    }, 'nodes'),
    r
  )
}
...
function PN(e) {
  return e.replace(BN, (e, t, n, r, i) => (!n && r ? ON(r) + jk(i || '') : e))
}
function ON(e) {
  return hk(e).replace(/\.0(?=$|e)/, '')
}
var IN = {
    print: function (e, t, n) {
      const r = e.getValue()
      ...
      switch (r.type) {
        ...
        case 'css-root': {
          const i = wN(e, t, n),
            u = r.raws.after.trim()
          return [i, u ? ` ${u}` : '', Nk(i).length > 0 ? vk : '']
        }
        case 'css-comment': {
          const e = r.inline || r.raws.inline,
            n = t.originalText.slice(FN(r), xN(r))
            ...
            r.nodes
              ? [
                  ...
                  vN(r.selector.value)
                    ...
                    : ' ',
                  '{',
                  r.nodes.length > 0 ? Sk([vk, wN(e, t, n)]) : '',
                  vk,
                  '}',
                  Gk(r) ? ';' : '',
                ]
        ...
        case 'css-decl': {
          const i = e.getParentNode(),
            ...
            o = u.trim(),
            s = ':' === o
          let a = iN(r) ? kk(n('value')) : n('value')
          return (
            !s && vN(o) && (a = Sk([vk, wk(a)])),
            [
              r.raws.before.replace(/[\s;]/g, ''),
              _k(e) ? r.prop : jk(r.prop),
              o.startsWith('//') ? ' ' : '',
              o,
              r.extend ? '' : ' ',
              Uk(t) && r.extend && r.selector
                ? ['extend(', n('selector'), ')']
                : '',
              a,
              r.raws.important
              ...
              r.nodes
                ...
                : pN(r) &&
                  !i.raws.semicolon &&
                  ';' !== t.originalText[xN(r) - 1]
                ? ''
                : t.__isHTMLStyleAttribute && Wk(e, r)
                ? Tk(';')
                : ';',
            ]
          )
        ...
        case 'css-atrule': {
          const i = e.getParentNode(),
            u = cN(r) && !i.raws.semicolon && ';' !== t.originalText[xN(r) - 1]
          if (Uk(t)) {
            if (r.mixin)
              return [
                n('selector'),
            ...
            if (r.variable)
              return [
                ...
                r.nodes
                  ? [
                      '{',
                      Sk([r.nodes.length > 0 ? Ak : '', wN(e, t, n)]),
                      Ak,
                      '}',
                    ]
                  : '',
          ...
          return [
            '@',
            lN(r) || r.name.endsWith(':') ? r.name : jk(r.name),
            r.params
              ? [
                  lN(r)
                    ? ''
              ...
              : '',
            r.selector ? Sk([' ', n('selector')]) : '',
            r.value
              ? Fk([' ', n('value'), zk(r) ? (uN(r) ? ' ' : Ck) : ''])
              : 'else' === r.name
              ? ' '
              : '',
            r.nodes
        ...
        case 'media-query':
          return [bk(' ', e.map(n, 'nodes')), Wk(e, r) ? '' : ',']
        case 'media-type':
          return PN(kN(r.value, t))
        case 'media-feature-expression':
          return r.nodes ? ['(', ...e.map(n, 'nodes'), ')'] : r.value
        case 'media-feature':
          return jk(kN(r.value.replace(/ +/g, ' '), t))
        case 'media-colon':
          return [r.value, ' ']
        case 'media-value':
          return PN(kN(r.value, t))
        ...
        case 'selector-root':
          return Fk([
            Mk(e, 'custom-selector')
              ? [Ok(e, 'css-atrule').customSelector, Ck]
              : '',
            bk(
              [',', Mk(e, ['extend', 'custom-selector', 'nest']) ? Ck : vk],
              e.map(n, 'nodes')
            ),
          ])
        case 'selector-selector':
          return Fk(Sk(e.map(n, 'nodes')))
        ...
        case 'selector-tag': {
          ...
          return [
            ...
            'selector-nesting' === i.type
              ? r.value
              : PN($k(e, r.value) ? r.value.toLowerCase() : r.value),
          ]
        }
        case 'selector-id':
          return ['#', r.value]
        ...
        case 'selector-attribute':
          return [
            ...
            r.value ? NN(kN(r.value.trim(), t), t) : '',
            r.insensitive ? ' i' : '',
            ']',
          ]
        case 'selector-combinator':
          if (
            ...
            const t = e.getParentNode()
            return [
              'selector-selector' === t.type && t.nodes[0] === r ? '' : Ck,
              r.value,
              Wk(e, r) ? '' : ' ',
            ]
          }
          return [
            r.value.trim().startsWith('(') ? Ck : '',
            PN(kN(r.value.trim(), t)) || Ck,
          ]
        ...
        case 'selector-pseudo':
          return [
            jk(r.value),
            Ek(r.nodes) ? ['(', bk(', ', e.map(n, 'nodes')), ')'] : '',
          ]
        case 'selector-nesting':
          return r.value
        case 'selector-unknown': {
          const n = Ok(e, 'css-rule')
          if (n && n.isSCSSNesterProperty) return PN(kN(jk(r.value), t))
          const i = e.getParentNode()
        ...
        case 'value-root':
          return n('group')
        case 'value-comment':
          return t.originalText.slice(FN(r), xN(r))
        case 'value-comma_group': {
          ...
          for (let n = 0; n < r.groups.length; ++n) {
            ...
            if (!g) continue
            if ('value-word' === l.type && l.value.endsWith('-') && AN(g))
              continue
            const y = 'value-string' === l.type && l.value.startsWith('#{'),
            ...
            if (d) continue
            if (EN(l) || EN(g)) continue
            if ('value-atword' === l.type && '' === l.value) continue
            if ('~' === l.value) continue
            if (
              l.value &&
              l.value.includes('\\') &&
            ...
            if (
              ...
              'value-operator' === l.type &&
              '/' === l.value
            )
              continue
            if ('\\' === l.value) continue
            if (fN(l, g)) continue
            if (gN(l) || mN(l) || yN(g) || (mN(g) && oN(g)) || (yN(l) && oN(g)))
              continue
            if ('--' === l.value && gN(g)) continue
            const E = Zk(l),
              b = Zk(g)
            if (((E && gN(g)) || (b && yN(l))) && oN(g)) continue
            if (!u && Yk(l)) continue
            if (Lk(e, 'calc') && (Kk(l) || Kk(g) || Qk(l) || Qk(g)) && oN(g))
              continue
            const C =
                (Kk(l) || Qk(l)) &&
                0 === n &&
            ...
            if (
              ...
              if (hN(l)) {
                ...
                (a && (Jk(g) || Hk(g) || rN(g) || eN(l) || tN(l))) ||
                (s && 'namespace' === s.name.toLowerCase())
                  ? p.push(' ')
                  : o
                  ? l.source &&
                    g.source &&
                    l.source.start.line !== g.source.start.line
                    ? (p.push(vk), (h = !0))
                    : p.push(' ')
                  : b
                  ? p.push(' ')
          ...
          return (
            l && p.push(Bk),
            h && p.unshift(vk),
            a ? Fk(Sk(p)) : Rk(e) ? Fk(xk(p)) : Fk(Sk(xk(p)))
          )
        }
                  ...
                  bk(
                    ...
                    e.map((e) => {
                      ...
                      if (
                        ...
                        const e = Nk(r.contents.contents)
                        return (e[1] = Fk(e[1])), Fk(wk(r))
                      }
                      return r
                    }, 'groups')
                  ),
                ]),
                Tk(!s && qk(t.parser, t.originalText) && u && SN(t) ? ',' : ''),
                Ak,
                r.close ? n('close') : '',
              ],
              { shouldBreak: u && !a }
        ...
        case 'value-func':
          return [r.value, Mk(e, 'supports') && bN(r) ? ' ' : '', n('group')]
        case 'value-paren':
          return r.value
        case 'value-number':
          return [ON(r.value), jk(r.unit)]
        case 'value-operator':
          return r.value
        case 'value-word':
          return (r.isColor && r.isHex) || Vk(r.value)
            ? r.value.toLowerCase()
            : r.value
        case 'value-colon': {
          const t = e.getParentNode(),
          ...
          return [
            r.value,
            (i && 'string' == typeof i.value && '\\' === Be(i.value)) ||
            Lk(e, 'url')
              ? ''
              : Ck,
          ]
        ...
        case 'value-comma':
          return [r.value, ' ']
        case 'value-string':
          return gk(r.raws.quote + r.value + r.raws.quote, t)
        case 'value-atword':
          return ['@', r.value]
...
var RN = {
  ...
  parsers: {
    get css() {
      return (() => {})('./parser-postcss').parsers.css
    },
    get less() {
      return (() => {})('./parser-postcss').parsers.less
    },
    get scss() {
      return (() => {})('./parser-postcss').parsers.scss
    },
  },
}
var $N = {
...
VN.ignoredProperties = new Set(['loc', 'selfClosing'])
var qN = VN
const WN = new Set([
  'area',
  'base',
...
function UN(e) {
  return zN(e, ['TextNode']) && !/\S/.test(e.chars)
}
function zN(e, t) {
  return e && t.includes(e.type)
}
function GN(e, t) {
  return zN(e.getParentNode(0), t)
}
function HN(e, t) {
  const n = e.getValue(),
    r = e.getParentNode(0) || {},
...
var KN = {
  ...
  isLastNodeOfSiblings: function (e) {
    const t = e.getValue(),
      n = e.getParentNode(0)
    return (
      !(!GN(e, ['ElementNode']) || Be(n.children) !== t) ||
      !(!GN(e, ['Block']) || Be(n.body) !== t)
    )
  },
...
const {
    ...
    utils: { getDocParts: aP, replaceEndOfLineWith: lP },
  } = ki,
  { isNonEmptyArray: cP } = Jr,
  { locStart: pP, locEnd: fP } = $N,
  {
    getNextNode: dP,
    getPreviousNode: hP,
    hasPrettierIgnore: gP,
    isLastNodeOfSiblings: mP,
    isNextNodeOfSomeType: yP,
    isNodeOfSomeType: DP,
    isParentOfSomeType: EP,
    isPreviousNodeOfSomeType: bP,
    isVoid: CP,
    isWhitespaceNode: vP,
  } = KN
function AP(e, t) {
...
function FP(e, t, n) {
  const r = e.getValue().children.every((e) => vP(e))
  return 'ignore' === t.htmlWhitespaceSensitivity && r
    ? ''
    : e.map((e, r) => {
        const i = n()
        return 0 === r && 'ignore' === t.htmlWhitespaceSensitivity ? [oP, i] : i
      }, 'children')
}
function xP(e) {
  return CP(e) ? nP([oP, '/>'], [' />', oP]) : nP([oP, '>'], '>')
}
function SP(e) {
...
function kP(e) {
  return [SP(e), e.inverseStrip.open ? '~' : '']
}
function NP(e) {
  const t = wP(e)
...
function PP(e, t) {
  const n = e.getValue(),
    ...
    u = [GP(e, t)],
    o = HP(e, t)
  if ((o && u.push(uP, o), cP(n.program.blockParams))) {
    const e = JP(n.program)
    u.push(uP, e)
  }
  return eP([r, rP(u), oP, i])
}
function OP(e, t) {
  return [
...
function IP(e, t) {
  const n = e.getParentNode(1)
  return [kP(n), 'else if ', HP(e, t), NP(n)]
}
function jP(e, t, n) {
  const r = e.getValue()
  if ('ignore' === n.htmlWhitespaceSensitivity) {
    return [LP(r) ? oP : tP, TP(r), t('path'), BP(r)]
  }
  return [TP(r), t('path'), BP(r)]
}
function LP(e) {
  return DP(e, ['BlockStatement']) && e.program.body.every((e) => vP(e))
}
function _P(e) {
  return DP(e, ['BlockStatement']) && e.inverse
}
function MP(e, t, n) {
  if (LP(e.getValue())) return ''
  const r = t('program')
  return 'ignore' === n.htmlWhitespaceSensitivity ? rP([tP, r]) : rP(r)
}
function RP(e, t, n) {
  const r = e.getValue(),
    i = t('inverse'),
  ...
  return (function (e) {
    return (
      ...
      DP(e.inverse.body[0], ['BlockStatement']) &&
...
function UP(e, t) {
  const n = GP(e, t),
    r = HP(e, t)
  return r ? rP([n, uP, eP(r)]) : n
}
function zP(e, t) {
  const n = GP(e, t),
    r = HP(e, t)
  return r ? [rP([n, uP, r]), oP] : n
}
function GP(e, t) {
  return t('path')
}
...
var XP = {
  print: function (e, t, n) {
    const r = e.getValue()
    if (!r) return ''
    if (gP(e)) return t.originalText.slice(pP(r), fP(r))
    switch (r.type) {
      case 'Block':
      case 'Program':
      case 'Template':
        return eP(e.map(n, 'body'))
      case 'ElementNode': {
        const i = eP(
            (function (e, t) {
              const n = e.getValue(),
                ...
                i = r.flatMap((e) => n[e]).sort(AP)
              for (const n of r)
                e.each((e) => {
                  const n = i.indexOf(e.getValue())
                  i.splice(n, 1, [uP, t()])
                }, n)
              cP(n.blockParams) && i.push(uP, JP(n))
              return ['<', n.tag, rP(i), xP(n)]
            })(e, n)
          ),
          u =
            'ignore' === t.htmlWhitespaceSensitivity && yP(e, ['ElementNode'])
              ? oP
              : ''
        if (CP(r)) return [i, u]
        const o = ['</', r.tag, '>']
        return 0 === r.children.length
          ...
          ? [i, rP(FP(e, t, n)), tP, rP(o), u]
          : [i, rP(eP(FP(e, t, n))), rP(o), u]
      }
      case 'BlockStatement': {
        ...
        return i &&
          ...
          ? [IP(e, n), MP(e, n, t), RP(e, n, t)]
          : [PP(e, n), eP([MP(e, n, t), RP(e, n, t), jP(e, n, t)])]
      }
      case 'ElementModifierStatement':
        return eP(['{{', zP(e, n), '}}'])
      case 'MustacheStatement':
        return eP([SP(r), zP(e, n), wP(r)])
      case 'SubExpression':
        return eP(['(', UP(e, n), oP, ')'])
      case 'AttrNode': {
        const e = 'TextNode' === r.value.type
        if (e && '' === r.value.chars && pP(r.value) === fP(r.value))
          return r.name
        const i = e
            ? WP(t, r.value.chars).quote
            ...
            : '',
          u = n('value')
        return [r.name, '=', i, 'class' === r.name && i ? eP(rP(u)) : u, i]
      }
      case 'ConcatStatement':
        return e.map(n, 'parts')
      case 'Hash':
        return iP(uP, e.map(n, 'pairs'))
      case 'HashPair':
      ...
      case 'TextNode': {
        ...
        if (i) {
          if ('class' === i) {
            ...
            let r = !1,
              i = !1
            return (
              EP(e, ['ConcatStatement']) &&
                (bP(e, ['MustacheStatement']) && /^\s/.test(n) && (r = !0),
                yP(e, ['MustacheStatement']) &&
                  /\s$/.test(n) &&
                  '' !== t &&
                  (i = !0)),
              [r ? uP : '', t, i ? uP : '']
        ...
        if ('ignore' !== t.htmlWhitespaceSensitivity) {
          ...
          if (u) {
            ...
            let t = [uP]
            const r = VP(n)
            return r && (t = qP(r)), mP(e) && (t = t.map((e) => QN(e))), t
          }
          const [l] = n.match(t),
            [c] = n.match(r)
          let p = []
        ...
        if ((o || s) && u && EP(e, ['Block', 'ElementNode', 'Template']))
          return ''
        u && a
          ? ((l = Math.min(a, 2)), (c = 0))
          : (yP(e, ['BlockStatement', 'ElementNode']) && (c = Math.max(c, 1)),
            bP(e, ['BlockStatement', 'ElementNode']) && (l = Math.max(l, 1)))
        let p = '',
          f = ''
        return (
          0 === c && yP(e, ['MustacheStatement']) && (f = ' '),
          0 === l && bP(e, ['MustacheStatement']) && (p = ' '),
          o && ((l = 0), (p = '')),
          s && ((c = 0), (f = '')),
          (n = n.replace(/^[\t\n\f\r ]+/g, p).replace(/[\t\n\f\r ]+$/, f)),
          [...qP(l), ZN($P(n)), ...qP(c)]
...
var YP = {
  ...
  parsers: {
    get glimmer() {
      return (() => {})('./parser-glimmer').parsers.glimmer
    },
  },
}
var KP = {
...
const {
  ...
  { isNextLineEmpty: oO, isNonEmptyArray: sO } = Jr,
  { insertPragma: aO } = KP,
  { locStart: lO, locEnd: cO } = QP
function pO(e, t, n) {
  if (0 === n.directives.length) return ''
  const r = ZP(tO, e.map(t, 'directives'))
...
function fO(e, t, n) {
  ...
  return e.map((e, i) => {
    const u = n()
    return oO(t.originalText, e.getValue(), cO) && i < r - 1 ? [u, eO] : u
  })
}
function dO(e, t, n) {
  const r = e.getNode(),
...
function hO() {}
hO.ignoredProperties = new Set(['loc', 'comments'])
var gO = {
    print: function (e, t, n) {
      const r = e.getValue()
      if (!r) return ''
      ...
      switch (r.kind) {
          ...
          return (
            e.each((e, i, u) => {
              r.push(n()),
                i !== u.length - 1 &&
                  (r.push(eO),
                  oO(t.originalText, e.getValue(), cO) && r.push(eO))
            }, 'definitions'),
            [...r, eO]
          )
        }
        case 'OperationDefinition': {
          ...
          return [
            i ? r.operation : '',
            i && u ? [' ', n('name')] : '',
            i && !u && sO(r.variableDefinitions) ? ' ' : '',
            sO(r.variableDefinitions)
              ? rO([
                  '(',
                  iO([
                    nO,
                    ZP([uO('', ', '), nO], e.map(n, 'variableDefinitions')),
                  ]),
                  nO,
                  ')',
                ])
        ...
        case 'ObjectValue':
          return rO([
            ...
            iO([nO, ZP([uO('', ', '), nO], e.map(n, 'fields'))]),
            nO,
            uO('', t.bracketSpacing && r.fields.length > 0 ? ' ' : ''),
            '}',
          ])
        case 'ObjectField':
        case 'Argument':
        ...
        case 'ObjectTypeDefinition':
          return [
            ...
            'type ',
            n('name'),
            r.interfaces.length > 0 ? [' implements ', ...dO(e, t, n)] : '',
            pO(e, n, r),
            r.fields.length > 0
              ? [
                  ' {',
        ...
        case 'InputValueDefinition':
          return [
            n('description'),
            r.description ? (r.description.block ? eO : tO) : '',
            n('name'),
            ': ',
            n('type'),
            r.defaultValue ? [' = ', n('defaultValue')] : '',
          ...
          return [
            ...
            r.operationTypes.length > 0
              ? iO([
                  ...
                  ZP(
                    eO,
                    e.call((e) => fO(e, t, n), 'operationTypes')
                  ),
                ])
              : '',
            eO,
  ...
  mO = { bracketSpacing: SB.bracketSpacing }
var yO = {
  languages: [
    Ld(
      {
  ...
  parsers: {
    get graphql() {
      return (() => {})('./parser-graphql').parsers.graphql
    },
  },
}
var DO = {
...
const { getLast: EO } = Jr,
  ...
  SO = [...xO, 'tableCell', 'paragraph', 'heading'],
  wO = new RegExp(AO),
  TO = new RegExp(FO)
function BO(e, t) {
  const [, n, r, i] = t
...
var kO = {
          ...
          (e % 2 != 0
            ...
            : '' !== t &&
              s({
                ...
                value: t,
                kind: n,
                hasLeadingPunctuation: TO.test(t[0]),
                hasTrailingPunctuation: TO.test(EO(t)),
              }))
    }
    return u
    function s(e) {
  ...
  getOrderedListItemInfo: BO,
  hasGitDiffFriendlyOrderedList: function (e, t) {
    if (!e.ordered) return !1
    if (e.children.length < 2) return !1
    const n = Number(BO(e.children[0], t.originalText).numberText),
      r = Number(BO(e.children[1], t.originalText).numberText)
    if (0 === n && e.children.length > 2) {
      const n = Number(BO(e.children[2], t.originalText).numberText)
      return 1 === r && 1 === n
    }
    return 1 === r
  },
  INLINE_NODE_TYPES: xO,
  INLINE_NODE_WRAPPER_TYPES: SO,
  isAutolink: function (e) {
    if (!e || 'link' !== e.type || 1 !== e.children.length) return !1
    const t = e.children[0]
    return t && bO(e) === bO(t) && CO(e) === CO(t)
  },
}
const { inferParserByLanguage: NO, getMaxContinuousCount: PO } = Jr,
  {
    builders: { hardline: OO, markAsRoot: IO },
    utils: { replaceNewlinesWithLiterallines: jO },
  } = ki,
  { getFencedCodeBlockValue: LO } = kO
  ...
  if ('code' === i.type && null !== i.lang) {
    ...
    if (e) {
      const t = r.__inJsTemplate ? '~' : '`',
        u = t.repeat(Math.max(3, PO(i.value, t) + 1)),
        o = n(
          LO(i, r.originalText),
          { parser: e },
          { stripTrailingHardline: !0 }
        )
      return IO([u, i.lang, i.meta ? ' ' + i.meta : '', OO, jO(o), OO, u])
    }
  }
  switch (i.type) {
    case 'front-matter':
...
var $O = {
  startWithPragma: RO,
  hasPragma: (e) => RO(zB(e).content.trimStart()),
  insertPragma: (e) => {
    const t = zB(e),
      n = `\x3c!-- @${MO[0]} --\x3e`
...
const { getOrderedListItemInfo: VO, mapAst: qO, splitText: WO } = kO,
  UO = /^.$/su
function zO(e, t, n) {
  return qO(e, (e) => {
      ...
      (e = (function (e, t) {
        ...
        (e = (function (e, t) {
          ...
          function r(e) {
            ...
            if (VO(r, t.originalText).leadingSpaces.length > 1) return !0
            const u = n(r)
            if (-1 === u) return !1
            if (1 === e.children.length) return u % t.tabWidth == 0
            if (u !== n(i)) return !1
            if (u % t.tabWidth == 0) return !0
            return VO(i, t.originalText).leadingSpaces.length > 1
          }
        })(
          (e = (function (e, t) {
            return qO(e, (e, n, r) => {
...
const { isFrontMatterNode: HO } = Jr,
  { startWithPragma: JO } = $O,
  XO = new Set(['position', 'raw'])
function YO(e, t, n) {
  return (
    ('front-matter' !== e.type &&
      'code' !== e.type &&
    ...
    'text' === e.type
      ...
      : ('inlineCode' === e.type &&
        ...
        'root' === n.type &&
        n.children.length > 0 &&
        (n.children[0] === e || (HO(n.children[0]) && n.children[1] === e)) &&
        'html' === e.type &&
        JO(e.value)
          ? null
          : void 0)
...
YO.ignoredProperties = XO
var KO = YO
const {
    getLast: QO,
    getMinNotPresentContinuousCount: ZO,
    getMaxContinuousCount: eI,
    getStringWidth: tI,
    isNonEmptyArray: nI,
  } = Jr,
  {
    builders: {
      ...
      indent: dI,
      group: hI,
      hardlineWithoutBreakParent: gI,
    },
    utils: { normalizeDoc: mI, replaceEndOfLineWith: yI },
    printer: { printDocToString: DI },
  } = ki,
  { insertPragma: EI } = $O,
  { locStart: bI, locEnd: CI } = DO,
  {
    getFencedCodeBlockValue: vI,
    hasGitDiffFriendlyOrderedList: AI,
    splitText: FI,
    punctuationPattern: xI,
    INLINE_NODE_TYPES: SI,
    INLINE_NODE_WRAPPER_TYPES: wI,
    isAutolink: TI,
  } = kO,
  BI = new Set(['importExport']),
  kI = ['heading', 'tableCell', 'link', 'wikiLink'],
  NI = new Set(['listItem', 'definition', 'footnoteDefinition'])
function PI(e, t, n, r) {
  const i = e.getValue(),
...
function LI(e, t, n) {
  ...
  const r = 'always' === n.proseWrap && !jI(e, kI)
  return '' !== t ? (r ? uI : ' ') : r ? lI : ''
}
function _I(e, t, n) {
  const r = []
      ...
      if (!1 !== i) {
        ...
        ;(function (e, t) {
          const n = 0 === t.parts.length,
            r = SI.includes(e.type),
            i = 'html' === e.type && wI.includes(t.parentNode.type)
          return !n && !r && !i
        })(r, e) &&
          (s.push(aI),
          (a && BI.has(a.type)) ||
            (((function (e, t) {
              const n =
                  (t.prevNode && t.prevNode.type) === e.type && NI.has(e.type),
...
function RI(e) {
  let t = e
  for (; nI(t.children); ) t = QO(t.children)
  return t
}
function $I(e) {
...
function WI(e, t, n = !0) {
  ...
  return `${u}${(e = (e = e.replace(/\\/, '\\\\')).replace(
    new RegExp(`(${u})`, 'g'),
    '\\$1'
  ))}${u}`
}
var UI = {
    ...
    print: function (e, t, n) {
      ...
      if (
        (function (e) {
          const t = jI(e, ['linkReference', 'imageReference'])
          return t && ('linkReference' !== t.type || 'full' !== t.referenceType)
        })(e)
      )
        return FI(
          t.originalText.slice(r.position.start.offset, r.position.end.offset),
          t
        ).map((n) =>
          'word' === n.type ? n.value : '' === n.value ? '' : LI(e, n.value, t)
        )
      switch (r.type) {
        case 'front-matter':
        ...
        case 'root':
          return 0 === r.children.length
            ? ''
            : [mI(_I(e, t, n)), BI.has(RI(r).type) ? '' : aI]
        case 'paragraph':
          return MI(e, t, n, { postprocessor: pI })
        case 'sentence':
          return MI(e, t, n)
        case 'word': {
          let t = r.value
          ...
          const n = e.getParentNode(),
            ...
            o =
              u && /^>|^([*+-]|#{1,6}|\d+[).])$/.test(u.value)
                ? 'never'
                : t.proseWrap
          return LI(e, r.value, { proseWrap: o })
        }
        case 'emphasis': {
          let i
          if (TI(r.children[0])) i = t.originalText[r.position.start.offset]
          else {
            const t = e.getParentNode(),
            ...
            i =
              (u &&
                'sentence' === u.type &&
                u.children.length > 0 &&
                'word' === QO(u.children).type &&
                !QO(u.children).hasTrailingPunctuation) ||
              (o &&
                'sentence' === o.type &&
                o.children.length > 0 &&
        ...
        case 'image':
          return ['![', r.alt || '', '](', qI(r.url, ')'), WI(r.title, t), ')']
        case 'blockquote':
          return ['> ', fI('> ', MI(e, t, n))]
        case 'heading':
          return ['#'.repeat(r.depth) + ' ', MI(e, t, n)]
        case 'code': {
          if (r.isIndented) {
            const e = ' '.repeat(4)
            return fI(e, [e, ...yI(r.value, aI)])
          }
          const e = t.__inJsTemplate ? '~' : '`',
            n = e.repeat(Math.max(3, eI(r.value, e) + 1))
          return [
            n,
            r.lang || '',
            r.meta ? ' ' + r.meta : '',
            aI,
            ...yI(vI(r, t.originalText), aI),
            aI,
            n,
          ]
        }
        case 'html': {
          const t = e.getParentNode(),
            n =
              'root' === t.type && QO(t.children) === r
                ? r.value.trimEnd()
                : r.value,
            i = /^<!--.*-->$/s.test(n)
          return yI(n, i ? aI : sI(oI))
        }
        case 'list': {
          const i = OI(r, e.getParentNode()),
            u = AI(r, t)
          return MI(e, t, n, {
            processor: (e, o) => {
              const s = (function () {
              ...
              return 2 === a.children.length &&
                ...
                ? [s, PI(e, t, n, s)]
                : [s, fI(' '.repeat(s.length), PI(e, t, n, s))]
            },
          })
        }
        case 'thematicBreak': {
          const t = II(e, 'list')
          if (-1 === t) return '---'
          return OI(e.getParentNode(t), e.getParentNode(t + 1)) % 2 == 0
            ? '***'
            : '---'
        }
        case 'linkReference':
        ...
        case 'definition': {
          const e = 'always' === t.proseWrap ? uI : ' '
          return hI([
            '[',
            r.identifier,
            ']:',
            dI([e, qI(r.url), null === r.title ? '' : [e, WI(r.title, t, !1)]]),
          ])
        }
        case 'footnote':
          return ['[^', MI(e, t, n), ']']
        ...
        case 'table':
          return (function (e, t, n) {
            const r = e.getValue(),
              ...
              o = a(!1)
            if ('never' !== t.proseWrap) return [rI, o]
            const s = a(!0)
            return [rI, hI(cI(s, o))]
            function a(e) {
              const t = [c(u[0], e), l(e)]
        ...
        case 'break':
          return /\s/.test(t.originalText[r.position.start.offset])
            ...
            : ['\\', aI]
        case 'liquidNode':
          return yI(r.value, aI)
        case 'importExport':
          return [r.value, aI]
        case 'jsx':
          return r.value
        case 'math':
          return ['$$', aI, r.value ? [...yI(r.value, aI), aI] : '', '$$']
        case 'inlineMath':
          return t.originalText.slice(bI(r), CI(r))
        case 'tableRow':
        case 'listItem':
        default:
    ...
    hasPrettierIgnore: function (e) {
      ...
      return 0 !== t && 'next' === $I(e.getParentNode().children[t - 1])
    },
    insertPragma: EI,
  },
  zI = { proseWrap: SB.proseWrap, singleQuote: SB.singleQuote },
  GI = {
    name: 'Markdown',
    type: 'prose',
    color: '#083fa1',
...
var HI = {
  ...
  parsers: {
    get remark() {
      return (() => {})('./parser-markdown').parsers.remark
    },
    get markdown() {
      return (() => {})('./parser-markdown').parsers.remark
    },
    get mdx() {
      return (() => {})('./parser-markdown').parsers.mdx
    },
  },
}
const { isFrontMatterNode: JI } = Jr,
  XI = new Set([
    'sourceSpan',
    'startSourceSpan',
    'endSourceSpan',
...
const { inferParserByLanguage: ZI, isFrontMatterNode: ej } = Jr,
  {
    CSS_DISPLAY_TAGS: tj,
    CSS_DISPLAY_DEFAULT: nj,
    CSS_WHITE_SPACE_TAGS: rj,
    CSS_WHITE_SPACE_DEFAULT: ij,
  } = {
    CSS_DISPLAY_TAGS: {
      area: 'none',
      base: 'none',
...
function pj(e, t) {
  return (
    ...
    !(
      !Aj(e) ||
      !e.children.some((e) => 'text' !== e.type && 'interpolation' !== e.type)
    ) ||
    !(!Bj(e, t) || dj(e) || 'interpolation' === e.type)
  )
}
function fj(e) {
...
function dj(e) {
  return (
    ...
    ('script' === e.fullName ||
      ...
      (Fj(e) && ('script' === e.name || 'style' === e.name)))
  )
}
function hj(e) {
  return xj(e).startsWith('pre')
}
function gj(e) {
  return (
    'element' === e.type &&
...
function mj(e) {
  return bj(e) || ('element' === e.type && 'br' === e.fullName) || yj(e)
}
function yj(e) {
  return Dj(e) && Ej(e)
}
...
function xj(e) {
  return ('element' === e.type && (!e.namespace || Fj(e)) && rj[e.name]) || ij
}
const Sj = new Set(['template', 'style', 'script'])
function wj(e, t) {
  return Tj(e, t) && !Sj.has(e.fullName)
}
function Tj(e, t) {
  return (
    'vue' === t.parser &&
...
function Bj(e, t) {
  return Tj(e, t) && (wj(e, t) || (e.attrMap.lang && 'html' !== e.attrMap.lang))
}
var kj = {
    HTML_ELEMENT_ATTRIBUTES: oj,
    HTML_TAGS: uj,
    ...
    forceBreakContent: function (e) {
      return (
        ...
        (e.firstChild &&
          ...
          Dj(e.firstChild) &&
          (!e.lastChild.isTrailingSpaceSensitive || Ej(e.lastChild)))
      )
    },
    ...
    inferScriptParser: function (e, t) {
      return 'script' !== e.name || e.attrMap.src
        ? 'style' === e.name
          ...
          : t && Bj(e, t)
          ? Cj(e) || (!('src' in e.attrMap) && ZI(e.attrMap.lang, t))
          : void 0
    ...
    isDanglingSpaceSensitiveNode: function (e) {
      return !((t = e.cssDisplay), vj(t) || 'inline-block' === t || dj(e))
      var t
    },
    isIndentationSensitiveNode: hj,
      ...
      const n = (function () {
        ...
        if (
          ...
          ('root' === e.parent.type ||
            ...
            dj(e.parent) ||
            wj(e.parent, t) ||
            ((n = e.parent.cssDisplay), vj(n) || 'inline-block' === n))
        )
          return !1
        var n
        if (
    ...
    isWhitespaceSensitiveNode: function (e) {
      return dj(e) || 'interpolation' === e.type || hj(e)
    },
    isUnknownNamespace: Fj,
    preferHardlineAsLeadingSpaces: function (e) {
      return bj(e) || (e.prev && mj(e.prev)) || yj(e)
    },
    preferHardlineAsTrailingSpaces: mj,
    shouldNotPrintClosingTag: function (e, t) {
      return !e.isSelfClosing && !e.endSourceSpan && (fj(e) || pj(e.parent, t))
    },
    shouldPreserveContent: pj,
...
var Ij = class {
    ...
    get(e, t, n) {
      ...
      return i || ((i = new Pj(e, t, n)), this.cache.set(r, i)), i
    }
  },
  jj = Object.defineProperty(
    { StaticSymbol: Oj, StaticSymbolCache: Ij },
    '__esModule',
    { value: !0 }
  )
/**
...
const Lj = /-+([a-z0-9])/g
var _j = function (e) {
  return e.replace(Lj, (...e) => e[1].toUpperCase())
}
var Mj = function (e, t) {
  return $j(e, ':', t)
}
...
function Vj(e, t, n) {
  return Array.isArray(e)
    ...
    : (function (e) {
        return (
          'object' == typeof e && null !== e && Object.getPrototypeOf(e) === eL
        )
      })(e)
...
var zj = class {
  ...
  Gj = {
    assertSync: (e) => {
      if (iL(e)) throw new Error('Illegal state: value cannot be a promise')
      return e
    },
    then: (e, t) => (iL(e) ? e.then(t) : t(e)),
    all: (e) => (e.some(iL) ? Promise.all(e) : e),
  }
var Hj = function (e) {
...
var Jj = function (e, t) {
  const n = Error(e)
  return (n[Xj] = !0), t && (n[Yj] = t), n
}
const Xj = 'ngSyntaxError',
  Yj = 'ngParseErrors'
var Kj = function (e) {
  return e[Xj]
}
...
const sL = 'undefined' != typeof window && window,
  aL =
    'undefined' != typeof self &&
    'undefined' != typeof WorkerGlobalScope &&
    self instanceof WorkerGlobalScope &&
    self
var lL = (void 0 !== n && n) || sL || aL,
  cL = Object.defineProperty(
    {
      dashCaseToCamelCase: _j,
      splitAtColon: Mj,
      splitAtPeriod: Rj,
      visitValue: qj,
      isDefined: Wj,
  ...
  pL = i(function (e, t) {
    ...
    function u(e) {
      ...
      const t = e.reference
      if (t instanceof jj.StaticSymbol) return t.name
      if (t.__anonymousType) return t.__anonymousType
      let n = cL.stringify(t)
      return (
        n.indexOf('(') >= 0
    ...
    ;(t.identifierName = u),
      (t.identifierModuleUrl = function (e) {
        const t = e.reference
        return t instanceof jj.StaticSymbol
          ? t.filePath
          : `./${cL.stringify(t)}`
      }),
    ...
    t.CompileTemplateMetadata = class {
      constructor({
        ...
        if (
          ...
          (this.animations = s ? l(s) : []),
          (this.ngContentSelectors = c || []),
          p && 2 != p.length)
        )
          throw new Error(
    ...
    t.CompileNgModuleMetadata = class {
      constructor({
        ...
        ;(this.type = e || null),
          ...
          (this.importedModules = a(l)),
          (this.exportedModules = a(c)),
          (this.schemas = a(p)),
          (this.id = d || null),
    ...
    ;(t.ProviderMeta = class {
      ...
      (t.templateSourceUrl = function (e, t, n) {
        ...
        return (
          (r = n.isInline
            ? t.type.reference instanceof jj.StaticSymbol
              ? `${t.type.reference.filePath}.${t.type.reference.name}.html`
              : `${u(e)}/${u(t.type)}.html`
            : n.templateUrl),
          t.type.reference instanceof jj.StaticSymbol ? r : c(r)
        )
      }),
      (t.sharedStylesheetJitUrl = function (e, t) {
        const n = e.moduleUrl.split(/\/\\/g)
        return c(`css/${t}${n[n.length - 1]}.ngstyle.js`)
      }),
      (t.ngModuleJitUrl = function (e) {
        return c(`${u(e.type)}/module.ngfactory.js`)
      }),
      (t.templateJitUrl = function (e, t) {
        return c(`${u(e)}/${u(t.type)}.ngfactory.js`)
      })
  }),
  fL = i(function (e, t) {
    Object.defineProperty(t, '__esModule', { value: !0 })
    ...
    class n {
      ...
      moveBy(e) {
        ...
        for (; i > 0 && e < 0; ) {
          i--, e++
          if (t.charCodeAt(i) == Nj.$LF) {
            u--
            const e = t
              .substr(0, i - 1)
              .lastIndexOf(String.fromCharCode(Nj.$LF))
            o = e > 0 ? i - e : i
          } else o--
        }
        for (; i < r && e > 0; ) {
    ...
    ;(t.ParseError = class {
      ...
      (t.typeSourceSpan = function (e, t) {
        const u = pL.identifierModuleUrl(t),
          o =
            null != u
              ? `in ${e} ${pL.identifierName(t)} in ${u}`
              : `in ${e} ${pL.identifierName(t)}`,
          s = new r('', o)
...
const { ParseSourceSpan: dL } = fL,
  {
    htmlTrim: hL,
    getLeadingAndTrailingHtmlWhitespace: gL,
    hasHtmlWhitespace: mL,
    canHaveInterpolation: yL,
    getNodeCssStyleDisplay: DL,
    isDanglingSpaceSensitiveNode: EL,
    isIndentationSensitiveNode: bL,
    isLeadingSpaceSensitiveNode: CL,
    isTrailingSpaceSensitiveNode: vL,
    isWhitespaceSensitiveNode: AL,
  } = kj,
  FL = [
    function (e) {
      return e.map((e) => {
            ...
            for (let r = 0; r < e.children.length; r++) {
              ...
              if (!n[r + 1])
                if (n[r]) {
                  const e = i.prev,
                    n = i.firstChild,
                    r = new dL(e.sourceSpan.start, n.sourceSpan.end),
                    u = new dL(r.start, i.sourceSpan.end)
                  t.push(
                    i.clone({
              ...
              for (let i = 0; i < e.children.length; i++) {
                ...
                t.push(
                  s.clone({
                    ...
                    sourceSpan: new dL(s.sourceSpan.start, o.sourceSpan.end),
                  })
                )
              }
              return e.clone({ children: t })
                      ...
                      : [
                          {
                            type: 'text',
                            value: r,
                            sourceSpan: new dL(e.moveBy(2), i.moveBy(-2)),
                          },
                        ],
                }))
              : ((i = e.moveBy(r.length)),
    ...
    function (e) {
      return e.map((e) => {
        ...
        if (
          ...
          (1 === e.children.length &&
            'text' === e.children[0].type &&
            0 === hL(e.children[0].value).length)
        )
          return e.clone({
            children: [],
            hasDanglingSpaces: e.children.length > 0,
          })
        const t = AL(e),
          n = bL(e)
        return e.clone({
            ...
            .map((e, t, n) => {
              if (e !== xL)
                return Object.assign(
                  ...
                  {},
                  {
                    hasLeadingSpaces: n[t - 1] === xL,
                    hasTrailingSpaces: n[t + 1] === xL,
                  }
                )
            })
            .filter(Boolean),
    ...
    function (e, t) {
      return e.map((e) => Object.assign(e, { cssDisplay: DL(e, t) }))
    },
    function (e) {
      return e.map((e) =>
        Object.assign(e, {
    ...
    function (e, t) {
      return e.map((e) =>
        e.children
          ? 0 === e.children.length
            ? e.clone({ isDanglingSpaceSensitive: EL(e) })
            : e.clone({
                children: e.children
                  .map((e) =>
                    Object.assign(
                      ...
                      {},
                      {
                        isLeadingSpaceSensitive: CL(e, t),
                        isTrailingSpaceSensitive: vL(e, t),
                      }
                    )
                  )
                  .map((e, t, n) =>
                ...
                t.push(
                  n.clone({
                    value:
                      ...
                      `</${i.rawName}>` +
                      u.value,
                    sourceSpan: new dL(n.sourceSpan.start, u.sourceSpan.end),
...
const xL = { type: 'whitespace' }
var SL = function (e, t) {
  for (const n of FL) e = n(e, t)
  return e
}
var wL = {
  hasPragma: function (e) {
      ...
      (r = function () {
        return function (e, t) {
          ...
          for (
            ...
            ;(u = i(d)),
              (o = []),
              ',' === u.slice(-1) ? ((u = u.replace(h, '')), b()) : E()
          }
          function E() {
            for (i(p), s = '', a = 'in descriptor'; ; ) {
              if (((l = e.charAt(y)), 'in descriptor' === a))
                if (r(l)) s && (o.push(s), (s = ''), (a = 'after descriptor'))
                else {
                  if (',' === l) return (y += 1), s && o.push(s), void b()
                  if ('(' === l) (s += l), (a = 'in parens')
                  else {
                    if ('' === l) return s && o.push(s), void b()
                    s += l
                  }
                }
              else if ('in parens' === a)
                if (')' === l) (s += l), (a = 'in descriptor')
                else {
                  if ('' === l) return o.push(s), void b()
                  s += l
                }
...
var $L = {
  printImgSrcset: function (e) {
    ...
    const i = n ? 'w' : r ? 'h' : 'd',
      ...
      l = t.map((e) => e[i]).map((e) => (e ? e.toString() : '')),
      c = l.map((e) => {
        const t = e.indexOf('.')
  ...
  printClassNames: function (e) {
    ...
    for (let e = 0; e < t.length; e++) {
      const i = RL(t[e])
      i !== r && i !== t[e - 1] && n.push([]), Be(n).push(t[e]), (r = i)
    }
    return [
      IL([
        _L,
...
const {
    ...
    utils: {
      ...
      getDocParts: t_,
      isConcat: n_,
      replaceEndOfLineWith: r_,
    },
  } = ki,
  { isNonEmptyArray: i_ } = Jr,
  {
    htmlTrimPreserveIndentation: u_,
    splitByHtmlWhitespace: o_,
    countChars: s_,
    countParents: a_,
    dedentString: l_,
    forceBreakChildren: c_,
    forceBreakContent: p_,
    forceNextEmptyLine: f_,
    getLastDescendant: d_,
    getPrettierIgnoreAttributeCommentData: h_,
    hasPrettierIgnore: g_,
    inferScriptParser: m_,
    isVueCustomBlock: y_,
    isVueNonHtmlBlock: D_,
    isVueSlotAttribute: E_,
    isVueSfcBindingsAttribute: b_,
    isScriptLikeTag: C_,
    isTextLikeNode: v_,
    preferHardlineAsLeadingSpaces: A_,
    shouldNotPrintClosingTag: F_,
    shouldPreserveContent: x_,
    unescapeQuoteEntities: S_,
    isPreLikeNode: w_,
  } = kj,
  { insertPragma: T_ } = wL,
  { locStart: B_, locEnd: k_ } = TL,
  {
    printVueFor: N_,
    printVueBindings: P_,
    isVueEventBindingExpression: O_,
  } = kL,
  { printImgSrcset: I_, printClassNames: j_ } = $L
function L_(e, t, n) {
  const r = e.getValue()
  if (c_(r))
    return [
  ...
  return e.map((e, t) => {
    ...
    if (v_(n)) {
      if (n.prev && v_(n.prev)) {
        const t = o(n.prev, n)
        if (t) return f_(n.prev) ? [zL, zL, u(e)] : [t, u(e)]
      }
      return u(e)
    }
    const r = [],
    ...
    return (
      c &&
        (f_(n.prev)
          ...
          : v_(n.prev)
          ? s.push(c)
          : s.push(GL('', QL, { groupId: i[t - 1] }))),
      p &&
        (f_(n)
          ? v_(n.next) && l.push(zL, zL)
          : p === zL
          ? v_(n.next) && l.push(zL)
          : a.push(p)),
      [...r, UL([...s, UL([u(e), ...a], { id: i[t] })]), ...l]
    )
  }, 'children')
  function u(e) {
    const r = e.getValue()
    return g_(r)
      ? [
          ...
          ...r_(
            t.originalText.slice(
              B_(r) + (r.prev && z_(r.prev) ? Z_(r).length : 0),
              k_(r) - (r.next && H_(r.next) ? nM(r, t).length : 0)
            ),
            KL
          ),
          Q_(r, t),
  ...
  function o(e, t) {
    return v_(e) && v_(t)
      ...
      : (z_(e) &&
        ...
        ('element' === e.type && e.isSelfClosing && H_(t))
      ? ''
...
function __(e, t) {
  ...
  e.firstChild && G_(e.firstChild) && (n -= eM(e).length)
  let r = e.endSourceSpan.start.offset
  return (
    e.lastChild && X_(e.lastChild)
      ? (r += tM(e, t).length)
      : J_(e) && (r -= nM(e.lastChild, t).length),
    t.originalText.slice(n, r)
  )
}
function M_(e, t, n) {
  const r = e.getValue()
  if (!i_(r.attrs)) return r.isSelfClosing ? ' ' : ''
  const i = r.prev && 'comment' === r.prev.type && h_(r.prev.value),
    u =
      'boolean' == typeof i
        ? () => i
        : Array.isArray(i)
    ...
    o = e.map((e) => {
      const r = e.getValue()
      return u(r) ? r_(t.originalText.slice(B_(r), k_(r)), KL) : n()
    }, 'attrs'),
    s =
      'element' === r.type &&
      'script' === r.fullName &&
    ...
    a = [JL([s ? ' ' : YL, XL(YL, o)])]
  return (
    (r.firstChild && G_(r.firstChild)) || (r.isSelfClosing && J_(r.parent)) || s
      ? a.push(r.isSelfClosing ? ' ' : '')
      : a.push(r.isSelfClosing ? YL : QL),
    a
  )
}
function R_(e, t, n) {
  const r = e.getValue()
  return [$_(r, t), M_(e, t, n), r.isSelfClosing ? '' : V_(r)]
}
function $_(e, t) {
  return e.prev && z_(e.prev) ? '' : [Y_(e, t), Z_(e)]
}
function V_(e) {
  return e.firstChild && G_(e.firstChild) ? '' : eM(e)
}
function q_(e, t) {
  return [e.isSelfClosing ? '' : W_(e, t), U_(e, t)]
}
function W_(e, t) {
  return e.lastChild && X_(e.lastChild) ? '' : [K_(e, t), tM(e, t)]
}
function U_(e, t) {
  return (e.next ? H_(e.next) : J_(e.parent)) ? '' : [nM(e, t), Q_(e, t)]
}
function z_(e) {
  return (
    e.next &&
...
function X_(e) {
  return (
    !e.next && !e.hasTrailingSpaces && e.isTrailingSpaceSensitive && v_(d_(e))
  )
}
function Y_(e, t) {
  return G_(e) ? eM(e.parent) : H_(e) ? nM(e.prev, t) : ''
}
function K_(e, t) {
  return J_(e) ? nM(e.lastChild, t) : ''
}
function Q_(e, t) {
  return X_(e) ? tM(e.parent, t) : z_(e) ? Z_(e.next) : ''
}
function Z_(e) {
  switch (e.type) {
    case 'ieConditionalComment':
...
function eM(e) {
  switch ((nf(!e.isSelfClosing), e.type)) {
    case 'ieConditionalComment':
      return ']>'
    case 'element':
...
function tM(e, t) {
  if ((nf(!e.isSelfClosing), F_(e, t))) return ''
  switch (e.type) {
    case 'ieConditionalComment':
      return '<!'
    case 'element':
...
var iM = {
  ...
  print: function (e, t, n) {
    ...
    switch (r.type) {
      case 'front-matter':
        return r_(r.raw, KL)
      case 'root':
        return t.__onHtmlRoot && t.__onHtmlRoot(r), [UL(L_(e, t, n)), zL]
      case 'element':
      case 'ieConditionalComment': {
        if (x_(r, t))
          return [
        ...
        return [
          UL([
            UL(R_(e, t, n), { id: o }),
            0 === r.children.length
              ? r.hasDanglingSpaces && r.isDanglingSpaceSensitive
                ? YL
                : ''
              : [
                  p_(r) ? VL : '',
                  ...
                  (r.next ? H_(r.next) : J_(r.parent))
                    ...
                    : ('comment' === r.lastChild.type ||
                      ...
                      new RegExp(
                        `\\n[\\t ]{${
                          t.tabWidth *
                          a_(e, (e) => e.parent && 'root' !== e.parent.type)
                        }}$`
      ...
      case 'ieConditionalEndComment':
        return [$_(r), U_(r)]
      case 'interpolation':
        return [$_(r, t), ...e.map(n, 'children'), U_(r, t)]
      case 'text': {
        ...
        const e = e_([Y_(r, t), ...rM(r), Q_(r, t)])
        return n_(e) || 'fill' === e.type ? WL(t_(e)) : e
      }
      case 'docType':
        return [
          UL([
      ...
      case 'comment':
        return [
          Y_(r, t),
          ...r_(t.originalText.slice(B_(r), k_(r)), KL),
          Q_(r, t),
        ]
      case 'attribute': {
  ...
  embed: function (e, t, n, r) {
    ...
    switch (i.type) {
      case 'element':
        if (C_(i) || 'interpolation' === i.type) return
        if (!i.isSelfClosing && D_(i, r)) {
          const u = m_(i, r)
          if (!u) return
          const o = __(i, r)
          let s = /^\s*$/.test(o),
      ...
      case 'text':
        if (C_(i.parent)) {
          ...
          return (
            ...
            [
              JL([YL, n(i.value, e, { stripTrailingHardline: !0 })]),
              i.parent.next && H_(i.parent.next) ? ' ' : YL,
            ]
          )
        }
        break
      case 'attribute': {
        ...
        const e = (function (e, t, n) {
          ...
          if ('vue' === n.parser) {
            if ('v-for' === e.fullName) return N_(i(), c)
            if (E_(e) || b_(e, n)) return P_(i(), c)
            const t = ['^:', '^v-bind:'],
              u = ['^v-']
            if (r(['^@', '^v-on:'])) {
              const e = i()
              return l(
                c(e, {
                  parser: O_(e) ? '__js_expression' : '__vue_event_binding',
                })
              )
            }
            if (r(t)) return l(c(i(), { parser: '__vue_expression' }))
            if (r(u)) return l(c(i(), { parser: '__js_expression' }))
          }
          if ('angular' === n.parser) {
            const t = (e, t) =>
                c(
              ...
              o = ['^i18n(-.+)?$']
            if (r(['^\\(.+\\)$', '^on-']))
              return l(t(i(), { parser: '__ng_action' }))
            if (r(u)) return l(t(i(), { parser: '__ng_binding' }))
            if (r(o)) {
              const t = i().trim()
              return a(WL(rM(e, t)), !t.includes('@@'))
            }
            if (r(n)) return l(t(i(), { parser: '__ng_directive' }))
            const s = /{{(.+?)}}/gs,
              p = i()
            if (s.test(p)) {
              const e = []
              for (const [n, r] of p.split(s).entries())
                if (n % 2 == 0) e.push(r_(r, KL))
                else
                  try {
                    e.push(
                      UL([
...
var aM = {
  ...
  parsers: {
    get html() {
      return (() => {})('./parser-html').parsers.html
    },
    get vue() {
      return (() => {})('./parser-html').parsers.vue
    },
    get angular() {
      return (() => {})('./parser-html').parsers.angular
    },
    get lwc() {
      return (() => {})('./parser-html').parsers.lwc
    },
  },
}
var lM = {
...
const { getLast: fM, isNonEmptyArray: dM } = Jr
function hM(e, t) {
...
function mM(e) {
  return e && dM(e.leadingComments)
}
function yM(e) {
  return e && dM(e.middleComments)
}
function DM(e) {
...
var vM = {
  ...
  isEmptyNode: function (e) {
    return (
      !dM(e.children) &&
      !(function (e) {
        return mM(e) || yM(e) || DM(e) || EM(e) || bM(e)
      })(e)
    )
  },
  ...
  getBlockValueLineContents: function (
    ...
    function s(t) {
      if ('keep' === e.chomping) return 0 === fM(t).length ? t.slice(0, -1) : t
      let r = 0
      ...
      : r
          ...
          .reduce(
            (t, n, i) =>
              ...
              r[i - 1].length > 0 &&
              n.length > 0 &&
              ('quoteDouble' !== e || !fM(fM(t)).endsWith('\\'))
                ? [...t.slice(0, -1), [...fM(t), ...n]]
                : [...t, n],
            []
          )
  ...
  getLastDescendantNode: function e(t) {
    return dM(t.children) ? e(fM(t.children)) : t
  },
  hasPrettierIgnore: function (e) {
    const t = e.getValue()
    if ('documentBody' === t.type) {
      const t = e.getParentNode()
      return bM(t.head) && gM(fM(t.head.endComments))
    }
    return mM(t) && gM(fM(t.leadingComments))
  },
  hasLeadingComments: mM,
  hasMiddleComments: yM,
  hasIndicatorComment: DM,
  hasTrailingComment: EM,
  hasEndComments: bM,
}
const { defineShortcut: AM, mapNode: FM } = vM
function xM(e) {
  switch (e.type) {
    case 'document':
      AM(e, 'head', () => e.children[0]), AM(e, 'body', () => e.children[1])
      break
    case 'documentBody':
    case 'sequenceItem':
    ...
    case 'mappingKey':
    case 'mappingValue':
      AM(e, 'content', () => e.children[0])
      break
    case 'mappingItem':
    case 'flowMappingItem':
      AM(e, 'key', () => e.children[0]), AM(e, 'value', () => e.children[1])
  }
  return e
}
var SM = function (e) {
...
const {
    builders: { softline: wM, align: TM },
  } = ki,
  { hasEndComments: BM, isNextLineEmpty: kM, isNode: NM } = vM,
  PM = new WeakMap()
function OM(e) {
  return (
    BM(e) &&
    !NM(e, ['documentHead', 'documentBody', 'flowMapping', 'flowSequence'])
  )
}
var IM = {
  alignWithSpaces: function (e, t) {
    return TM(' '.repeat(e), t)
  },
  shouldPrintEndComments: OM,
  printNextEmptyLine: function (e, t) {
    const n = e.getValue(),
      r = e.stack[0]
    let i
    return (
      PM.has(r) ? (i = PM.get(r)) : ((i = new Set()), PM.set(r, i)),
      i.has(n.position.end.line) ||
      (i.add(n.position.end.line), !kM(n, t) || OM(e.getParentNode()))
        ? ''
        : wM
    )
  },
...
const {
    builders: { ifBreak: jM, line: LM, softline: _M, hardline: MM, join: RM },
  } = ki,
  { isEmptyNode: $M, getLast: VM, hasEndComments: qM } = vM,
  { printNextEmptyLine: WM, alignWithSpaces: UM } = IM
function zM(e, t, n) {
  const r = e.getValue(),
    ...
    o = i ? '}' : ']'
  let s = _M
  i && r.children.length > 0 && n.bracketSpacing && (s = LM)
  const a = VM(r.children),
    l = a && 'flowMappingItem' === a.type && $M(a.key) && $M(a.value)
  return [
    u,
    UM(n.tabWidth, [
      s,
      GM(e, t, n),
      'none' === n.trailingComma ? '' : jM(','),
      qM(r) ? [MM, RM(MM, e.map(t, 'endComments'))] : '',
    ]),
    l ? '' : s,
    o,
  ]
...
var HM = { printFlowMapping: zM, printFlowSequence: zM }
const {
    builders: {
      conditionalGroup: JM,
      group: XM,
  ...
  {
    hasLeadingComments: eR,
    hasMiddleComments: tR,
    hasTrailingComment: nR,
    hasEndComments: rR,
    isNode: iR,
    isEmptyNode: uR,
    isInlineNode: oR,
  } = vM,
  { alignWithSpaces: sR } = IM
function aR(e, t) {
  if (!e) return !0
  switch (e.type) {
    case 'plain':
...
var lR = function (e, t, n, r, i) {
  ...
  if (eR(o) || !oR(u.content))
    return [
      ...
      QM(
        '',
        n.map(r, 'value', 'leadingComments').map((e) => [e, YM])
      ),
      ': ',
      sR(2, p),
    ]
  ...
  const f = Symbol('mappingKey'),
    d = XM([KM('? '), XM(sR(2, l), { id: f })]),
    h = [YM, ': ', sR(2, p)],
    g = [c, ':']
  eR(o.content) ||
  (rR(o) && o.content && !iR(o.content, ['mapping', 'sequence'])) ||
  ('mapping' === t.type && nR(u.content) && oR(o.content)) ||
  (iR(o.content, ['mapping', 'sequence']) &&
    null === o.content.tag &&
    null === o.content.anchor)
    ? g.push(YM)
    : o.content && g.push(ZM),
    g.push(p)
  const m = sR(i.tabWidth, g)
  return !aR(u.content, i) || eR(u.content) || tR(u.content) || rR(u)
    ? JM([[d, KM(h, m, { groupId: f })]])
    : JM([[l, m]])
}
const {
    builders: {
    ...
    utils: { getDocParts: DR },
  } = ki,
  {
    getAncestorCount: ER,
    getBlockValueLineContents: bR,
    hasIndicatorComment: CR,
    isLastDescendantNode: vR,
    isNode: AR,
  } = vM,
  { alignWithSpaces: FR } = IM
var xR = function (e, t, n) {
  const r = e.getValue(),
    i = ER(e, (e) => AR(e, ['sequence', 'mapping'])),
    u = vR(e),
    o = ['blockFolded' === r.type ? '>' : '|']
  null !== r.indent && o.push(r.indent.toString()),
    'clip' !== r.chomping && o.push('keep' === r.chomping ? '+' : '-'),
    CR(r) && o.push(' ', t('indicatorComment'))
  const s = bR(r, { parentIndent: i, isLastDescendant: u, options: n }),
    a = []
  for (const [e, t] of s.entries())
    0 === e && a.push(dR),
      a.push(fR(DR(hR(gR, t)))),
      e !== s.length - 1
        ? a.push(0 === t.length ? dR : yR(mR))
        : 'keep' === r.chomping && u && a.push(pR(0 === t.length ? dR : mR))
  return (
    null === r.indent
      ? o.push(cR(FR(n.tabWidth, a)))
      : o.push(pR(FR(r.indent - 1 + i, a))),
    o
  )
}
const {
    ...
    utils: { getDocParts: IR, replaceEndOfLineWith: jR },
  } = ki,
  { isPreviousLineEmpty: LR } = Jr,
  { insertPragma: _R, isPragma: MR } = lM,
  { locStart: RR } = cM,
  {
    getFlowScalarLineContents: $R,
    getLastDescendantNode: VR,
    hasLeadingComments: qR,
    hasMiddleComments: WR,
    hasTrailingComment: UR,
    hasEndComments: zR,
    hasPrettierIgnore: GR,
    isLastDescendantNode: HR,
    isNode: JR,
    isInlineNode: XR,
  } = vM,
  {
    alignWithSpaces: YR,
    printNextEmptyLine: KR,
    shouldPrintEndComments: QR,
  } = IM,
  { printFlowMapping: ZR, printFlowSequence: e$ } = HM
function t$(e, t) {
  return UR(e) || (t && (t.head.children.length > 0 || zR(t.head)))
}
function n$(e, t, n) {
  const r = $R(e, t, n)
  return kR(
    BR,
    r.map((e) => wR(IR(kR(NR, e))))
  )
}
var r$ = {
    preprocess: SM,
    ...
    print: function (e, t, n) {
      ...
      'mappingValue' !== r.type &&
        qR(r) &&
        i.push([kR(BR, e.map(n, 'leadingComments')), BR])
      ...
      JR(r, [
        ...
        !HR(e) &&
        (s = KR(e, t.originalText)),
        (u || o) &&
          (JR(r, ['sequence', 'mapping']) && !WR(r) ? i.push(BR) : i.push(' ')),
        WR(r) &&
          i.push([
            1 === r.middleComments.length ? '' : BR,
            kR(BR, e.map(n, 'middleComments')),
            BR,
          ])
      const a = e.getParentNode()
      return (
                  ...
                  switch (e.type) {
                    case 'root': {
                      ...
                      n.each((e, n) => {
                        ...
                        0 !== n && r.push(BR),
                          ...
                          t$(u, o)
                            ? (r.push(BR, '...'),
                              UR(u) && r.push(' ', i('trailingComment')))
                            : o && !UR(o.head) && r.push(BR, '---')
                      }, 'children')
                      const u = VR(e)
                      return (
                        (JR(u, ['blockLiteral', 'blockFolded']) &&
                          'keep' === u.chomping) ||
                          r.push(BR),
                        r
                      )
                        ...
                        'head' ===
                          (function (e, t, n, r) {
                            if (
                              (n.children[0] === e &&
                                /---(\s|$)/.test(
                                  r.originalText.slice(RR(e), RR(e) + 4)
                                )) ||
                          ...
                          UR(e.head)
                            ...
                            : u.push('---')),
                        (function (e) {
                          return e.body.children.length > 0 || zR(e.body)
                        })(e) && u.push(i('body')),
                        kR(BR, u)
                      )
                    }
                    ...
                    case 'documentBody': {
                      ...
                      if (t.length > 0 && r.length > 0) {
                        const t = VR(e)
                        JR(t, ['blockFolded', 'blockLiteral'])
                          ? 'keep' !== t.chomping && (u = [BR, BR])
                          : (u = BR)
                      }
                      return [
                        kR(BR, n.map(i, 'children')),
                        u,
                        kR(BR, n.map(i, 'endComments')),
                      ]
                    }
                    case 'directive':
                      return ['%', kR(' ', [e.name, ...e.parameters])]
                    case 'comment':
                      return ['#', e.value]
                    case 'alias':
                      return ['*', e.value]
                    ...
                    case 'quoteSingle': {
                      ...
                      if (i.includes(n))
                        return [
                          ...
                          n$(
                            e.type,
                            'quoteDouble' === e.type
                              ? i.replace(/\\"/g, n).replace(/'/g, t.repeat(2))
                              : i,
                            r
                          ),
                          t,
                      ...
                      if (i.includes(t))
                        return [
                          ...
                          n$(
                            e.type,
                            'quoteSingle' === e.type ? i.replace(/''/g, t) : i,
                            r
                          ),
                          n,
                        ]
                    ...
                    case 'mapping':
                    case 'sequence':
                      return kR(BR, n.map(i, 'children'))
                    case 'sequenceItem':
                      return ['- ', YR(2, e.content ? i('content') : '')]
                    case 'mappingKey':
                    case 'mappingValue':
        ...
        QR(r) &&
          i.push(
            YR('sequenceItem' === r.type ? 2 : 0, [
              BR,
              kR(
                BR,
                e.map(
                  (e) => [LR(t.originalText, e.getValue(), RR) ? BR : '', n()],
                  'endComments'
                )
              ),
            ])
...
var u$ = [
  ...
  aM,
  {
    ...
    parsers: {
      get yaml() {
        return (() => {})('./parser-yaml').parsers.yaml
      },
    },
  },
]
  ...
  return (...n) => {
    ...
    return (
      (n[t] = Object.assign(
        ...
        {},
        {
          plugins: [...l$, ...(Array.isArray(i) ? i : Object.values(i))],
        }
      )),
      e(...n)
    )
...
const p$ = c$(cd.formatWithCursor)
var f$ = {
  formatWithCursor: p$,
  format: (e, t) => p$(e, t).formatted,
  check(e, t) {
    const { formatted: n } = p$(e, t)
    return n === e
  },
  doc: ki,
  getSupportInfo: c$(a$, 0),
  version: s$,
  util: Id,
  __debug: {
    parse: c$(cd.parse),
    formatAST: c$(cd.formatAST),
    formatDoc: c$(cd.formatDoc),
    printToDoc: c$(cd.printToDoc),
    printDocToString: c$(cd.printDocToString),
  },
}
export default f$
