!function (e) {
    ...
    var f = [], u = Object.keys, N = {}, c = {}, n = /^(no-?highlight|plain|text)$/i, s = /\blang(?:uage)?-([\w-]+)\b/i, t = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, r = {
            case_insensitive: 'cI',
            lexemes: 'l',
            contains: 'c',
            keywords: 'k',
    ...
    function R(e) {
        ...
        return function e(n, t) {
            for (var r = n.firstChild; r; r = r.nextSibling)
                3 === r.nodeType ? t += r.nodeValue.length : 1 === r.nodeType && (a.push({
                    event: 'start',
                    offset: t,
                    node: r
        ...
        function o() {
            E += null != l.sL ? function () {
                ...
                for (r = '', n = 0, l.lR.lastIndex = 0, t = l.lR.exec(g); t;)
                    r += _(g.substring(n, t.index)), a = l, i = t, void 0, o = s.cI ? i[0].toLowerCase() : i[0], (e = a.k.hasOwnProperty(o) && a.k[o]) ? (R += e[1], r += c(e[0], _(t[0]))) : r += _(t[0]), n = l.lR.lastIndex, t = l.lR.exec(g);
                return r + _(g.substr(n));
            }(), g = '';
        }
        function u(e) {
            E += e.cN ? c(e.cN, '', !0) : '', l = Object.create(e, { parent: { value: l } });
        }
        function r(e, n) {
            if (g += e, null == n)
                return o(), 0;
            var t = function (e, n) {
                ...
                for (t = 0, r = n.c.length; t < r; t++)
                    if (v(n.c[t].bR, e))
                        return n.c[t].endSameAsBegin && (n.c[t].eR = (a = n.c[t].bR.exec(e)[0], new RegExp(a.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'), 'm'))), n.c[t];
            }(n, l);
            if (t)
                return t.skip ? g += n : (t.eB && (g += n), o(), t.rB || t.eB || (g = n)), u(t), t.rB ? 0 : n.length;
            ...
            if (function (e, n) {
                ...
                throw new Error('Illegal lexeme "' + n + '" for mode "' + (l.cN || '<unnamed>') + '"');
        ...
        l(o) || (h.useBR ? (n = document.createElementNS('http://www.w3.org/1999/xhtml', 'div')).innerHTML = e.innerHTML.replace(/\n/g, '').replace(/<br[ \/]*>/g, '\n') : n = e, i = n.textContent, r = o ? C(o, i, !0) : O(i), (t = R(n)).length && ((a = document.createElementNS('http://www.w3.org/1999/xhtml', 'div')).innerHTML = r.value, r.value = function (e, n, t) {
            ...
            for (; e.length || n.length;) {
                ...
                if (a += _(t.substring(r, l[0].offset)), r = l[0].offset, l === e) {
                    ...
                    'start' === l[0].event ? i.push(l[0].node) : i.pop(), s(l.splice(0, 1)[0]);
            }
